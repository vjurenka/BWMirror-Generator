...
UnitCommand convertUnitCommand(JNIEnv * env, jobject obj){	jclass clz = FindCachedClass(env, "bwapi4/UnitCommand");
	...
	jobject typeObj = env->CallObjectMethod(obj, FindCachedMethod(env, clz, "getUnitCommandType", "()Lbwapi4/UnitCommandType;"));
...
jclass retcls = FindCachedClass(env, "bwapi4/Position");
...
JNIEXPORT jstring JNICALL Java_bwapi4_BulletType_toString_1native(JNIEnv * env, jobject obj, jlong pointer){
BulletType* x_bulletType = (BulletType*)pointer;
return env->NewStringUTF(x_bulletType->toString().c_str());
}
...
JNIEXPORT jstring JNICALL Java_bwapi4_DamageType_toString_1native(JNIEnv * env, jobject obj, jlong pointer){
DamageType* x_damageType = (DamageType*)pointer;
return env->NewStringUTF(x_damageType->toString().c_str());
}
JNIEXPORT jstring JNICALL Java_bwapi4_Error_toString_1native(JNIEnv * env, jobject obj, jlong pointer){
Error* x_error = (Error*)pointer;
return env->NewStringUTF(x_error->toString().c_str());
}
...
JNIEXPORT jstring JNICALL Java_bwapi4_ExplosionType_toString_1native(JNIEnv * env, jobject obj, jlong pointer){
ExplosionType* x_explosionType = (ExplosionType*)pointer;
return env->NewStringUTF(x_explosionType->toString().c_str());
}
...
Force x_force = (Force)pointer;
Playerset cresult = x_force->getPlayers();
...
jclass elemClass = FindCachedClass(env, "bwapi4/Player");
jmethodID getMethodID = FindCachedMethodStatic(env, elemClass, "get", "(J)Lbwapi4/Player;");
...
Playerset cresult = x_forceset->getPlayers();
jclass listCls = FindCachedClass(env, "java/util/ArrayList");
jmethodID listConsID = FindCachedMethod(env, listCls, "<init>", "()V");
jobject result = env->NewObject(listCls, listConsID);
jmethodID addMethodID = FindCachedMethod(env, listCls, "add", "(Ljava/lang/Object;)Z");
...
Forceset cresult = x_game->getForces();
jclass listCls = FindCachedClass(env, "java/util/ArrayList");
jmethodID listConsID = FindCachedMethod(env, listCls, "<init>", "()V");
jobject result = env->NewObject(listCls, listConsID);
jmethodID addMethodID = FindCachedMethod(env, listCls, "add", "(Ljava/lang/Object;)Z");
jclass elemClass = FindCachedClass(env, "bwapi4/Force");
jmethodID getMethodID = FindCachedMethodStatic(env, elemClass, "get", "(J)Lbwapi4/Force;");
...
Game* x_game = (Game*)pointer;
Playerset cresult = x_game->getPlayers();
jclass listCls = FindCachedClass(env, "java/util/ArrayList");
jmethodID listConsID = FindCachedMethod(env, listCls, "<init>", "()V");
jobject result = env->NewObject(listCls, listConsID);
jmethodID addMethodID = FindCachedMethod(env, listCls, "add", "(Ljava/lang/Object;)Z");
...
Game* x_game = (Game*)pointer;
Unitset cresult = x_game->getAllUnits();
jclass listCls = FindCachedClass(env, "java/util/ArrayList");
jmethodID listConsID = FindCachedMethod(env, listCls, "<init>", "()V");
jobject result = env->NewObject(listCls, listConsID);
jmethodID addMethodID = FindCachedMethod(env, listCls, "add", "(Ljava/lang/Object;)Z");
...
Game* x_game = (Game*)pointer;
Unitset cresult = x_game->getMinerals();
jclass listCls = FindCachedClass(env, "java/util/ArrayList");
jmethodID listConsID = FindCachedMethod(env, listCls, "<init>", "()V");
jobject result = env->NewObject(listCls, listConsID);
jmethodID addMethodID = FindCachedMethod(env, listCls, "add", "(Ljava/lang/Object;)Z");
...
Game* x_game = (Game*)pointer;
Unitset cresult = x_game->getGeysers();
jclass listCls = FindCachedClass(env, "java/util/ArrayList");
jmethodID listConsID = FindCachedMethod(env, listCls, "<init>", "()V");
jobject result = env->NewObject(listCls, listConsID);
jmethodID addMethodID = FindCachedMethod(env, listCls, "add", "(Ljava/lang/Object;)Z");
...
Game* x_game = (Game*)pointer;
Unitset cresult = x_game->getNeutralUnits();
jclass listCls = FindCachedClass(env, "java/util/ArrayList");
jmethodID listConsID = FindCachedMethod(env, listCls, "<init>", "()V");
jobject result = env->NewObject(listCls, listConsID);
jmethodID addMethodID = FindCachedMethod(env, listCls, "add", "(Ljava/lang/Object;)Z");
...
Game* x_game = (Game*)pointer;
Unitset cresult = x_game->getStaticMinerals();
jclass listCls = FindCachedClass(env, "java/util/ArrayList");
jmethodID listConsID = FindCachedMethod(env, listCls, "<init>", "()V");
jobject result = env->NewObject(listCls, listConsID);
jmethodID addMethodID = FindCachedMethod(env, listCls, "add", "(Ljava/lang/Object;)Z");
...
Game* x_game = (Game*)pointer;
Unitset cresult = x_game->getStaticGeysers();
jclass listCls = FindCachedClass(env, "java/util/ArrayList");
jmethodID listConsID = FindCachedMethod(env, listCls, "<init>", "()V");
jobject result = env->NewObject(listCls, listConsID);
jmethodID addMethodID = FindCachedMethod(env, listCls, "add", "(Ljava/lang/Object;)Z");
...
Game* x_game = (Game*)pointer;
Unitset cresult = x_game->getStaticNeutralUnits();
jclass listCls = FindCachedClass(env, "java/util/ArrayList");
jmethodID listConsID = FindCachedMethod(env, listCls, "<init>", "()V");
jobject result = env->NewObject(listCls, listConsID);
jmethodID addMethodID = FindCachedMethod(env, listCls, "add", "(Ljava/lang/Object;)Z");
...
Game* x_game = (Game*)pointer;
Bulletset cresult = x_game->getBullets();
jclass listCls = FindCachedClass(env, "java/util/ArrayList");
jmethodID listConsID = FindCachedMethod(env, listCls, "<init>", "()V");
jobject result = env->NewObject(listCls, listConsID);
jmethodID addMethodID = FindCachedMethod(env, listCls, "add", "(Ljava/lang/Object;)Z");
jclass elemClass = FindCachedClass(env, "bwapi4/Bullet");
jmethodID getMethodID = FindCachedMethodStatic(env, elemClass, "get", "(J)Lbwapi4/Bullet;");
...
JNIEXPORT void JNICALL Java_bwapi4_Game_printf_1native(JNIEnv * env, jobject obj, jlong pointer, jstring cstr_format){
Game* x_game = (Game*)pointer;
...
Game* x_game = (Game*)pointer;
Unitset cresult = x_game->getSelectedUnits();
jclass listCls = FindCachedClass(env, "java/util/ArrayList");
jmethodID listConsID = FindCachedMethod(env, listCls, "<init>", "()V");
jobject result = env->NewObject(listCls, listConsID);
jmethodID addMethodID = FindCachedMethod(env, listCls, "add", "(Ljava/lang/Object;)Z");
...
Game* x_game = (Game*)pointer;
Playerset cresult = x_game->allies();
jclass listCls = FindCachedClass(env, "java/util/ArrayList");
jmethodID listConsID = FindCachedMethod(env, listCls, "<init>", "()V");
jobject result = env->NewObject(listCls, listConsID);
jmethodID addMethodID = FindCachedMethod(env, listCls, "add", "(Ljava/lang/Object;)Z");
...
Game* x_game = (Game*)pointer;
Playerset cresult = x_game->enemies();
jclass listCls = FindCachedClass(env, "java/util/ArrayList");
jmethodID listConsID = FindCachedMethod(env, listCls, "<init>", "()V");
jobject result = env->NewObject(listCls, listConsID);
jmethodID addMethodID = FindCachedMethod(env, listCls, "add", "(Ljava/lang/Object;)Z");
...
Game* x_game = (Game*)pointer;
Playerset cresult = x_game->observers();
jclass listCls = FindCachedClass(env, "java/util/ArrayList");
jmethodID listConsID = FindCachedMethod(env, listCls, "<init>", "()V");
jobject result = env->NewObject(listCls, listConsID);
jmethodID addMethodID = FindCachedMethod(env, listCls, "add", "(Ljava/lang/Object;)Z");
...
JNIEXPORT void JNICALL Java_bwapi4_Game_drawTextMap_1native__JLbwapi4_Position_2Ljava_lang_String_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_p, jstring cstr_format){
Game* x_game = (Game*)pointer;
Position p((int)env->GetIntField(p_p, FindCachedField(env, env->GetObjectClass(p_p), "x", "I")), (int)env->GetIntField(p_p, FindCachedField(env, env->GetObjectClass(p_p), "y", "I")));
x_game->drawTextMap(p, std::string(env->GetStringUTFChars(cstr_format, NULL)).c_str());
}
JNIEXPORT void JNICALL Java_bwapi4_Game_drawTextMouse_1native__JIILjava_lang_String_2(JNIEnv * env, jobject obj, jlong pointer, jint x, jint y, jstring cstr_format){
Game* x_game = (Game*)pointer;
x_game->drawTextMouse(x, y, std::string(env->GetStringUTFChars(cstr_format, NULL)).c_str());
}
JNIEXPORT void JNICALL Java_bwapi4_Game_drawTextMouse_1native__JLbwapi4_Position_2Ljava_lang_String_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_p, jstring cstr_format){
Game* x_game = (Game*)pointer;
Position p((int)env->GetIntField(p_p, FindCachedField(env, env->GetObjectClass(p_p), "x", "I")), (int)env->GetIntField(p_p, FindCachedField(env, env->GetObjectClass(p_p), "y", "I")));
x_game->drawTextMouse(p, std::string(env->GetStringUTFChars(cstr_format, NULL)).c_str());
}
JNIEXPORT void JNICALL Java_bwapi4_Game_drawTextScreen_1native__JIILjava_lang_String_2(JNIEnv * env, jobject obj, jlong pointer, jint x, jint y, jstring cstr_format){
Game* x_game = (Game*)pointer;
x_game->drawTextScreen(x, y, std::string(env->GetStringUTFChars(cstr_format, NULL)).c_str());
}
JNIEXPORT void JNICALL Java_bwapi4_Game_drawTextScreen_1native__JLbwapi4_Position_2Ljava_lang_String_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_p, jstring cstr_format){
Game* x_game = (Game*)pointer;
Position p((int)env->GetIntField(p_p, FindCachedField(env, env->GetObjectClass(p_p), "x", "I")), (int)env->GetIntField(p_p, FindCachedField(env, env->GetObjectClass(p_p), "y", "I")));
x_game->drawTextScreen(p, std::string(env->GetStringUTFChars(cstr_format, NULL)).c_str());
}
...
JNIEXPORT jobject JNICALL Java_bwapi4_Game_getAllRegions_1native(JNIEnv * env, jobject obj, jlong pointer){
Game* x_game = (Game*)pointer;
Regionset cresult = x_game->getAllRegions();
jclass listCls = FindCachedClass(env, "java/util/ArrayList");
jmethodID listConsID = FindCachedMethod(env, listCls, "<init>", "()V");
jobject result = env->NewObject(listCls, listConsID);
jmethodID addMethodID = FindCachedMethod(env, listCls, "add", "(Ljava/lang/Object;)Z");
jclass elemClass = FindCachedClass(env, "bwapi4/Region");
jmethodID getMethodID = FindCachedMethodStatic(env, elemClass, "get", "(J)Lbwapi4/Region;");
...
jclass retcls = FindCachedClass(env, "bwapi4/TilePosition");
jmethodID retConsID = FindCachedMethod(env, retcls, "<init>", "(II)V");
jobject result = env->NewObject(retcls, retConsID, cresult.x, cresult.y);
return result;
}
...
JNIEXPORT jstring JNICALL Java_bwapi4_GameType_toString_1native(JNIEnv * env, jobject obj, jlong pointer){
...
JNIEXPORT jobject JNICALL Java_bwapi4_Player_getUnits_1native(JNIEnv * env, jobject obj, jlong pointer){
Player x_player = (Player)pointer;
Unitset cresult = x_player->getUnits();
jclass listCls = FindCachedClass(env, "java/util/ArrayList");
jmethodID listConsID = FindCachedMethod(env, listCls, "<init>", "()V");
jobject result = env->NewObject(listCls, listConsID);
jmethodID addMethodID = FindCachedMethod(env, listCls, "add", "(Ljava/lang/Object;)Z");
...
Unitset cresult = x_playerset->getUnits();
jclass listCls = FindCachedClass(env, "java/util/ArrayList");
jmethodID listConsID = FindCachedMethod(env, listCls, "<init>", "()V");
jobject result = env->NewObject(listCls, listConsID);
jmethodID addMethodID = FindCachedMethod(env, listCls, "add", "(Ljava/lang/Object;)Z");
...
JNIEXPORT jstring JNICALL Java_bwapi4_PlayerType_toString_1native(JNIEnv * env, jobject obj, jlong pointer){
PlayerType* x_playerType = (PlayerType*)pointer;
return env->NewStringUTF(x_playerType->toString().c_str());
}
JNIEXPORT jboolean JNICALL Java_bwapi4_PlayerType_isLobbyType_1native(JNIEnv * env, jobject obj, jlong pointer){
PlayerType* x_playerType = (PlayerType*)pointer;
return x_playerType->isLobbyType();
}
JNIEXPORT jboolean JNICALL Java_bwapi4_PlayerType_isGameType_1native(JNIEnv * env, jobject obj, jlong pointer){
PlayerType* x_playerType = (PlayerType*)pointer;
return x_playerType->isGameType();
}
...
JNIEXPORT jstring JNICALL Java_bwapi4_Race_toString_1native(JNIEnv * env, jobject obj, jlong pointer){
Race* x_race = (Race*)pointer;
return env->NewStringUTF(x_race->toString().c_str());
}
JNIEXPORT jobject JNICALL Java_bwapi4_Race_getWorker_1native(JNIEnv * env, jobject obj, jlong pointer){
Race* x_race = (Race*)pointer;
...
JNIEXPORT jobject JNICALL Java_bwapi4_Race_getCenter_1native(JNIEnv * env, jobject obj, jlong pointer){
Race* x_race = (Race*)pointer;
...
JNIEXPORT jobject JNICALL Java_bwapi4_Race_getRefinery_1native(JNIEnv * env, jobject obj, jlong pointer){
Race* x_race = (Race*)pointer;
...
JNIEXPORT jobject JNICALL Java_bwapi4_Race_getTransport_1native(JNIEnv * env, jobject obj, jlong pointer){
Race* x_race = (Race*)pointer;
...
JNIEXPORT jobject JNICALL Java_bwapi4_Race_getSupplyProvider_1native(JNIEnv * env, jobject obj, jlong pointer){
Race* x_race = (Race*)pointer;
...
JNIEXPORT jobject JNICALL Java_bwapi4_Region_getNeighbors_1native(JNIEnv * env, jobject obj, jlong pointer){
Region x_region = (Region)pointer;
Regionset cresult = x_region->getNeighbors();
jclass listCls = FindCachedClass(env, "java/util/ArrayList");
jmethodID listConsID = FindCachedMethod(env, listCls, "<init>", "()V");
jobject result = env->NewObject(listCls, listConsID);
jmethodID addMethodID = FindCachedMethod(env, listCls, "add", "(Ljava/lang/Object;)Z");
...
JNIEXPORT jstring JNICALL Java_bwapi4_TechType_toString_1native(JNIEnv * env, jobject obj, jlong pointer){
TechType* x_techType = (TechType*)pointer;
return env->NewStringUTF(x_techType->toString().c_str());
}
JNIEXPORT jobject JNICALL Java_bwapi4_TechType_getRace_1native(JNIEnv * env, jobject obj, jlong pointer){
TechType* x_techType = (TechType*)pointer;
...
JNIEXPORT jint JNICALL Java_bwapi4_TechType_mineralPrice_1native(JNIEnv * env, jobject obj, jlong pointer){
TechType* x_techType = (TechType*)pointer;
return x_techType->mineralPrice();
}
JNIEXPORT jint JNICALL Java_bwapi4_TechType_gasPrice_1native(JNIEnv * env, jobject obj, jlong pointer){
TechType* x_techType = (TechType*)pointer;
return x_techType->gasPrice();
}
JNIEXPORT jint JNICALL Java_bwapi4_TechType_researchTime_1native(JNIEnv * env, jobject obj, jlong pointer){
TechType* x_techType = (TechType*)pointer;
return x_techType->researchTime();
}
JNIEXPORT jint JNICALL Java_bwapi4_TechType_energyCost_1native(JNIEnv * env, jobject obj, jlong pointer){
TechType* x_techType = (TechType*)pointer;
return x_techType->energyCost();
}
JNIEXPORT jobject JNICALL Java_bwapi4_TechType_whatResearches_1native(JNIEnv * env, jobject obj, jlong pointer){
TechType* x_techType = (TechType*)pointer;
...
JNIEXPORT jobject JNICALL Java_bwapi4_TechType_getWeapon_1native(JNIEnv * env, jobject obj, jlong pointer){
TechType* x_techType = (TechType*)pointer;
jlong resptr = (jlong)tableWeaponType.find(x_techType->getWeapon())->second;
jclass retcls = FindCachedClass(env, "bwapi4/WeaponType");
jmethodID mid = FindCachedMethodStatic(env, retcls, "get", "(J)Lbwapi4/WeaponType;");
return env->CallStaticObjectMethod(retcls, mid, resptr);
}
JNIEXPORT jboolean JNICALL Java_bwapi4_TechType_targetsUnit_1native(JNIEnv * env, jobject obj, jlong pointer){
TechType* x_techType = (TechType*)pointer;
return x_techType->targetsUnit();
}
JNIEXPORT jboolean JNICALL Java_bwapi4_TechType_targetsPosition_1native(JNIEnv * env, jobject obj, jlong pointer){
TechType* x_techType = (TechType*)pointer;
return x_techType->targetsPosition();
}
JNIEXPORT jobject JNICALL Java_bwapi4_TechType_getOrder_1native(JNIEnv * env, jobject obj, jlong pointer){
TechType* x_techType = (TechType*)pointer;
...
jobject result = env->NewObject(retcls, retConsID, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/Unit"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/Unit"), "get", "(J)Lbwapi4/Unit;"), cresult.getUnit())
, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/UnitCommandType"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/UnitCommandType"), "get", "(J)Lbwapi4/UnitCommandType;"), (jlong)tableUnitCommandType.find(cresult.getType().getID())->second )
, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/Unit"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/Unit"), "get", "(J)Lbwapi4/Unit;"), cresult.getTarget())
...
Unit x_unit = (Unit)pointer;
Unitset cresult = x_unit->getLoadedUnits();
jclass listCls = FindCachedClass(env, "java/util/ArrayList");
jmethodID listConsID = FindCachedMethod(env, listCls, "<init>", "()V");
jobject result = env->NewObject(listCls, listConsID);
jmethodID addMethodID = FindCachedMethod(env, listCls, "add", "(Ljava/lang/Object;)Z");
...
Unit x_unit = (Unit)pointer;
Unitset cresult = x_unit->getInterceptors();
jclass listCls = FindCachedClass(env, "java/util/ArrayList");
jmethodID listConsID = FindCachedMethod(env, listCls, "<init>", "()V");
jobject result = env->NewObject(listCls, listConsID);
jmethodID addMethodID = FindCachedMethod(env, listCls, "add", "(Ljava/lang/Object;)Z");
...
Unit x_unit = (Unit)pointer;
Unitset cresult = x_unit->getLarva();
jclass listCls = FindCachedClass(env, "java/util/ArrayList");
jmethodID listConsID = FindCachedMethod(env, listCls, "<init>", "()V");
jobject result = env->NewObject(listCls, listConsID);
jmethodID addMethodID = FindCachedMethod(env, listCls, "add", "(Ljava/lang/Object;)Z");
...
JNIEXPORT jobject JNICALL Java_bwapi4_UnitCommand_attack__Lbwapi4_Unit_2Lbwapi4_PositionOrUnit_2(JNIEnv * env, jclass jclz, jobject p_unit, jobject p_target){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
PositionOrUnit target(convertPositionOrUnit(env, p_target ));
UnitCommand cresult = UnitCommand::attack(unit, target);
jclass retcls = FindCachedClass(env, "bwapi4/UnitCommand");
jmethodID retConsID = FindCachedMethod(env, retcls, "<init>", "(Lbwapi4/Unit;Lbwapi4/UnitCommandType;Lbwapi4/Unit;III)V");
jobject result = env->NewObject(retcls, retConsID, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/Unit"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/Unit"), "get", "(J)Lbwapi4/Unit;"), cresult.getUnit())
, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/UnitCommandType"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/UnitCommandType"), "get", "(J)Lbwapi4/UnitCommandType;"), (jlong)tableUnitCommandType.find(cresult.getType().getID())->second )
...
JNIEXPORT jobject JNICALL Java_bwapi4_UnitCommand_attack__Lbwapi4_Unit_2Lbwapi4_PositionOrUnit_2Z(JNIEnv * env, jclass jclz, jobject p_unit, jobject p_target, jboolean shiftQueueCommand){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
PositionOrUnit target(convertPositionOrUnit(env, p_target ));
UnitCommand cresult = UnitCommand::attack(unit, target, (bool)shiftQueueCommand);
jclass retcls = FindCachedClass(env, "bwapi4/UnitCommand");
jmethodID retConsID = FindCachedMethod(env, retcls, "<init>", "(Lbwapi4/Unit;Lbwapi4/UnitCommandType;Lbwapi4/Unit;III)V");
jobject result = env->NewObject(retcls, retConsID, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/Unit"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/Unit"), "get", "(J)Lbwapi4/Unit;"), cresult.getUnit())
, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/UnitCommandType"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/UnitCommandType"), "get", "(J)Lbwapi4/UnitCommandType;"), (jlong)tableUnitCommandType.find(cresult.getType().getID())->second )
...
JNIEXPORT jobject JNICALL Java_bwapi4_UnitCommand_build(JNIEnv * env, jclass jclz, jobject p_unit, jobject p_target, jobject p_type){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
TilePosition target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
UnitType* type = (UnitType*)env->GetLongField(p_type, FindCachedField(env, env->GetObjectClass(p_type), "pointer", "J"));
UnitCommand cresult = UnitCommand::build(unit, target, *type);
jclass retcls = FindCachedClass(env, "bwapi4/UnitCommand");
jmethodID retConsID = FindCachedMethod(env, retcls, "<init>", "(Lbwapi4/Unit;Lbwapi4/UnitCommandType;Lbwapi4/Unit;III)V");
jobject result = env->NewObject(retcls, retConsID, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/Unit"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/Unit"), "get", "(J)Lbwapi4/Unit;"), cresult.getUnit())
, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/UnitCommandType"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/UnitCommandType"), "get", "(J)Lbwapi4/UnitCommandType;"), (jlong)tableUnitCommandType.find(cresult.getType().getID())->second )
...
JNIEXPORT jobject JNICALL Java_bwapi4_UnitCommand_buildAddon(JNIEnv * env, jclass jclz, jobject p_unit, jobject p_type){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
UnitType* type = (UnitType*)env->GetLongField(p_type, FindCachedField(env, env->GetObjectClass(p_type), "pointer", "J"));
UnitCommand cresult = UnitCommand::buildAddon(unit, *type);
jclass retcls = FindCachedClass(env, "bwapi4/UnitCommand");
jmethodID retConsID = FindCachedMethod(env, retcls, "<init>", "(Lbwapi4/Unit;Lbwapi4/UnitCommandType;Lbwapi4/Unit;III)V");
jobject result = env->NewObject(retcls, retConsID, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/Unit"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/Unit"), "get", "(J)Lbwapi4/Unit;"), cresult.getUnit())
, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/UnitCommandType"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/UnitCommandType"), "get", "(J)Lbwapi4/UnitCommandType;"), (jlong)tableUnitCommandType.find(cresult.getType().getID())->second )
...
JNIEXPORT jobject JNICALL Java_bwapi4_UnitCommand_train(JNIEnv * env, jclass jclz, jobject p_unit, jobject p_type){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
UnitType* type = (UnitType*)env->GetLongField(p_type, FindCachedField(env, env->GetObjectClass(p_type), "pointer", "J"));
UnitCommand cresult = UnitCommand::train(unit, *type);
jclass retcls = FindCachedClass(env, "bwapi4/UnitCommand");
jmethodID retConsID = FindCachedMethod(env, retcls, "<init>", "(Lbwapi4/Unit;Lbwapi4/UnitCommandType;Lbwapi4/Unit;III)V");
jobject result = env->NewObject(retcls, retConsID, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/Unit"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/Unit"), "get", "(J)Lbwapi4/Unit;"), cresult.getUnit())
, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/UnitCommandType"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/UnitCommandType"), "get", "(J)Lbwapi4/UnitCommandType;"), (jlong)tableUnitCommandType.find(cresult.getType().getID())->second )
...
JNIEXPORT jobject JNICALL Java_bwapi4_UnitCommand_morph(JNIEnv * env, jclass jclz, jobject p_unit, jobject p_type){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
UnitType* type = (UnitType*)env->GetLongField(p_type, FindCachedField(env, env->GetObjectClass(p_type), "pointer", "J"));
UnitCommand cresult = UnitCommand::morph(unit, *type);
jclass retcls = FindCachedClass(env, "bwapi4/UnitCommand");
jmethodID retConsID = FindCachedMethod(env, retcls, "<init>", "(Lbwapi4/Unit;Lbwapi4/UnitCommandType;Lbwapi4/Unit;III)V");
jobject result = env->NewObject(retcls, retConsID, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/Unit"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/Unit"), "get", "(J)Lbwapi4/Unit;"), cresult.getUnit())
, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/UnitCommandType"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/UnitCommandType"), "get", "(J)Lbwapi4/UnitCommandType;"), (jlong)tableUnitCommandType.find(cresult.getType().getID())->second )
...
JNIEXPORT jobject JNICALL Java_bwapi4_UnitCommand_research(JNIEnv * env, jclass jclz, jobject p_unit, jobject p_tech){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
TechType* tech = (TechType*)env->GetLongField(p_tech, FindCachedField(env, env->GetObjectClass(p_tech), "pointer", "J"));
UnitCommand cresult = UnitCommand::research(unit, *tech);
jclass retcls = FindCachedClass(env, "bwapi4/UnitCommand");
jmethodID retConsID = FindCachedMethod(env, retcls, "<init>", "(Lbwapi4/Unit;Lbwapi4/UnitCommandType;Lbwapi4/Unit;III)V");
jobject result = env->NewObject(retcls, retConsID, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/Unit"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/Unit"), "get", "(J)Lbwapi4/Unit;"), cresult.getUnit())
, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/UnitCommandType"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/UnitCommandType"), "get", "(J)Lbwapi4/UnitCommandType;"), (jlong)tableUnitCommandType.find(cresult.getType().getID())->second )
...
JNIEXPORT jobject JNICALL Java_bwapi4_UnitCommand_upgrade(JNIEnv * env, jclass jclz, jobject p_unit, jobject p_upgrade){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
UpgradeType* upgrade = (UpgradeType*)env->GetLongField(p_upgrade, FindCachedField(env, env->GetObjectClass(p_upgrade), "pointer", "J"));
UnitCommand cresult = UnitCommand::upgrade(unit, *upgrade);
jclass retcls = FindCachedClass(env, "bwapi4/UnitCommand");
jmethodID retConsID = FindCachedMethod(env, retcls, "<init>", "(Lbwapi4/Unit;Lbwapi4/UnitCommandType;Lbwapi4/Unit;III)V");
jobject result = env->NewObject(retcls, retConsID, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/Unit"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/Unit"), "get", "(J)Lbwapi4/Unit;"), cresult.getUnit())
, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/UnitCommandType"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/UnitCommandType"), "get", "(J)Lbwapi4/UnitCommandType;"), (jlong)tableUnitCommandType.find(cresult.getType().getID())->second )
...
JNIEXPORT jobject JNICALL Java_bwapi4_UnitCommand_setRallyPoint(JNIEnv * env, jclass jclz, jobject p_unit, jobject p_target){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
PositionOrUnit target(convertPositionOrUnit(env, p_target ));
UnitCommand cresult = UnitCommand::setRallyPoint(unit, target);
jclass retcls = FindCachedClass(env, "bwapi4/UnitCommand");
jmethodID retConsID = FindCachedMethod(env, retcls, "<init>", "(Lbwapi4/Unit;Lbwapi4/UnitCommandType;Lbwapi4/Unit;III)V");
jobject result = env->NewObject(retcls, retConsID, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/Unit"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/Unit"), "get", "(J)Lbwapi4/Unit;"), cresult.getUnit())
, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/UnitCommandType"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/UnitCommandType"), "get", "(J)Lbwapi4/UnitCommandType;"), (jlong)tableUnitCommandType.find(cresult.getType().getID())->second )
...
JNIEXPORT jobject JNICALL Java_bwapi4_UnitCommand_move__Lbwapi4_Unit_2Lbwapi4_Position_2(JNIEnv * env, jclass jclz, jobject p_unit, jobject p_target){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
Position target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
UnitCommand cresult = UnitCommand::move(unit, target);
jclass retcls = FindCachedClass(env, "bwapi4/UnitCommand");
jmethodID retConsID = FindCachedMethod(env, retcls, "<init>", "(Lbwapi4/Unit;Lbwapi4/UnitCommandType;Lbwapi4/Unit;III)V");
jobject result = env->NewObject(retcls, retConsID, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/Unit"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/Unit"), "get", "(J)Lbwapi4/Unit;"), cresult.getUnit())
, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/UnitCommandType"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/UnitCommandType"), "get", "(J)Lbwapi4/UnitCommandType;"), (jlong)tableUnitCommandType.find(cresult.getType().getID())->second )
...
JNIEXPORT jobject JNICALL Java_bwapi4_UnitCommand_move__Lbwapi4_Unit_2Lbwapi4_Position_2Z(JNIEnv * env, jclass jclz, jobject p_unit, jobject p_target, jboolean shiftQueueCommand){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
Position target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
UnitCommand cresult = UnitCommand::move(unit, target, (bool)shiftQueueCommand);
jclass retcls = FindCachedClass(env, "bwapi4/UnitCommand");
jmethodID retConsID = FindCachedMethod(env, retcls, "<init>", "(Lbwapi4/Unit;Lbwapi4/UnitCommandType;Lbwapi4/Unit;III)V");
jobject result = env->NewObject(retcls, retConsID, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/Unit"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/Unit"), "get", "(J)Lbwapi4/Unit;"), cresult.getUnit())
, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/UnitCommandType"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/UnitCommandType"), "get", "(J)Lbwapi4/UnitCommandType;"), (jlong)tableUnitCommandType.find(cresult.getType().getID())->second )
...
JNIEXPORT jobject JNICALL Java_bwapi4_UnitCommand_patrol__Lbwapi4_Unit_2Lbwapi4_Position_2(JNIEnv * env, jclass jclz, jobject p_unit, jobject p_target){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
Position target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
UnitCommand cresult = UnitCommand::patrol(unit, target);
jclass retcls = FindCachedClass(env, "bwapi4/UnitCommand");
jmethodID retConsID = FindCachedMethod(env, retcls, "<init>", "(Lbwapi4/Unit;Lbwapi4/UnitCommandType;Lbwapi4/Unit;III)V");
jobject result = env->NewObject(retcls, retConsID, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/Unit"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/Unit"), "get", "(J)Lbwapi4/Unit;"), cresult.getUnit())
, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/UnitCommandType"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/UnitCommandType"), "get", "(J)Lbwapi4/UnitCommandType;"), (jlong)tableUnitCommandType.find(cresult.getType().getID())->second )
...
JNIEXPORT jobject JNICALL Java_bwapi4_UnitCommand_patrol__Lbwapi4_Unit_2Lbwapi4_Position_2Z(JNIEnv * env, jclass jclz, jobject p_unit, jobject p_target, jboolean shiftQueueCommand){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
Position target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
UnitCommand cresult = UnitCommand::patrol(unit, target, (bool)shiftQueueCommand);
jclass retcls = FindCachedClass(env, "bwapi4/UnitCommand");
jmethodID retConsID = FindCachedMethod(env, retcls, "<init>", "(Lbwapi4/Unit;Lbwapi4/UnitCommandType;Lbwapi4/Unit;III)V");
jobject result = env->NewObject(retcls, retConsID, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/Unit"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/Unit"), "get", "(J)Lbwapi4/Unit;"), cresult.getUnit())
, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/UnitCommandType"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/UnitCommandType"), "get", "(J)Lbwapi4/UnitCommandType;"), (jlong)tableUnitCommandType.find(cresult.getType().getID())->second )
...
JNIEXPORT jobject JNICALL Java_bwapi4_UnitCommand_holdPosition__Lbwapi4_Unit_2(JNIEnv * env, jclass jclz, jobject p_unit){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
UnitCommand cresult = UnitCommand::holdPosition(unit);
jclass retcls = FindCachedClass(env, "bwapi4/UnitCommand");
jmethodID retConsID = FindCachedMethod(env, retcls, "<init>", "(Lbwapi4/Unit;Lbwapi4/UnitCommandType;Lbwapi4/Unit;III)V");
jobject result = env->NewObject(retcls, retConsID, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/Unit"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/Unit"), "get", "(J)Lbwapi4/Unit;"), cresult.getUnit())
, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/UnitCommandType"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/UnitCommandType"), "get", "(J)Lbwapi4/UnitCommandType;"), (jlong)tableUnitCommandType.find(cresult.getType().getID())->second )
...
JNIEXPORT jobject JNICALL Java_bwapi4_UnitCommand_holdPosition__Lbwapi4_Unit_2Z(JNIEnv * env, jclass jclz, jobject p_unit, jboolean shiftQueueCommand){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
UnitCommand cresult = UnitCommand::holdPosition(unit, (bool)shiftQueueCommand);
jclass retcls = FindCachedClass(env, "bwapi4/UnitCommand");
jmethodID retConsID = FindCachedMethod(env, retcls, "<init>", "(Lbwapi4/Unit;Lbwapi4/UnitCommandType;Lbwapi4/Unit;III)V");
jobject result = env->NewObject(retcls, retConsID, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/Unit"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/Unit"), "get", "(J)Lbwapi4/Unit;"), cresult.getUnit())
, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/UnitCommandType"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/UnitCommandType"), "get", "(J)Lbwapi4/UnitCommandType;"), (jlong)tableUnitCommandType.find(cresult.getType().getID())->second )
...
JNIEXPORT jobject JNICALL Java_bwapi4_UnitCommand_stop__Lbwapi4_Unit_2(JNIEnv * env, jclass jclz, jobject p_unit){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
UnitCommand cresult = UnitCommand::stop(unit);
jclass retcls = FindCachedClass(env, "bwapi4/UnitCommand");
jmethodID retConsID = FindCachedMethod(env, retcls, "<init>", "(Lbwapi4/Unit;Lbwapi4/UnitCommandType;Lbwapi4/Unit;III)V");
jobject result = env->NewObject(retcls, retConsID, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/Unit"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/Unit"), "get", "(J)Lbwapi4/Unit;"), cresult.getUnit())
, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/UnitCommandType"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/UnitCommandType"), "get", "(J)Lbwapi4/UnitCommandType;"), (jlong)tableUnitCommandType.find(cresult.getType().getID())->second )
...
JNIEXPORT jobject JNICALL Java_bwapi4_UnitCommand_stop__Lbwapi4_Unit_2Z(JNIEnv * env, jclass jclz, jobject p_unit, jboolean shiftQueueCommand){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
UnitCommand cresult = UnitCommand::stop(unit, (bool)shiftQueueCommand);
jclass retcls = FindCachedClass(env, "bwapi4/UnitCommand");
jmethodID retConsID = FindCachedMethod(env, retcls, "<init>", "(Lbwapi4/Unit;Lbwapi4/UnitCommandType;Lbwapi4/Unit;III)V");
jobject result = env->NewObject(retcls, retConsID, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/Unit"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/Unit"), "get", "(J)Lbwapi4/Unit;"), cresult.getUnit())
, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/UnitCommandType"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/UnitCommandType"), "get", "(J)Lbwapi4/UnitCommandType;"), (jlong)tableUnitCommandType.find(cresult.getType().getID())->second )
...
JNIEXPORT jobject JNICALL Java_bwapi4_UnitCommand_follow__Lbwapi4_Unit_2Lbwapi4_Unit_2(JNIEnv * env, jclass jclz, jobject p_unit, jobject p_target){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
Unit target = (Unit)env->GetLongField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "pointer", "J"));
UnitCommand cresult = UnitCommand::follow(unit, target);
jclass retcls = FindCachedClass(env, "bwapi4/UnitCommand");
jmethodID retConsID = FindCachedMethod(env, retcls, "<init>", "(Lbwapi4/Unit;Lbwapi4/UnitCommandType;Lbwapi4/Unit;III)V");
jobject result = env->NewObject(retcls, retConsID, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/Unit"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/Unit"), "get", "(J)Lbwapi4/Unit;"), cresult.getUnit())
, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/UnitCommandType"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/UnitCommandType"), "get", "(J)Lbwapi4/UnitCommandType;"), (jlong)tableUnitCommandType.find(cresult.getType().getID())->second )
...
JNIEXPORT jobject JNICALL Java_bwapi4_UnitCommand_follow__Lbwapi4_Unit_2Lbwapi4_Unit_2Z(JNIEnv * env, jclass jclz, jobject p_unit, jobject p_target, jboolean shiftQueueCommand){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
Unit target = (Unit)env->GetLongField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "pointer", "J"));
UnitCommand cresult = UnitCommand::follow(unit, target, (bool)shiftQueueCommand);
jclass retcls = FindCachedClass(env, "bwapi4/UnitCommand");
jmethodID retConsID = FindCachedMethod(env, retcls, "<init>", "(Lbwapi4/Unit;Lbwapi4/UnitCommandType;Lbwapi4/Unit;III)V");
jobject result = env->NewObject(retcls, retConsID, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/Unit"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/Unit"), "get", "(J)Lbwapi4/Unit;"), cresult.getUnit())
, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/UnitCommandType"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/UnitCommandType"), "get", "(J)Lbwapi4/UnitCommandType;"), (jlong)tableUnitCommandType.find(cresult.getType().getID())->second )
...
JNIEXPORT jobject JNICALL Java_bwapi4_UnitCommand_gather__Lbwapi4_Unit_2Lbwapi4_Unit_2(JNIEnv * env, jclass jclz, jobject p_unit, jobject p_target){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
Unit target = (Unit)env->GetLongField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "pointer", "J"));
UnitCommand cresult = UnitCommand::gather(unit, target);
jclass retcls = FindCachedClass(env, "bwapi4/UnitCommand");
jmethodID retConsID = FindCachedMethod(env, retcls, "<init>", "(Lbwapi4/Unit;Lbwapi4/UnitCommandType;Lbwapi4/Unit;III)V");
jobject result = env->NewObject(retcls, retConsID, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/Unit"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/Unit"), "get", "(J)Lbwapi4/Unit;"), cresult.getUnit())
, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/UnitCommandType"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/UnitCommandType"), "get", "(J)Lbwapi4/UnitCommandType;"), (jlong)tableUnitCommandType.find(cresult.getType().getID())->second )
...
JNIEXPORT jobject JNICALL Java_bwapi4_UnitCommand_gather__Lbwapi4_Unit_2Lbwapi4_Unit_2Z(JNIEnv * env, jclass jclz, jobject p_unit, jobject p_target, jboolean shiftQueueCommand){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
Unit target = (Unit)env->GetLongField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "pointer", "J"));
UnitCommand cresult = UnitCommand::gather(unit, target, (bool)shiftQueueCommand);
jclass retcls = FindCachedClass(env, "bwapi4/UnitCommand");
jmethodID retConsID = FindCachedMethod(env, retcls, "<init>", "(Lbwapi4/Unit;Lbwapi4/UnitCommandType;Lbwapi4/Unit;III)V");
jobject result = env->NewObject(retcls, retConsID, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/Unit"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/Unit"), "get", "(J)Lbwapi4/Unit;"), cresult.getUnit())
, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/UnitCommandType"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/UnitCommandType"), "get", "(J)Lbwapi4/UnitCommandType;"), (jlong)tableUnitCommandType.find(cresult.getType().getID())->second )
...
JNIEXPORT jobject JNICALL Java_bwapi4_UnitCommand_returnCargo__Lbwapi4_Unit_2(JNIEnv * env, jclass jclz, jobject p_unit){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
UnitCommand cresult = UnitCommand::returnCargo(unit);
jclass retcls = FindCachedClass(env, "bwapi4/UnitCommand");
jmethodID retConsID = FindCachedMethod(env, retcls, "<init>", "(Lbwapi4/Unit;Lbwapi4/UnitCommandType;Lbwapi4/Unit;III)V");
jobject result = env->NewObject(retcls, retConsID, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/Unit"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/Unit"), "get", "(J)Lbwapi4/Unit;"), cresult.getUnit())
, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/UnitCommandType"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/UnitCommandType"), "get", "(J)Lbwapi4/UnitCommandType;"), (jlong)tableUnitCommandType.find(cresult.getType().getID())->second )
...
JNIEXPORT jobject JNICALL Java_bwapi4_UnitCommand_returnCargo__Lbwapi4_Unit_2Z(JNIEnv * env, jclass jclz, jobject p_unit, jboolean shiftQueueCommand){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
UnitCommand cresult = UnitCommand::returnCargo(unit, (bool)shiftQueueCommand);
jclass retcls = FindCachedClass(env, "bwapi4/UnitCommand");
jmethodID retConsID = FindCachedMethod(env, retcls, "<init>", "(Lbwapi4/Unit;Lbwapi4/UnitCommandType;Lbwapi4/Unit;III)V");
jobject result = env->NewObject(retcls, retConsID, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/Unit"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/Unit"), "get", "(J)Lbwapi4/Unit;"), cresult.getUnit())
, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/UnitCommandType"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/UnitCommandType"), "get", "(J)Lbwapi4/UnitCommandType;"), (jlong)tableUnitCommandType.find(cresult.getType().getID())->second )
...
JNIEXPORT jobject JNICALL Java_bwapi4_UnitCommand_repair__Lbwapi4_Unit_2Lbwapi4_Unit_2(JNIEnv * env, jclass jclz, jobject p_unit, jobject p_target){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
Unit target = (Unit)env->GetLongField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "pointer", "J"));
UnitCommand cresult = UnitCommand::repair(unit, target);
jclass retcls = FindCachedClass(env, "bwapi4/UnitCommand");
jmethodID retConsID = FindCachedMethod(env, retcls, "<init>", "(Lbwapi4/Unit;Lbwapi4/UnitCommandType;Lbwapi4/Unit;III)V");
jobject result = env->NewObject(retcls, retConsID, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/Unit"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/Unit"), "get", "(J)Lbwapi4/Unit;"), cresult.getUnit())
, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/UnitCommandType"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/UnitCommandType"), "get", "(J)Lbwapi4/UnitCommandType;"), (jlong)tableUnitCommandType.find(cresult.getType().getID())->second )
...
JNIEXPORT jobject JNICALL Java_bwapi4_UnitCommand_repair__Lbwapi4_Unit_2Lbwapi4_Unit_2Z(JNIEnv * env, jclass jclz, jobject p_unit, jobject p_target, jboolean shiftQueueCommand){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
Unit target = (Unit)env->GetLongField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "pointer", "J"));
UnitCommand cresult = UnitCommand::repair(unit, target, (bool)shiftQueueCommand);
jclass retcls = FindCachedClass(env, "bwapi4/UnitCommand");
jmethodID retConsID = FindCachedMethod(env, retcls, "<init>", "(Lbwapi4/Unit;Lbwapi4/UnitCommandType;Lbwapi4/Unit;III)V");
jobject result = env->NewObject(retcls, retConsID, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/Unit"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/Unit"), "get", "(J)Lbwapi4/Unit;"), cresult.getUnit())
, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/UnitCommandType"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/UnitCommandType"), "get", "(J)Lbwapi4/UnitCommandType;"), (jlong)tableUnitCommandType.find(cresult.getType().getID())->second )
...
JNIEXPORT jobject JNICALL Java_bwapi4_UnitCommand_burrow(JNIEnv * env, jclass jclz, jobject p_unit){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
UnitCommand cresult = UnitCommand::burrow(unit);
jclass retcls = FindCachedClass(env, "bwapi4/UnitCommand");
jmethodID retConsID = FindCachedMethod(env, retcls, "<init>", "(Lbwapi4/Unit;Lbwapi4/UnitCommandType;Lbwapi4/Unit;III)V");
jobject result = env->NewObject(retcls, retConsID, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/Unit"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/Unit"), "get", "(J)Lbwapi4/Unit;"), cresult.getUnit())
, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/UnitCommandType"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/UnitCommandType"), "get", "(J)Lbwapi4/UnitCommandType;"), (jlong)tableUnitCommandType.find(cresult.getType().getID())->second )
...
JNIEXPORT jobject JNICALL Java_bwapi4_UnitCommand_unburrow(JNIEnv * env, jclass jclz, jobject p_unit){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
UnitCommand cresult = UnitCommand::unburrow(unit);
jclass retcls = FindCachedClass(env, "bwapi4/UnitCommand");
jmethodID retConsID = FindCachedMethod(env, retcls, "<init>", "(Lbwapi4/Unit;Lbwapi4/UnitCommandType;Lbwapi4/Unit;III)V");
jobject result = env->NewObject(retcls, retConsID, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/Unit"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/Unit"), "get", "(J)Lbwapi4/Unit;"), cresult.getUnit())
, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/UnitCommandType"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/UnitCommandType"), "get", "(J)Lbwapi4/UnitCommandType;"), (jlong)tableUnitCommandType.find(cresult.getType().getID())->second )
...
JNIEXPORT jobject JNICALL Java_bwapi4_UnitCommand_cloak(JNIEnv * env, jclass jclz, jobject p_unit){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
UnitCommand cresult = UnitCommand::cloak(unit);
jclass retcls = FindCachedClass(env, "bwapi4/UnitCommand");
jmethodID retConsID = FindCachedMethod(env, retcls, "<init>", "(Lbwapi4/Unit;Lbwapi4/UnitCommandType;Lbwapi4/Unit;III)V");
jobject result = env->NewObject(retcls, retConsID, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/Unit"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/Unit"), "get", "(J)Lbwapi4/Unit;"), cresult.getUnit())
, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/UnitCommandType"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/UnitCommandType"), "get", "(J)Lbwapi4/UnitCommandType;"), (jlong)tableUnitCommandType.find(cresult.getType().getID())->second )
...
JNIEXPORT jobject JNICALL Java_bwapi4_UnitCommand_decloak(JNIEnv * env, jclass jclz, jobject p_unit){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
UnitCommand cresult = UnitCommand::decloak(unit);
jclass retcls = FindCachedClass(env, "bwapi4/UnitCommand");
jmethodID retConsID = FindCachedMethod(env, retcls, "<init>", "(Lbwapi4/Unit;Lbwapi4/UnitCommandType;Lbwapi4/Unit;III)V");
jobject result = env->NewObject(retcls, retConsID, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/Unit"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/Unit"), "get", "(J)Lbwapi4/Unit;"), cresult.getUnit())
, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/UnitCommandType"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/UnitCommandType"), "get", "(J)Lbwapi4/UnitCommandType;"), (jlong)tableUnitCommandType.find(cresult.getType().getID())->second )
...
JNIEXPORT jobject JNICALL Java_bwapi4_UnitCommand_siege(JNIEnv * env, jclass jclz, jobject p_unit){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
UnitCommand cresult = UnitCommand::siege(unit);
jclass retcls = FindCachedClass(env, "bwapi4/UnitCommand");
jmethodID retConsID = FindCachedMethod(env, retcls, "<init>", "(Lbwapi4/Unit;Lbwapi4/UnitCommandType;Lbwapi4/Unit;III)V");
jobject result = env->NewObject(retcls, retConsID, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/Unit"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/Unit"), "get", "(J)Lbwapi4/Unit;"), cresult.getUnit())
, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/UnitCommandType"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/UnitCommandType"), "get", "(J)Lbwapi4/UnitCommandType;"), (jlong)tableUnitCommandType.find(cresult.getType().getID())->second )
...
JNIEXPORT jobject JNICALL Java_bwapi4_UnitCommand_unsiege(JNIEnv * env, jclass jclz, jobject p_unit){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
UnitCommand cresult = UnitCommand::unsiege(unit);
jclass retcls = FindCachedClass(env, "bwapi4/UnitCommand");
jmethodID retConsID = FindCachedMethod(env, retcls, "<init>", "(Lbwapi4/Unit;Lbwapi4/UnitCommandType;Lbwapi4/Unit;III)V");
jobject result = env->NewObject(retcls, retConsID, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/Unit"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/Unit"), "get", "(J)Lbwapi4/Unit;"), cresult.getUnit())
, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/UnitCommandType"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/UnitCommandType"), "get", "(J)Lbwapi4/UnitCommandType;"), (jlong)tableUnitCommandType.find(cresult.getType().getID())->second )
...
JNIEXPORT jobject JNICALL Java_bwapi4_UnitCommand_lift(JNIEnv * env, jclass jclz, jobject p_unit){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
UnitCommand cresult = UnitCommand::lift(unit);
jclass retcls = FindCachedClass(env, "bwapi4/UnitCommand");
jmethodID retConsID = FindCachedMethod(env, retcls, "<init>", "(Lbwapi4/Unit;Lbwapi4/UnitCommandType;Lbwapi4/Unit;III)V");
jobject result = env->NewObject(retcls, retConsID, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/Unit"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/Unit"), "get", "(J)Lbwapi4/Unit;"), cresult.getUnit())
, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/UnitCommandType"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/UnitCommandType"), "get", "(J)Lbwapi4/UnitCommandType;"), (jlong)tableUnitCommandType.find(cresult.getType().getID())->second )
...
JNIEXPORT jobject JNICALL Java_bwapi4_UnitCommand_land(JNIEnv * env, jclass jclz, jobject p_unit, jobject p_target){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
TilePosition target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
UnitCommand cresult = UnitCommand::land(unit, target);
jclass retcls = FindCachedClass(env, "bwapi4/UnitCommand");
jmethodID retConsID = FindCachedMethod(env, retcls, "<init>", "(Lbwapi4/Unit;Lbwapi4/UnitCommandType;Lbwapi4/Unit;III)V");
jobject result = env->NewObject(retcls, retConsID, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/Unit"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/Unit"), "get", "(J)Lbwapi4/Unit;"), cresult.getUnit())
, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/UnitCommandType"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/UnitCommandType"), "get", "(J)Lbwapi4/UnitCommandType;"), (jlong)tableUnitCommandType.find(cresult.getType().getID())->second )
...
JNIEXPORT jobject JNICALL Java_bwapi4_UnitCommand_load__Lbwapi4_Unit_2Lbwapi4_Unit_2(JNIEnv * env, jclass jclz, jobject p_unit, jobject p_target){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
Unit target = (Unit)env->GetLongField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "pointer", "J"));
UnitCommand cresult = UnitCommand::load(unit, target);
jclass retcls = FindCachedClass(env, "bwapi4/UnitCommand");
jmethodID retConsID = FindCachedMethod(env, retcls, "<init>", "(Lbwapi4/Unit;Lbwapi4/UnitCommandType;Lbwapi4/Unit;III)V");
jobject result = env->NewObject(retcls, retConsID, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/Unit"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/Unit"), "get", "(J)Lbwapi4/Unit;"), cresult.getUnit())
, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/UnitCommandType"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/UnitCommandType"), "get", "(J)Lbwapi4/UnitCommandType;"), (jlong)tableUnitCommandType.find(cresult.getType().getID())->second )
...
JNIEXPORT jobject JNICALL Java_bwapi4_UnitCommand_load__Lbwapi4_Unit_2Lbwapi4_Unit_2Z(JNIEnv * env, jclass jclz, jobject p_unit, jobject p_target, jboolean shiftQueueCommand){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
Unit target = (Unit)env->GetLongField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "pointer", "J"));
UnitCommand cresult = UnitCommand::load(unit, target, (bool)shiftQueueCommand);
jclass retcls = FindCachedClass(env, "bwapi4/UnitCommand");
jmethodID retConsID = FindCachedMethod(env, retcls, "<init>", "(Lbwapi4/Unit;Lbwapi4/UnitCommandType;Lbwapi4/Unit;III)V");
jobject result = env->NewObject(retcls, retConsID, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/Unit"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/Unit"), "get", "(J)Lbwapi4/Unit;"), cresult.getUnit())
, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/UnitCommandType"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/UnitCommandType"), "get", "(J)Lbwapi4/UnitCommandType;"), (jlong)tableUnitCommandType.find(cresult.getType().getID())->second )
...
JNIEXPORT jobject JNICALL Java_bwapi4_UnitCommand_unload(JNIEnv * env, jclass jclz, jobject p_unit, jobject p_target){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
Unit target = (Unit)env->GetLongField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "pointer", "J"));
UnitCommand cresult = UnitCommand::unload(unit, target);
jclass retcls = FindCachedClass(env, "bwapi4/UnitCommand");
jmethodID retConsID = FindCachedMethod(env, retcls, "<init>", "(Lbwapi4/Unit;Lbwapi4/UnitCommandType;Lbwapi4/Unit;III)V");
jobject result = env->NewObject(retcls, retConsID, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/Unit"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/Unit"), "get", "(J)Lbwapi4/Unit;"), cresult.getUnit())
, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/UnitCommandType"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/UnitCommandType"), "get", "(J)Lbwapi4/UnitCommandType;"), (jlong)tableUnitCommandType.find(cresult.getType().getID())->second )
...
JNIEXPORT jobject JNICALL Java_bwapi4_UnitCommand_unloadAll__Lbwapi4_Unit_2(JNIEnv * env, jclass jclz, jobject p_unit){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
UnitCommand cresult = UnitCommand::unloadAll(unit);
jclass retcls = FindCachedClass(env, "bwapi4/UnitCommand");
jmethodID retConsID = FindCachedMethod(env, retcls, "<init>", "(Lbwapi4/Unit;Lbwapi4/UnitCommandType;Lbwapi4/Unit;III)V");
jobject result = env->NewObject(retcls, retConsID, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/Unit"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/Unit"), "get", "(J)Lbwapi4/Unit;"), cresult.getUnit())
, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/UnitCommandType"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/UnitCommandType"), "get", "(J)Lbwapi4/UnitCommandType;"), (jlong)tableUnitCommandType.find(cresult.getType().getID())->second )
...
JNIEXPORT jobject JNICALL Java_bwapi4_UnitCommand_unloadAll__Lbwapi4_Unit_2Z(JNIEnv * env, jclass jclz, jobject p_unit, jboolean shiftQueueCommand){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
UnitCommand cresult = UnitCommand::unloadAll(unit, (bool)shiftQueueCommand);
jclass retcls = FindCachedClass(env, "bwapi4/UnitCommand");
jmethodID retConsID = FindCachedMethod(env, retcls, "<init>", "(Lbwapi4/Unit;Lbwapi4/UnitCommandType;Lbwapi4/Unit;III)V");
jobject result = env->NewObject(retcls, retConsID, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/Unit"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/Unit"), "get", "(J)Lbwapi4/Unit;"), cresult.getUnit())
, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/UnitCommandType"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/UnitCommandType"), "get", "(J)Lbwapi4/UnitCommandType;"), (jlong)tableUnitCommandType.find(cresult.getType().getID())->second )
...
JNIEXPORT jobject JNICALL Java_bwapi4_UnitCommand_unloadAll__Lbwapi4_Unit_2Lbwapi4_Position_2(JNIEnv * env, jclass jclz, jobject p_unit, jobject p_target){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
Position target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
UnitCommand cresult = UnitCommand::unloadAll(unit, target);
jclass retcls = FindCachedClass(env, "bwapi4/UnitCommand");
jmethodID retConsID = FindCachedMethod(env, retcls, "<init>", "(Lbwapi4/Unit;Lbwapi4/UnitCommandType;Lbwapi4/Unit;III)V");
jobject result = env->NewObject(retcls, retConsID, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/Unit"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/Unit"), "get", "(J)Lbwapi4/Unit;"), cresult.getUnit())
, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/UnitCommandType"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/UnitCommandType"), "get", "(J)Lbwapi4/UnitCommandType;"), (jlong)tableUnitCommandType.find(cresult.getType().getID())->second )
...
JNIEXPORT jobject JNICALL Java_bwapi4_UnitCommand_unloadAll__Lbwapi4_Unit_2Lbwapi4_Position_2Z(JNIEnv * env, jclass jclz, jobject p_unit, jobject p_target, jboolean shiftQueueCommand){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
Position target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
UnitCommand cresult = UnitCommand::unloadAll(unit, target, (bool)shiftQueueCommand);
jclass retcls = FindCachedClass(env, "bwapi4/UnitCommand");
jmethodID retConsID = FindCachedMethod(env, retcls, "<init>", "(Lbwapi4/Unit;Lbwapi4/UnitCommandType;Lbwapi4/Unit;III)V");
jobject result = env->NewObject(retcls, retConsID, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/Unit"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/Unit"), "get", "(J)Lbwapi4/Unit;"), cresult.getUnit())
, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/UnitCommandType"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/UnitCommandType"), "get", "(J)Lbwapi4/UnitCommandType;"), (jlong)tableUnitCommandType.find(cresult.getType().getID())->second )
...
JNIEXPORT jobject JNICALL Java_bwapi4_UnitCommand_rightClick__Lbwapi4_Unit_2Lbwapi4_PositionOrUnit_2(JNIEnv * env, jclass jclz, jobject p_unit, jobject p_target){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
PositionOrUnit target(convertPositionOrUnit(env, p_target ));
UnitCommand cresult = UnitCommand::rightClick(unit, target);
jclass retcls = FindCachedClass(env, "bwapi4/UnitCommand");
jmethodID retConsID = FindCachedMethod(env, retcls, "<init>", "(Lbwapi4/Unit;Lbwapi4/UnitCommandType;Lbwapi4/Unit;III)V");
jobject result = env->NewObject(retcls, retConsID, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/Unit"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/Unit"), "get", "(J)Lbwapi4/Unit;"), cresult.getUnit())
, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/UnitCommandType"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/UnitCommandType"), "get", "(J)Lbwapi4/UnitCommandType;"), (jlong)tableUnitCommandType.find(cresult.getType().getID())->second )
...
JNIEXPORT jobject JNICALL Java_bwapi4_UnitCommand_rightClick__Lbwapi4_Unit_2Lbwapi4_PositionOrUnit_2Z(JNIEnv * env, jclass jclz, jobject p_unit, jobject p_target, jboolean shiftQueueCommand){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
PositionOrUnit target(convertPositionOrUnit(env, p_target ));
UnitCommand cresult = UnitCommand::rightClick(unit, target, (bool)shiftQueueCommand);
jclass retcls = FindCachedClass(env, "bwapi4/UnitCommand");
jmethodID retConsID = FindCachedMethod(env, retcls, "<init>", "(Lbwapi4/Unit;Lbwapi4/UnitCommandType;Lbwapi4/Unit;III)V");
jobject result = env->NewObject(retcls, retConsID, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/Unit"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/Unit"), "get", "(J)Lbwapi4/Unit;"), cresult.getUnit())
, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/UnitCommandType"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/UnitCommandType"), "get", "(J)Lbwapi4/UnitCommandType;"), (jlong)tableUnitCommandType.find(cresult.getType().getID())->second )
...
JNIEXPORT jobject JNICALL Java_bwapi4_UnitCommand_haltConstruction(JNIEnv * env, jclass jclz, jobject p_unit){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
UnitCommand cresult = UnitCommand::haltConstruction(unit);
jclass retcls = FindCachedClass(env, "bwapi4/UnitCommand");
jmethodID retConsID = FindCachedMethod(env, retcls, "<init>", "(Lbwapi4/Unit;Lbwapi4/UnitCommandType;Lbwapi4/Unit;III)V");
jobject result = env->NewObject(retcls, retConsID, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/Unit"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/Unit"), "get", "(J)Lbwapi4/Unit;"), cresult.getUnit())
, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/UnitCommandType"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/UnitCommandType"), "get", "(J)Lbwapi4/UnitCommandType;"), (jlong)tableUnitCommandType.find(cresult.getType().getID())->second )
...
JNIEXPORT jobject JNICALL Java_bwapi4_UnitCommand_cancelConstruction(JNIEnv * env, jclass jclz, jobject p_unit){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
UnitCommand cresult = UnitCommand::cancelConstruction(unit);
jclass retcls = FindCachedClass(env, "bwapi4/UnitCommand");
jmethodID retConsID = FindCachedMethod(env, retcls, "<init>", "(Lbwapi4/Unit;Lbwapi4/UnitCommandType;Lbwapi4/Unit;III)V");
jobject result = env->NewObject(retcls, retConsID, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/Unit"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/Unit"), "get", "(J)Lbwapi4/Unit;"), cresult.getUnit())
, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/UnitCommandType"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/UnitCommandType"), "get", "(J)Lbwapi4/UnitCommandType;"), (jlong)tableUnitCommandType.find(cresult.getType().getID())->second )
...
JNIEXPORT jobject JNICALL Java_bwapi4_UnitCommand_cancelAddon(JNIEnv * env, jclass jclz, jobject p_unit){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
UnitCommand cresult = UnitCommand::cancelAddon(unit);
jclass retcls = FindCachedClass(env, "bwapi4/UnitCommand");
jmethodID retConsID = FindCachedMethod(env, retcls, "<init>", "(Lbwapi4/Unit;Lbwapi4/UnitCommandType;Lbwapi4/Unit;III)V");
jobject result = env->NewObject(retcls, retConsID, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/Unit"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/Unit"), "get", "(J)Lbwapi4/Unit;"), cresult.getUnit())
, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/UnitCommandType"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/UnitCommandType"), "get", "(J)Lbwapi4/UnitCommandType;"), (jlong)tableUnitCommandType.find(cresult.getType().getID())->second )
...
JNIEXPORT jobject JNICALL Java_bwapi4_UnitCommand_cancelTrain__Lbwapi4_Unit_2(JNIEnv * env, jclass jclz, jobject p_unit){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
UnitCommand cresult = UnitCommand::cancelTrain(unit);
jclass retcls = FindCachedClass(env, "bwapi4/UnitCommand");
jmethodID retConsID = FindCachedMethod(env, retcls, "<init>", "(Lbwapi4/Unit;Lbwapi4/UnitCommandType;Lbwapi4/Unit;III)V");
jobject result = env->NewObject(retcls, retConsID, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/Unit"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/Unit"), "get", "(J)Lbwapi4/Unit;"), cresult.getUnit())
, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/UnitCommandType"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/UnitCommandType"), "get", "(J)Lbwapi4/UnitCommandType;"), (jlong)tableUnitCommandType.find(cresult.getType().getID())->second )
...
JNIEXPORT jobject JNICALL Java_bwapi4_UnitCommand_cancelTrain__Lbwapi4_Unit_2I(JNIEnv * env, jclass jclz, jobject p_unit, jint slot){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
UnitCommand cresult = UnitCommand::cancelTrain(unit, slot);
jclass retcls = FindCachedClass(env, "bwapi4/UnitCommand");
jmethodID retConsID = FindCachedMethod(env, retcls, "<init>", "(Lbwapi4/Unit;Lbwapi4/UnitCommandType;Lbwapi4/Unit;III)V");
jobject result = env->NewObject(retcls, retConsID, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/Unit"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/Unit"), "get", "(J)Lbwapi4/Unit;"), cresult.getUnit())
, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/UnitCommandType"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/UnitCommandType"), "get", "(J)Lbwapi4/UnitCommandType;"), (jlong)tableUnitCommandType.find(cresult.getType().getID())->second )
...
JNIEXPORT jobject JNICALL Java_bwapi4_UnitCommand_cancelMorph(JNIEnv * env, jclass jclz, jobject p_unit){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
UnitCommand cresult = UnitCommand::cancelMorph(unit);
jclass retcls = FindCachedClass(env, "bwapi4/UnitCommand");
jmethodID retConsID = FindCachedMethod(env, retcls, "<init>", "(Lbwapi4/Unit;Lbwapi4/UnitCommandType;Lbwapi4/Unit;III)V");
jobject result = env->NewObject(retcls, retConsID, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/Unit"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/Unit"), "get", "(J)Lbwapi4/Unit;"), cresult.getUnit())
, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/UnitCommandType"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/UnitCommandType"), "get", "(J)Lbwapi4/UnitCommandType;"), (jlong)tableUnitCommandType.find(cresult.getType().getID())->second )
...
JNIEXPORT jobject JNICALL Java_bwapi4_UnitCommand_cancelResearch(JNIEnv * env, jclass jclz, jobject p_unit){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
UnitCommand cresult = UnitCommand::cancelResearch(unit);
jclass retcls = FindCachedClass(env, "bwapi4/UnitCommand");
jmethodID retConsID = FindCachedMethod(env, retcls, "<init>", "(Lbwapi4/Unit;Lbwapi4/UnitCommandType;Lbwapi4/Unit;III)V");
jobject result = env->NewObject(retcls, retConsID, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/Unit"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/Unit"), "get", "(J)Lbwapi4/Unit;"), cresult.getUnit())
, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/UnitCommandType"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/UnitCommandType"), "get", "(J)Lbwapi4/UnitCommandType;"), (jlong)tableUnitCommandType.find(cresult.getType().getID())->second )
...
JNIEXPORT jobject JNICALL Java_bwapi4_UnitCommand_cancelUpgrade(JNIEnv * env, jclass jclz, jobject p_unit){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
UnitCommand cresult = UnitCommand::cancelUpgrade(unit);
jclass retcls = FindCachedClass(env, "bwapi4/UnitCommand");
jmethodID retConsID = FindCachedMethod(env, retcls, "<init>", "(Lbwapi4/Unit;Lbwapi4/UnitCommandType;Lbwapi4/Unit;III)V");
jobject result = env->NewObject(retcls, retConsID, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/Unit"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/Unit"), "get", "(J)Lbwapi4/Unit;"), cresult.getUnit())
, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/UnitCommandType"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/UnitCommandType"), "get", "(J)Lbwapi4/UnitCommandType;"), (jlong)tableUnitCommandType.find(cresult.getType().getID())->second )
...
JNIEXPORT jobject JNICALL Java_bwapi4_UnitCommand_useTech__Lbwapi4_Unit_2Lbwapi4_TechType_2(JNIEnv * env, jclass jclz, jobject p_unit, jobject p_tech){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
TechType* tech = (TechType*)env->GetLongField(p_tech, FindCachedField(env, env->GetObjectClass(p_tech), "pointer", "J"));
UnitCommand cresult = UnitCommand::useTech(unit, *tech);
jclass retcls = FindCachedClass(env, "bwapi4/UnitCommand");
jmethodID retConsID = FindCachedMethod(env, retcls, "<init>", "(Lbwapi4/Unit;Lbwapi4/UnitCommandType;Lbwapi4/Unit;III)V");
jobject result = env->NewObject(retcls, retConsID, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/Unit"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/Unit"), "get", "(J)Lbwapi4/Unit;"), cresult.getUnit())
, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/UnitCommandType"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/UnitCommandType"), "get", "(J)Lbwapi4/UnitCommandType;"), (jlong)tableUnitCommandType.find(cresult.getType().getID())->second )
...
JNIEXPORT jobject JNICALL Java_bwapi4_UnitCommand_useTech__Lbwapi4_Unit_2Lbwapi4_TechType_2Lbwapi4_PositionOrUnit_2(JNIEnv * env, jclass jclz, jobject p_unit, jobject p_tech, jobject p_target){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
TechType* tech = (TechType*)env->GetLongField(p_tech, FindCachedField(env, env->GetObjectClass(p_tech), "pointer", "J"));
PositionOrUnit target(convertPositionOrUnit(env, p_target ));
UnitCommand cresult = UnitCommand::useTech(unit, *tech, target);
jclass retcls = FindCachedClass(env, "bwapi4/UnitCommand");
jmethodID retConsID = FindCachedMethod(env, retcls, "<init>", "(Lbwapi4/Unit;Lbwapi4/UnitCommandType;Lbwapi4/Unit;III)V");
jobject result = env->NewObject(retcls, retConsID, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/Unit"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/Unit"), "get", "(J)Lbwapi4/Unit;"), cresult.getUnit())
, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/UnitCommandType"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/UnitCommandType"), "get", "(J)Lbwapi4/UnitCommandType;"), (jlong)tableUnitCommandType.find(cresult.getType().getID())->second )
...
JNIEXPORT jobject JNICALL Java_bwapi4_UnitCommand_placeCOP(JNIEnv * env, jclass jclz, jobject p_unit, jobject p_target){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
TilePosition target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
UnitCommand cresult = UnitCommand::placeCOP(unit, target);
jclass retcls = FindCachedClass(env, "bwapi4/UnitCommand");
jmethodID retConsID = FindCachedMethod(env, retcls, "<init>", "(Lbwapi4/Unit;Lbwapi4/UnitCommandType;Lbwapi4/Unit;III)V");
jobject result = env->NewObject(retcls, retConsID, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/Unit"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/Unit"), "get", "(J)Lbwapi4/Unit;"), cresult.getUnit())
, env->CallStaticObjectMethod(FindCachedClass(env, "bwapi4/UnitCommandType"), FindCachedMethodStatic(env, FindCachedClass(env, "bwapi4/UnitCommandType"), "get", "(J)Lbwapi4/UnitCommandType;"), (jlong)tableUnitCommandType.find(cresult.getType().getID())->second )
...
JNIEXPORT jstring JNICALL Java_bwapi4_UnitCommandType_toString_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitCommandType* x_unitCommandType = (UnitCommandType*)pointer;
return env->NewStringUTF(x_unitCommandType->toString().c_str());
}
...
Unitset* x_unitset = (Unitset*)pointer;
Unitset cresult = x_unitset->getLoadedUnits();
jclass listCls = FindCachedClass(env, "java/util/ArrayList");
jmethodID listConsID = FindCachedMethod(env, listCls, "<init>", "()V");
jobject result = env->NewObject(listCls, listConsID);
jmethodID addMethodID = FindCachedMethod(env, listCls, "add", "(Ljava/lang/Object;)Z");
...
Unitset* x_unitset = (Unitset*)pointer;
Unitset cresult = x_unitset->getInterceptors();
jclass listCls = FindCachedClass(env, "java/util/ArrayList");
jmethodID listConsID = FindCachedMethod(env, listCls, "<init>", "()V");
jobject result = env->NewObject(listCls, listConsID);
jmethodID addMethodID = FindCachedMethod(env, listCls, "add", "(Ljava/lang/Object;)Z");
...
Unitset* x_unitset = (Unitset*)pointer;
Unitset cresult = x_unitset->getLarva();
jclass listCls = FindCachedClass(env, "java/util/ArrayList");
jmethodID listConsID = FindCachedMethod(env, listCls, "<init>", "()V");
jobject result = env->NewObject(listCls, listConsID);
jmethodID addMethodID = FindCachedMethod(env, listCls, "add", "(Ljava/lang/Object;)Z");
...
JNIEXPORT jstring JNICALL Java_bwapi4_UnitSizeType_toString_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitSizeType* x_unitSizeType = (UnitSizeType*)pointer;
return env->NewStringUTF(x_unitSizeType->toString().c_str());
}
JNIEXPORT jstring JNICALL Java_bwapi4_UnitType_toString_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return env->NewStringUTF(x_unitType->toString().c_str());
}
JNIEXPORT jobject JNICALL Java_bwapi4_UnitType_getRace_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
...
JNIEXPORT jobject JNICALL Java_bwapi4_UnitType_requiredTech_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
...
JNIEXPORT jobject JNICALL Java_bwapi4_UnitType_cloakingTech_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
...
JNIEXPORT jobject JNICALL Java_bwapi4_UnitType_armorUpgrade_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
...
JNIEXPORT jint JNICALL Java_bwapi4_UnitType_maxHitPoints_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->maxHitPoints();
}
JNIEXPORT jint JNICALL Java_bwapi4_UnitType_maxShields_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->maxShields();
}
JNIEXPORT jint JNICALL Java_bwapi4_UnitType_maxEnergy_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->maxEnergy();
}
JNIEXPORT jint JNICALL Java_bwapi4_UnitType_armor_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->armor();
}
JNIEXPORT jint JNICALL Java_bwapi4_UnitType_mineralPrice_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->mineralPrice();
}
JNIEXPORT jint JNICALL Java_bwapi4_UnitType_gasPrice_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->gasPrice();
}
JNIEXPORT jint JNICALL Java_bwapi4_UnitType_buildTime_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->buildTime();
}
JNIEXPORT jint JNICALL Java_bwapi4_UnitType_supplyRequired_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->supplyRequired();
}
JNIEXPORT jint JNICALL Java_bwapi4_UnitType_supplyProvided_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->supplyProvided();
}
JNIEXPORT jint JNICALL Java_bwapi4_UnitType_spaceRequired_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->spaceRequired();
}
JNIEXPORT jint JNICALL Java_bwapi4_UnitType_spaceProvided_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->spaceProvided();
}
JNIEXPORT jint JNICALL Java_bwapi4_UnitType_buildScore_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->buildScore();
}
JNIEXPORT jint JNICALL Java_bwapi4_UnitType_destroyScore_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->destroyScore();
}
JNIEXPORT jobject JNICALL Java_bwapi4_UnitType_size_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
jlong resptr = (jlong)x_unitType->size();
jclass retcls = FindCachedClass(env, "bwapi4/UnitSizeType");
jmethodID mid = FindCachedMethodStatic(env, retcls, "get", "(J)Lbwapi4/UnitSizeType;");
return env->CallStaticObjectMethod(retcls, mid, resptr);
}
JNIEXPORT jint JNICALL Java_bwapi4_UnitType_tileWidth_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->tileWidth();
}
JNIEXPORT jint JNICALL Java_bwapi4_UnitType_tileHeight_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->tileHeight();
}
JNIEXPORT jobject JNICALL Java_bwapi4_UnitType_tileSize_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
TilePosition cresult = x_unitType->tileSize();
jclass retcls = FindCachedClass(env, "bwapi4/TilePosition");
jmethodID retConsID = FindCachedMethod(env, retcls, "<init>", "(II)V");
jobject result = env->NewObject(retcls, retConsID, cresult.x, cresult.y);
return result;
}
JNIEXPORT jint JNICALL Java_bwapi4_UnitType_dimensionLeft_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->dimensionLeft();
}
JNIEXPORT jint JNICALL Java_bwapi4_UnitType_dimensionUp_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->dimensionUp();
}
JNIEXPORT jint JNICALL Java_bwapi4_UnitType_dimensionRight_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->dimensionRight();
}
JNIEXPORT jint JNICALL Java_bwapi4_UnitType_dimensionDown_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->dimensionDown();
}
JNIEXPORT jint JNICALL Java_bwapi4_UnitType_width_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->width();
}
JNIEXPORT jint JNICALL Java_bwapi4_UnitType_height_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->height();
}
JNIEXPORT jint JNICALL Java_bwapi4_UnitType_seekRange_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->seekRange();
}
JNIEXPORT jint JNICALL Java_bwapi4_UnitType_sightRange_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->sightRange();
}
JNIEXPORT jobject JNICALL Java_bwapi4_UnitType_groundWeapon_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
...
JNIEXPORT jint JNICALL Java_bwapi4_UnitType_maxGroundHits_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->maxGroundHits();
}
JNIEXPORT jobject JNICALL Java_bwapi4_UnitType_airWeapon_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
...
JNIEXPORT jint JNICALL Java_bwapi4_UnitType_maxAirHits_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->maxAirHits();
}
JNIEXPORT jdouble JNICALL Java_bwapi4_UnitType_topSpeed_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->topSpeed();
}
JNIEXPORT jint JNICALL Java_bwapi4_UnitType_acceleration_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->acceleration();
}
JNIEXPORT jint JNICALL Java_bwapi4_UnitType_haltDistance_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->haltDistance();
}
JNIEXPORT jint JNICALL Java_bwapi4_UnitType_turnRadius_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->turnRadius();
}
JNIEXPORT jboolean JNICALL Java_bwapi4_UnitType_canProduce_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->canProduce();
}
JNIEXPORT jboolean JNICALL Java_bwapi4_UnitType_canAttack_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->canAttack();
}
JNIEXPORT jboolean JNICALL Java_bwapi4_UnitType_canMove_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->canMove();
}
JNIEXPORT jboolean JNICALL Java_bwapi4_UnitType_isFlyer_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->isFlyer();
}
JNIEXPORT jboolean JNICALL Java_bwapi4_UnitType_regeneratesHP_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->regeneratesHP();
}
JNIEXPORT jboolean JNICALL Java_bwapi4_UnitType_isSpellcaster_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->isSpellcaster();
}
JNIEXPORT jboolean JNICALL Java_bwapi4_UnitType_hasPermanentCloak_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->hasPermanentCloak();
}
JNIEXPORT jboolean JNICALL Java_bwapi4_UnitType_isInvincible_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->isInvincible();
}
JNIEXPORT jboolean JNICALL Java_bwapi4_UnitType_isOrganic_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->isOrganic();
}
JNIEXPORT jboolean JNICALL Java_bwapi4_UnitType_isMechanical_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->isMechanical();
}
JNIEXPORT jboolean JNICALL Java_bwapi4_UnitType_isRobotic_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->isRobotic();
}
JNIEXPORT jboolean JNICALL Java_bwapi4_UnitType_isDetector_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->isDetector();
}
JNIEXPORT jboolean JNICALL Java_bwapi4_UnitType_isResourceContainer_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->isResourceContainer();
}
JNIEXPORT jboolean JNICALL Java_bwapi4_UnitType_isResourceDepot_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->isResourceDepot();
}
JNIEXPORT jboolean JNICALL Java_bwapi4_UnitType_isRefinery_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->isRefinery();
}
JNIEXPORT jboolean JNICALL Java_bwapi4_UnitType_isWorker_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->isWorker();
}
JNIEXPORT jboolean JNICALL Java_bwapi4_UnitType_requiresPsi_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->requiresPsi();
}
JNIEXPORT jboolean JNICALL Java_bwapi4_UnitType_requiresCreep_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->requiresCreep();
}
JNIEXPORT jboolean JNICALL Java_bwapi4_UnitType_isTwoUnitsInOneEgg_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->isTwoUnitsInOneEgg();
}
JNIEXPORT jboolean JNICALL Java_bwapi4_UnitType_isBurrowable_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->isBurrowable();
}
JNIEXPORT jboolean JNICALL Java_bwapi4_UnitType_isCloakable_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->isCloakable();
}
JNIEXPORT jboolean JNICALL Java_bwapi4_UnitType_isBuilding_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->isBuilding();
}
JNIEXPORT jboolean JNICALL Java_bwapi4_UnitType_isAddon_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->isAddon();
}
JNIEXPORT jboolean JNICALL Java_bwapi4_UnitType_isFlyingBuilding_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->isFlyingBuilding();
}
JNIEXPORT jboolean JNICALL Java_bwapi4_UnitType_isNeutral_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->isNeutral();
}
JNIEXPORT jboolean JNICALL Java_bwapi4_UnitType_isHero_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->isHero();
}
JNIEXPORT jboolean JNICALL Java_bwapi4_UnitType_isPowerup_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->isPowerup();
}
JNIEXPORT jboolean JNICALL Java_bwapi4_UnitType_isBeacon_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->isBeacon();
}
JNIEXPORT jboolean JNICALL Java_bwapi4_UnitType_isFlagBeacon_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->isFlagBeacon();
}
JNIEXPORT jboolean JNICALL Java_bwapi4_UnitType_isSpecialBuilding_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->isSpecialBuilding();
}
JNIEXPORT jboolean JNICALL Java_bwapi4_UnitType_isSpell_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->isSpell();
}
JNIEXPORT jboolean JNICALL Java_bwapi4_UnitType_producesLarva_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->producesLarva();
}
JNIEXPORT jboolean JNICALL Java_bwapi4_UnitType_isMineralField_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->isMineralField();
}
JNIEXPORT jboolean JNICALL Java_bwapi4_UnitType_isCritter_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->isCritter();
}
JNIEXPORT jboolean JNICALL Java_bwapi4_UnitType_canBuildAddon_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->canBuildAddon();
}
JNIEXPORT jstring JNICALL Java_bwapi4_UpgradeType_toString_1native(JNIEnv * env, jobject obj, jlong pointer){
UpgradeType* x_upgradeType = (UpgradeType*)pointer;
return env->NewStringUTF(x_upgradeType->toString().c_str());
}
JNIEXPORT jobject JNICALL Java_bwapi4_UpgradeType_getRace_1native(JNIEnv * env, jobject obj, jlong pointer){
UpgradeType* x_upgradeType = (UpgradeType*)pointer;
...
JNIEXPORT jint JNICALL Java_bwapi4_UpgradeType_mineralPrice_1native__J(JNIEnv * env, jobject obj, jlong pointer){
UpgradeType* x_upgradeType = (UpgradeType*)pointer;
return x_upgradeType->mineralPrice();
}
JNIEXPORT jint JNICALL Java_bwapi4_UpgradeType_mineralPrice_1native__JI(JNIEnv * env, jobject obj, jlong pointer, jint level){
UpgradeType* x_upgradeType = (UpgradeType*)pointer;
return x_upgradeType->mineralPrice(level);
}
JNIEXPORT jint JNICALL Java_bwapi4_UpgradeType_mineralPriceFactor_1native(JNIEnv * env, jobject obj, jlong pointer){
UpgradeType* x_upgradeType = (UpgradeType*)pointer;
return x_upgradeType->mineralPriceFactor();
}
JNIEXPORT jint JNICALL Java_bwapi4_UpgradeType_gasPrice_1native__J(JNIEnv * env, jobject obj, jlong pointer){
UpgradeType* x_upgradeType = (UpgradeType*)pointer;
return x_upgradeType->gasPrice();
}
JNIEXPORT jint JNICALL Java_bwapi4_UpgradeType_gasPrice_1native__JI(JNIEnv * env, jobject obj, jlong pointer, jint level){
UpgradeType* x_upgradeType = (UpgradeType*)pointer;
return x_upgradeType->gasPrice(level);
}
JNIEXPORT jint JNICALL Java_bwapi4_UpgradeType_gasPriceFactor_1native(JNIEnv * env, jobject obj, jlong pointer){
UpgradeType* x_upgradeType = (UpgradeType*)pointer;
return x_upgradeType->gasPriceFactor();
}
JNIEXPORT jint JNICALL Java_bwapi4_UpgradeType_upgradeTime_1native__J(JNIEnv * env, jobject obj, jlong pointer){
UpgradeType* x_upgradeType = (UpgradeType*)pointer;
return x_upgradeType->upgradeTime();
}
JNIEXPORT jint JNICALL Java_bwapi4_UpgradeType_upgradeTime_1native__JI(JNIEnv * env, jobject obj, jlong pointer, jint level){
UpgradeType* x_upgradeType = (UpgradeType*)pointer;
return x_upgradeType->upgradeTime(level);
}
JNIEXPORT jint JNICALL Java_bwapi4_UpgradeType_upgradeTimeFactor_1native(JNIEnv * env, jobject obj, jlong pointer){
UpgradeType* x_upgradeType = (UpgradeType*)pointer;
return x_upgradeType->upgradeTimeFactor();
}
JNIEXPORT jint JNICALL Java_bwapi4_UpgradeType_maxRepeats_1native(JNIEnv * env, jobject obj, jlong pointer){
UpgradeType* x_upgradeType = (UpgradeType*)pointer;
return x_upgradeType->maxRepeats();
}
JNIEXPORT jobject JNICALL Java_bwapi4_UpgradeType_whatUpgrades_1native(JNIEnv * env, jobject obj, jlong pointer){
UpgradeType* x_upgradeType = (UpgradeType*)pointer;
...
JNIEXPORT jobject JNICALL Java_bwapi4_UpgradeType_whatsRequired_1native__J(JNIEnv * env, jobject obj, jlong pointer){
UpgradeType* x_upgradeType = (UpgradeType*)pointer;
...
JNIEXPORT jobject JNICALL Java_bwapi4_UpgradeType_whatsRequired_1native__JI(JNIEnv * env, jobject obj, jlong pointer, jint level){
UpgradeType* x_upgradeType = (UpgradeType*)pointer;
...
JNIEXPORT jstring JNICALL Java_bwapi4_WeaponType_toString_1native(JNIEnv * env, jobject obj, jlong pointer){
WeaponType* x_weaponType = (WeaponType*)pointer;
return env->NewStringUTF(x_weaponType->toString().c_str());
}
JNIEXPORT jobject JNICALL Java_bwapi4_WeaponType_getTech_1native(JNIEnv * env, jobject obj, jlong pointer){
WeaponType* x_weaponType = (WeaponType*)pointer;
...
JNIEXPORT jobject JNICALL Java_bwapi4_WeaponType_whatUses_1native(JNIEnv * env, jobject obj, jlong pointer){
WeaponType* x_weaponType = (WeaponType*)pointer;
...
JNIEXPORT jint JNICALL Java_bwapi4_WeaponType_damageAmount_1native(JNIEnv * env, jobject obj, jlong pointer){
WeaponType* x_weaponType = (WeaponType*)pointer;
return x_weaponType->damageAmount();
}
JNIEXPORT jint JNICALL Java_bwapi4_WeaponType_damageBonus_1native(JNIEnv * env, jobject obj, jlong pointer){
WeaponType* x_weaponType = (WeaponType*)pointer;
return x_weaponType->damageBonus();
}
JNIEXPORT jint JNICALL Java_bwapi4_WeaponType_damageCooldown_1native(JNIEnv * env, jobject obj, jlong pointer){
WeaponType* x_weaponType = (WeaponType*)pointer;
return x_weaponType->damageCooldown();
}
JNIEXPORT jint JNICALL Java_bwapi4_WeaponType_damageFactor_1native(JNIEnv * env, jobject obj, jlong pointer){
WeaponType* x_weaponType = (WeaponType*)pointer;
return x_weaponType->damageFactor();
}
JNIEXPORT jobject JNICALL Java_bwapi4_WeaponType_upgradeType_1native(JNIEnv * env, jobject obj, jlong pointer){
WeaponType* x_weaponType = (WeaponType*)pointer;
...
JNIEXPORT jobject JNICALL Java_bwapi4_WeaponType_damageType_1native(JNIEnv * env, jobject obj, jlong pointer){
WeaponType* x_weaponType = (WeaponType*)pointer;
jlong resptr = (jlong)x_weaponType->damageType();
jclass retcls = FindCachedClass(env, "bwapi4/DamageType");
jmethodID mid = FindCachedMethodStatic(env, retcls, "get", "(J)Lbwapi4/DamageType;");
return env->CallStaticObjectMethod(retcls, mid, resptr);
}
JNIEXPORT jobject JNICALL Java_bwapi4_WeaponType_explosionType_1native(JNIEnv * env, jobject obj, jlong pointer){
WeaponType* x_weaponType = (WeaponType*)pointer;
jlong resptr = (jlong)x_weaponType->explosionType();
jclass retcls = FindCachedClass(env, "bwapi4/ExplosionType");
jmethodID mid = FindCachedMethodStatic(env, retcls, "get", "(J)Lbwapi4/ExplosionType;");
return env->CallStaticObjectMethod(retcls, mid, resptr);
}
JNIEXPORT jint JNICALL Java_bwapi4_WeaponType_minRange_1native(JNIEnv * env, jobject obj, jlong pointer){
WeaponType* x_weaponType = (WeaponType*)pointer;
return x_weaponType->minRange();
}
JNIEXPORT jint JNICALL Java_bwapi4_WeaponType_maxRange_1native(JNIEnv * env, jobject obj, jlong pointer){
WeaponType* x_weaponType = (WeaponType*)pointer;
return x_weaponType->maxRange();
}
JNIEXPORT jint JNICALL Java_bwapi4_WeaponType_innerSplashRadius_1native(JNIEnv * env, jobject obj, jlong pointer){
WeaponType* x_weaponType = (WeaponType*)pointer;
return x_weaponType->innerSplashRadius();
}
JNIEXPORT jint JNICALL Java_bwapi4_WeaponType_medianSplashRadius_1native(JNIEnv * env, jobject obj, jlong pointer){
WeaponType* x_weaponType = (WeaponType*)pointer;
return x_weaponType->medianSplashRadius();
}
JNIEXPORT jint JNICALL Java_bwapi4_WeaponType_outerSplashRadius_1native(JNIEnv * env, jobject obj, jlong pointer){
WeaponType* x_weaponType = (WeaponType*)pointer;
return x_weaponType->outerSplashRadius();
}
JNIEXPORT jboolean JNICALL Java_bwapi4_WeaponType_targetsAir_1native(JNIEnv * env, jobject obj, jlong pointer){
WeaponType* x_weaponType = (WeaponType*)pointer;
return x_weaponType->targetsAir();
}
JNIEXPORT jboolean JNICALL Java_bwapi4_WeaponType_targetsGround_1native(JNIEnv * env, jobject obj, jlong pointer){
WeaponType* x_weaponType = (WeaponType*)pointer;
return x_weaponType->targetsGround();
}
JNIEXPORT jboolean JNICALL Java_bwapi4_WeaponType_targetsMechanical_1native(JNIEnv * env, jobject obj, jlong pointer){
WeaponType* x_weaponType = (WeaponType*)pointer;
return x_weaponType->targetsMechanical();
}
JNIEXPORT jboolean JNICALL Java_bwapi4_WeaponType_targetsOrganic_1native(JNIEnv * env, jobject obj, jlong pointer){
WeaponType* x_weaponType = (WeaponType*)pointer;
return x_weaponType->targetsOrganic();
}
JNIEXPORT jboolean JNICALL Java_bwapi4_WeaponType_targetsNonBuilding_1native(JNIEnv * env, jobject obj, jlong pointer){
WeaponType* x_weaponType = (WeaponType*)pointer;
return x_weaponType->targetsNonBuilding();
}
JNIEXPORT jboolean JNICALL Java_bwapi4_WeaponType_targetsNonRobotic_1native(JNIEnv * env, jobject obj, jlong pointer){
WeaponType* x_weaponType = (WeaponType*)pointer;
return x_weaponType->targetsNonRobotic();
}
JNIEXPORT jboolean JNICALL Java_bwapi4_WeaponType_targetsTerrain_1native(JNIEnv * env, jobject obj, jlong pointer){
WeaponType* x_weaponType = (WeaponType*)pointer;
return x_weaponType->targetsTerrain();
}
JNIEXPORT jboolean JNICALL Java_bwapi4_WeaponType_targetsOrgOrMech_1native(JNIEnv * env, jobject obj, jlong pointer){
WeaponType* x_weaponType = (WeaponType*)pointer;
return x_weaponType->targetsOrgOrMech();
}
JNIEXPORT jboolean JNICALL Java_bwapi4_WeaponType_targetsOwn_1native(JNIEnv * env, jobject obj, jlong pointer){
WeaponType* x_weaponType = (WeaponType*)pointer;
...
jclass cls;
jmethodID getId;
cls = env->FindClass("Lbwapi4/BulletType;");
getId = env->GetStaticMethodID(cls, "get", "(J)Lbwapi4/BulletType;");
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Melee", "Lbwapi4/BulletType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&BulletTypes::Melee));
tableBulletType.insert(std::pair<int, const BulletType*>(BulletTypes::Melee.getID(), &BulletTypes::Melee));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Fusion_Cutter_Hit", "Lbwapi4/BulletType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&BulletTypes::Fusion_Cutter_Hit));
tableBulletType.insert(std::pair<int, const BulletType*>(BulletTypes::Fusion_Cutter_Hit.getID(), &BulletTypes::Fusion_Cutter_Hit));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Gauss_Rifle_Hit", "Lbwapi4/BulletType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&BulletTypes::Gauss_Rifle_Hit));
tableBulletType.insert(std::pair<int, const BulletType*>(BulletTypes::Gauss_Rifle_Hit.getID(), &BulletTypes::Gauss_Rifle_Hit));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "C_10_Canister_Rifle_Hit", "Lbwapi4/BulletType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&BulletTypes::C_10_Canister_Rifle_Hit));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Gemini_Missiles", "Lbwapi4/BulletType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&BulletTypes::Gemini_Missiles));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Longbolt_Missile", "Lbwapi4/BulletType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&BulletTypes::Longbolt_Missile));
tableBulletType.insert(std::pair<int, const BulletType*>(BulletTypes::Longbolt_Missile.getID(), &BulletTypes::Longbolt_Missile));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "ATS_ATA_Laser_Battery", "Lbwapi4/BulletType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&BulletTypes::ATS_ATA_Laser_Battery));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Burst_Lasers", "Lbwapi4/BulletType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&BulletTypes::Burst_Lasers));
tableBulletType.insert(std::pair<int, const BulletType*>(BulletTypes::Burst_Lasers.getID(), &BulletTypes::Burst_Lasers));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Arclite_Shock_Cannon_Hit", "Lbwapi4/BulletType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&BulletTypes::Arclite_Shock_Cannon_Hit));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "EMP_Missile", "Lbwapi4/BulletType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&BulletTypes::EMP_Missile));
tableBulletType.insert(std::pair<int, const BulletType*>(BulletTypes::EMP_Missile.getID(), &BulletTypes::EMP_Missile));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Dual_Photon_Blasters_Hit", "Lbwapi4/BulletType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&BulletTypes::Dual_Photon_Blasters_Hit));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Particle_Beam_Hit", "Lbwapi4/BulletType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&BulletTypes::Particle_Beam_Hit));
tableBulletType.insert(std::pair<int, const BulletType*>(BulletTypes::Particle_Beam_Hit.getID(), &BulletTypes::Particle_Beam_Hit));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Anti_Matter_Missile", "Lbwapi4/BulletType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&BulletTypes::Anti_Matter_Missile));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Psionic_Storm", "Lbwapi4/BulletType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&BulletTypes::Psionic_Storm));
tableBulletType.insert(std::pair<int, const BulletType*>(BulletTypes::Psionic_Storm.getID(), &BulletTypes::Psionic_Storm));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Yamato_Gun", "Lbwapi4/BulletType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&BulletTypes::Yamato_Gun));
tableBulletType.insert(std::pair<int, const BulletType*>(BulletTypes::Yamato_Gun.getID(), &BulletTypes::Yamato_Gun));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Phase_Disruptor", "Lbwapi4/BulletType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&BulletTypes::Phase_Disruptor));
tableBulletType.insert(std::pair<int, const BulletType*>(BulletTypes::Phase_Disruptor.getID(), &BulletTypes::Phase_Disruptor));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "STA_STS_Cannon_Overlay", "Lbwapi4/BulletType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&BulletTypes::STA_STS_Cannon_Overlay));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Sunken_Colony_Tentacle", "Lbwapi4/BulletType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&BulletTypes::Sunken_Colony_Tentacle));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Acid_Spore", "Lbwapi4/BulletType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&BulletTypes::Acid_Spore));
tableBulletType.insert(std::pair<int, const BulletType*>(BulletTypes::Acid_Spore.getID(), &BulletTypes::Acid_Spore));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Glave_Wurm", "Lbwapi4/BulletType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&BulletTypes::Glave_Wurm));
tableBulletType.insert(std::pair<int, const BulletType*>(BulletTypes::Glave_Wurm.getID(), &BulletTypes::Glave_Wurm));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Seeker_Spores", "Lbwapi4/BulletType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&BulletTypes::Seeker_Spores));
tableBulletType.insert(std::pair<int, const BulletType*>(BulletTypes::Seeker_Spores.getID(), &BulletTypes::Seeker_Spores));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Queen_Spell_Carrier", "Lbwapi4/BulletType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&BulletTypes::Queen_Spell_Carrier));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Plague_Cloud", "Lbwapi4/BulletType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&BulletTypes::Plague_Cloud));
tableBulletType.insert(std::pair<int, const BulletType*>(BulletTypes::Plague_Cloud.getID(), &BulletTypes::Plague_Cloud));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Consume", "Lbwapi4/BulletType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&BulletTypes::Consume));
tableBulletType.insert(std::pair<int, const BulletType*>(BulletTypes::Consume.getID(), &BulletTypes::Consume));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Ensnare", "Lbwapi4/BulletType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&BulletTypes::Ensnare));
tableBulletType.insert(std::pair<int, const BulletType*>(BulletTypes::Ensnare.getID(), &BulletTypes::Ensnare));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Needle_Spine_Hit", "Lbwapi4/BulletType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&BulletTypes::Needle_Spine_Hit));
tableBulletType.insert(std::pair<int, const BulletType*>(BulletTypes::Needle_Spine_Hit.getID(), &BulletTypes::Needle_Spine_Hit));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Invisible", "Lbwapi4/BulletType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&BulletTypes::Invisible));
tableBulletType.insert(std::pair<int, const BulletType*>(BulletTypes::Invisible.getID(), &BulletTypes::Invisible));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Optical_Flare_Grenade", "Lbwapi4/BulletType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&BulletTypes::Optical_Flare_Grenade));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Subterranean_Spines", "Lbwapi4/BulletType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&BulletTypes::Subterranean_Spines));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Corrosive_Acid_Shot", "Lbwapi4/BulletType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&BulletTypes::Corrosive_Acid_Shot));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Neutron_Flare", "Lbwapi4/BulletType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&BulletTypes::Neutron_Flare));
tableBulletType.insert(std::pair<int, const BulletType*>(BulletTypes::Neutron_Flare.getID(), &BulletTypes::Neutron_Flare));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "None", "Lbwapi4/BulletType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&BulletTypes::None));
tableBulletType.insert(std::pair<int, const BulletType*>(BulletTypes::None.getID(), &BulletTypes::None));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Unknown", "Lbwapi4/BulletType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&BulletTypes::Unknown));
tableBulletType.insert(std::pair<int, const BulletType*>(BulletTypes::Unknown.getID(), &BulletTypes::Unknown));
cls = env->FindClass("Lbwapi4/Color;");
getId = env->GetMethodID(cls,"<init>", "(III)V");
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Red", "Lbwapi4/Color;"), env->NewObject(cls, getId, Colors::Red.red(), Colors::Red.green(), Colors::Red.blue()));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Blue", "Lbwapi4/Color;"), env->NewObject(cls, getId, Colors::Blue.red(), Colors::Blue.green(), Colors::Blue.blue()));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Teal", "Lbwapi4/Color;"), env->NewObject(cls, getId, Colors::Teal.red(), Colors::Teal.green(), Colors::Teal.blue()));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Purple", "Lbwapi4/Color;"), env->NewObject(cls, getId, Colors::Purple.red(), Colors::Purple.green(), Colors::Purple.blue()));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Orange", "Lbwapi4/Color;"), env->NewObject(cls, getId, Colors::Orange.red(), Colors::Orange.green(), Colors::Orange.blue()));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Brown", "Lbwapi4/Color;"), env->NewObject(cls, getId, Colors::Brown.red(), Colors::Brown.green(), Colors::Brown.blue()));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "White", "Lbwapi4/Color;"), env->NewObject(cls, getId, Colors::White.red(), Colors::White.green(), Colors::White.blue()));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Yellow", "Lbwapi4/Color;"), env->NewObject(cls, getId, Colors::Yellow.red(), Colors::Yellow.green(), Colors::Yellow.blue()));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Green", "Lbwapi4/Color;"), env->NewObject(cls, getId, Colors::Green.red(), Colors::Green.green(), Colors::Green.blue()));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Cyan", "Lbwapi4/Color;"), env->NewObject(cls, getId, Colors::Cyan.red(), Colors::Cyan.green(), Colors::Cyan.blue()));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Black", "Lbwapi4/Color;"), env->NewObject(cls, getId, Colors::Black.red(), Colors::Black.green(), Colors::Black.blue()));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Grey", "Lbwapi4/Color;"), env->NewObject(cls, getId, Colors::Grey.red(), Colors::Grey.green(), Colors::Grey.blue()));
cls = env->FindClass("Lbwapi4/DamageType;");
getId = env->GetStaticMethodID(cls, "get", "(J)Lbwapi4/DamageType;");
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Independent", "Lbwapi4/DamageType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&DamageTypes::Independent));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Concussive", "Lbwapi4/DamageType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&DamageTypes::Concussive));
tableDamageType.insert(std::pair<int, const DamageType*>(DamageTypes::Concussive.getID(), &DamageTypes::Concussive));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Normal", "Lbwapi4/DamageType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&DamageTypes::Normal));
tableDamageType.insert(std::pair<int, const DamageType*>(DamageTypes::Normal.getID(), &DamageTypes::Normal));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Ignore_Armor", "Lbwapi4/DamageType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&DamageTypes::Ignore_Armor));
tableDamageType.insert(std::pair<int, const DamageType*>(DamageTypes::Ignore_Armor.getID(), &DamageTypes::Ignore_Armor));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "None", "Lbwapi4/DamageType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&DamageTypes::None));
tableDamageType.insert(std::pair<int, const DamageType*>(DamageTypes::None.getID(), &DamageTypes::None));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Unknown", "Lbwapi4/DamageType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&DamageTypes::Unknown));
tableDamageType.insert(std::pair<int, const DamageType*>(DamageTypes::Unknown.getID(), &DamageTypes::Unknown));
cls = env->FindClass("Lbwapi4/Error;");
getId = env->GetStaticMethodID(cls, "get", "(J)Lbwapi4/Error;");
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Unit_Does_Not_Exist", "Lbwapi4/Error;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Errors::Unit_Does_Not_Exist));
tableError.insert(std::pair<int, const Error*>(Errors::Unit_Does_Not_Exist.getID(), &Errors::Unit_Does_Not_Exist));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Unit_Not_Visible", "Lbwapi4/Error;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Errors::Unit_Not_Visible));
tableError.insert(std::pair<int, const Error*>(Errors::Unit_Not_Visible.getID(), &Errors::Unit_Not_Visible));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Unit_Not_Owned", "Lbwapi4/Error;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Errors::Unit_Not_Owned));
tableError.insert(std::pair<int, const Error*>(Errors::Unit_Not_Owned.getID(), &Errors::Unit_Not_Owned));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Unit_Busy", "Lbwapi4/Error;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Errors::Unit_Busy));
tableError.insert(std::pair<int, const Error*>(Errors::Unit_Busy.getID(), &Errors::Unit_Busy));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Incompatible_UnitType", "Lbwapi4/Error;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Errors::Incompatible_UnitType));
tableError.insert(std::pair<int, const Error*>(Errors::Incompatible_UnitType.getID(), &Errors::Incompatible_UnitType));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Incompatible_TechType", "Lbwapi4/Error;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Errors::Incompatible_TechType));
tableError.insert(std::pair<int, const Error*>(Errors::Incompatible_TechType.getID(), &Errors::Incompatible_TechType));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Incompatible_State", "Lbwapi4/Error;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Errors::Incompatible_State));
tableError.insert(std::pair<int, const Error*>(Errors::Incompatible_State.getID(), &Errors::Incompatible_State));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Already_Researched", "Lbwapi4/Error;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Errors::Already_Researched));
tableError.insert(std::pair<int, const Error*>(Errors::Already_Researched.getID(), &Errors::Already_Researched));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Fully_Upgraded", "Lbwapi4/Error;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Errors::Fully_Upgraded));
tableError.insert(std::pair<int, const Error*>(Errors::Fully_Upgraded.getID(), &Errors::Fully_Upgraded));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Currently_Researching", "Lbwapi4/Error;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Errors::Currently_Researching));
tableError.insert(std::pair<int, const Error*>(Errors::Currently_Researching.getID(), &Errors::Currently_Researching));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Currently_Upgrading", "Lbwapi4/Error;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Errors::Currently_Upgrading));
tableError.insert(std::pair<int, const Error*>(Errors::Currently_Upgrading.getID(), &Errors::Currently_Upgrading));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Insufficient_Minerals", "Lbwapi4/Error;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Errors::Insufficient_Minerals));
tableError.insert(std::pair<int, const Error*>(Errors::Insufficient_Minerals.getID(), &Errors::Insufficient_Minerals));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Insufficient_Gas", "Lbwapi4/Error;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Errors::Insufficient_Gas));
tableError.insert(std::pair<int, const Error*>(Errors::Insufficient_Gas.getID(), &Errors::Insufficient_Gas));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Insufficient_Supply", "Lbwapi4/Error;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Errors::Insufficient_Supply));
tableError.insert(std::pair<int, const Error*>(Errors::Insufficient_Supply.getID(), &Errors::Insufficient_Supply));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Insufficient_Energy", "Lbwapi4/Error;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Errors::Insufficient_Energy));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Insufficient_Ammo", "Lbwapi4/Error;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Errors::Insufficient_Ammo));
tableError.insert(std::pair<int, const Error*>(Errors::Insufficient_Ammo.getID(), &Errors::Insufficient_Ammo));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Insufficient_Space", "Lbwapi4/Error;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Errors::Insufficient_Space));
tableError.insert(std::pair<int, const Error*>(Errors::Insufficient_Space.getID(), &Errors::Insufficient_Space));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Invalid_Tile_Position", "Lbwapi4/Error;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Errors::Invalid_Tile_Position));
tableError.insert(std::pair<int, const Error*>(Errors::Invalid_Tile_Position.getID(), &Errors::Invalid_Tile_Position));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Unbuildable_Location", "Lbwapi4/Error;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Errors::Unbuildable_Location));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Out_Of_Range", "Lbwapi4/Error;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Errors::Out_Of_Range));
tableError.insert(std::pair<int, const Error*>(Errors::Out_Of_Range.getID(), &Errors::Out_Of_Range));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Unable_To_Hit", "Lbwapi4/Error;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Errors::Unable_To_Hit));
tableError.insert(std::pair<int, const Error*>(Errors::Unable_To_Hit.getID(), &Errors::Unable_To_Hit));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Access_Denied", "Lbwapi4/Error;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Errors::Access_Denied));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "None", "Lbwapi4/Error;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Errors::None));
tableError.insert(std::pair<int, const Error*>(Errors::None.getID(), &Errors::None));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Unknown", "Lbwapi4/Error;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Errors::Unknown));
tableError.insert(std::pair<int, const Error*>(Errors::Unknown.getID(), &Errors::Unknown));
cls = env->FindClass("Lbwapi4/ExplosionType;");
getId = env->GetStaticMethodID(cls, "get", "(J)Lbwapi4/ExplosionType;");
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "None", "Lbwapi4/ExplosionType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&ExplosionTypes::None));
tableExplosionType.insert(std::pair<int, const ExplosionType*>(ExplosionTypes::None.getID(), &ExplosionTypes::None));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Normal", "Lbwapi4/ExplosionType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&ExplosionTypes::Normal));
tableExplosionType.insert(std::pair<int, const ExplosionType*>(ExplosionTypes::Normal.getID(), &ExplosionTypes::Normal));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Radial_Splash", "Lbwapi4/ExplosionType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&ExplosionTypes::Radial_Splash));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Enemy_Splash", "Lbwapi4/ExplosionType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&ExplosionTypes::Enemy_Splash));
tableExplosionType.insert(std::pair<int, const ExplosionType*>(ExplosionTypes::Enemy_Splash.getID(), &ExplosionTypes::Enemy_Splash));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Lockdown", "Lbwapi4/ExplosionType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&ExplosionTypes::Lockdown));
tableExplosionType.insert(std::pair<int, const ExplosionType*>(ExplosionTypes::Lockdown.getID(), &ExplosionTypes::Lockdown));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Nuclear_Missile", "Lbwapi4/ExplosionType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&ExplosionTypes::Nuclear_Missile));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Parasite", "Lbwapi4/ExplosionType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&ExplosionTypes::Parasite));
tableExplosionType.insert(std::pair<int, const ExplosionType*>(ExplosionTypes::Parasite.getID(), &ExplosionTypes::Parasite));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Broodlings", "Lbwapi4/ExplosionType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&ExplosionTypes::Broodlings));
tableExplosionType.insert(std::pair<int, const ExplosionType*>(ExplosionTypes::Broodlings.getID(), &ExplosionTypes::Broodlings));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "EMP_Shockwave", "Lbwapi4/ExplosionType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&ExplosionTypes::EMP_Shockwave));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Irradiate", "Lbwapi4/ExplosionType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&ExplosionTypes::Irradiate));
tableExplosionType.insert(std::pair<int, const ExplosionType*>(ExplosionTypes::Irradiate.getID(), &ExplosionTypes::Irradiate));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Ensnare", "Lbwapi4/ExplosionType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&ExplosionTypes::Ensnare));
tableExplosionType.insert(std::pair<int, const ExplosionType*>(ExplosionTypes::Ensnare.getID(), &ExplosionTypes::Ensnare));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Plague", "Lbwapi4/ExplosionType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&ExplosionTypes::Plague));
tableExplosionType.insert(std::pair<int, const ExplosionType*>(ExplosionTypes::Plague.getID(), &ExplosionTypes::Plague));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Stasis_Field", "Lbwapi4/ExplosionType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&ExplosionTypes::Stasis_Field));
tableExplosionType.insert(std::pair<int, const ExplosionType*>(ExplosionTypes::Stasis_Field.getID(), &ExplosionTypes::Stasis_Field));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Dark_Swarm", "Lbwapi4/ExplosionType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&ExplosionTypes::Dark_Swarm));
tableExplosionType.insert(std::pair<int, const ExplosionType*>(ExplosionTypes::Dark_Swarm.getID(), &ExplosionTypes::Dark_Swarm));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Consume", "Lbwapi4/ExplosionType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&ExplosionTypes::Consume));
tableExplosionType.insert(std::pair<int, const ExplosionType*>(ExplosionTypes::Consume.getID(), &ExplosionTypes::Consume));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Yamato_Gun", "Lbwapi4/ExplosionType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&ExplosionTypes::Yamato_Gun));
tableExplosionType.insert(std::pair<int, const ExplosionType*>(ExplosionTypes::Yamato_Gun.getID(), &ExplosionTypes::Yamato_Gun));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Restoration", "Lbwapi4/ExplosionType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&ExplosionTypes::Restoration));
tableExplosionType.insert(std::pair<int, const ExplosionType*>(ExplosionTypes::Restoration.getID(), &ExplosionTypes::Restoration));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Disruption_Web", "Lbwapi4/ExplosionType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&ExplosionTypes::Disruption_Web));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Corrosive_Acid", "Lbwapi4/ExplosionType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&ExplosionTypes::Corrosive_Acid));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Mind_Control", "Lbwapi4/ExplosionType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&ExplosionTypes::Mind_Control));
tableExplosionType.insert(std::pair<int, const ExplosionType*>(ExplosionTypes::Mind_Control.getID(), &ExplosionTypes::Mind_Control));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Feedback", "Lbwapi4/ExplosionType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&ExplosionTypes::Feedback));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Air_Splash", "Lbwapi4/ExplosionType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&ExplosionTypes::Air_Splash));
tableExplosionType.insert(std::pair<int, const ExplosionType*>(ExplosionTypes::Air_Splash.getID(), &ExplosionTypes::Air_Splash));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Unknown", "Lbwapi4/ExplosionType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&ExplosionTypes::Unknown));
tableExplosionType.insert(std::pair<int, const ExplosionType*>(ExplosionTypes::Unknown.getID(), &ExplosionTypes::Unknown));
cls = env->FindClass("Lbwapi4/GameType;");
getId = env->GetStaticMethodID(cls, "get", "(J)Lbwapi4/GameType;");
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Melee", "Lbwapi4/GameType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&GameTypes::Melee));
tableGameType.insert(std::pair<int, const GameType*>(GameTypes::Melee.getID(), &GameTypes::Melee));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Free_For_All", "Lbwapi4/GameType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&GameTypes::Free_For_All));
tableGameType.insert(std::pair<int, const GameType*>(GameTypes::Free_For_All.getID(), &GameTypes::Free_For_All));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "One_on_One", "Lbwapi4/GameType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&GameTypes::One_on_One));
tableGameType.insert(std::pair<int, const GameType*>(GameTypes::One_on_One.getID(), &GameTypes::One_on_One));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Capture_The_Flag", "Lbwapi4/GameType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&GameTypes::Capture_The_Flag));
tableGameType.insert(std::pair<int, const GameType*>(GameTypes::Capture_The_Flag.getID(), &GameTypes::Capture_The_Flag));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Greed", "Lbwapi4/GameType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&GameTypes::Greed));
tableGameType.insert(std::pair<int, const GameType*>(GameTypes::Greed.getID(), &GameTypes::Greed));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Slaughter", "Lbwapi4/GameType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&GameTypes::Slaughter));
tableGameType.insert(std::pair<int, const GameType*>(GameTypes::Slaughter.getID(), &GameTypes::Slaughter));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Sudden_Death", "Lbwapi4/GameType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&GameTypes::Sudden_Death));
tableGameType.insert(std::pair<int, const GameType*>(GameTypes::Sudden_Death.getID(), &GameTypes::Sudden_Death));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Ladder", "Lbwapi4/GameType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&GameTypes::Ladder));
tableGameType.insert(std::pair<int, const GameType*>(GameTypes::Ladder.getID(), &GameTypes::Ladder));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Use_Map_Settings", "Lbwapi4/GameType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&GameTypes::Use_Map_Settings));
tableGameType.insert(std::pair<int, const GameType*>(GameTypes::Use_Map_Settings.getID(), &GameTypes::Use_Map_Settings));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Team_Melee", "Lbwapi4/GameType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&GameTypes::Team_Melee));
tableGameType.insert(std::pair<int, const GameType*>(GameTypes::Team_Melee.getID(), &GameTypes::Team_Melee));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Team_Free_For_All", "Lbwapi4/GameType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&GameTypes::Team_Free_For_All));
tableGameType.insert(std::pair<int, const GameType*>(GameTypes::Team_Free_For_All.getID(), &GameTypes::Team_Free_For_All));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Team_Capture_The_Flag", "Lbwapi4/GameType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&GameTypes::Team_Capture_The_Flag));
tableGameType.insert(std::pair<int, const GameType*>(GameTypes::Team_Capture_The_Flag.getID(), &GameTypes::Team_Capture_The_Flag));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Top_vs_Bottom", "Lbwapi4/GameType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&GameTypes::Top_vs_Bottom));
tableGameType.insert(std::pair<int, const GameType*>(GameTypes::Top_vs_Bottom.getID(), &GameTypes::Top_vs_Bottom));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "None", "Lbwapi4/GameType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&GameTypes::None));
tableGameType.insert(std::pair<int, const GameType*>(GameTypes::None.getID(), &GameTypes::None));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Unknown", "Lbwapi4/GameType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&GameTypes::Unknown));
tableGameType.insert(std::pair<int, const GameType*>(GameTypes::Unknown.getID(), &GameTypes::Unknown));
cls = env->FindClass("Lbwapi4/Order;");
getId = env->GetStaticMethodID(cls, "get", "(J)Lbwapi4/Order;");
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Die", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::Die));
tableOrder.insert(std::pair<int, const Order*>(Orders::Die.getID(), &Orders::Die));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Stop", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::Stop));
tableOrder.insert(std::pair<int, const Order*>(Orders::Stop.getID(), &Orders::Stop));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Guard", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::Guard));
tableOrder.insert(std::pair<int, const Order*>(Orders::Guard.getID(), &Orders::Guard));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "PlayerGuard", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::PlayerGuard));
tableOrder.insert(std::pair<int, const Order*>(Orders::PlayerGuard.getID(), &Orders::PlayerGuard));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "TurretGuard", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::TurretGuard));
tableOrder.insert(std::pair<int, const Order*>(Orders::TurretGuard.getID(), &Orders::TurretGuard));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "BunkerGuard", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::BunkerGuard));
tableOrder.insert(std::pair<int, const Order*>(Orders::BunkerGuard.getID(), &Orders::BunkerGuard));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Move", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::Move));
tableOrder.insert(std::pair<int, const Order*>(Orders::Move.getID(), &Orders::Move));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "AttackUnit", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::AttackUnit));
tableOrder.insert(std::pair<int, const Order*>(Orders::AttackUnit.getID(), &Orders::AttackUnit));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "AttackTile", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::AttackTile));
tableOrder.insert(std::pair<int, const Order*>(Orders::AttackTile.getID(), &Orders::AttackTile));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Hover", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::Hover));
tableOrder.insert(std::pair<int, const Order*>(Orders::Hover.getID(), &Orders::Hover));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "AttackMove", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::AttackMove));
tableOrder.insert(std::pair<int, const Order*>(Orders::AttackMove.getID(), &Orders::AttackMove));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "InfestedCommandCenter", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::InfestedCommandCenter));
tableOrder.insert(std::pair<int, const Order*>(Orders::InfestedCommandCenter.getID(), &Orders::InfestedCommandCenter));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "UnusedNothing", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::UnusedNothing));
tableOrder.insert(std::pair<int, const Order*>(Orders::UnusedNothing.getID(), &Orders::UnusedNothing));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "UnusedPowerup", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::UnusedPowerup));
tableOrder.insert(std::pair<int, const Order*>(Orders::UnusedPowerup.getID(), &Orders::UnusedPowerup));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "TowerGuard", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::TowerGuard));
tableOrder.insert(std::pair<int, const Order*>(Orders::TowerGuard.getID(), &Orders::TowerGuard));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "VultureMine", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::VultureMine));
tableOrder.insert(std::pair<int, const Order*>(Orders::VultureMine.getID(), &Orders::VultureMine));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Nothing", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::Nothing));
tableOrder.insert(std::pair<int, const Order*>(Orders::Nothing.getID(), &Orders::Nothing));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "CastInfestation", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::CastInfestation));
tableOrder.insert(std::pair<int, const Order*>(Orders::CastInfestation.getID(), &Orders::CastInfestation));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "InfestingCommandCenter", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::InfestingCommandCenter));
tableOrder.insert(std::pair<int, const Order*>(Orders::InfestingCommandCenter.getID(), &Orders::InfestingCommandCenter));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "PlaceBuilding", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::PlaceBuilding));
tableOrder.insert(std::pair<int, const Order*>(Orders::PlaceBuilding.getID(), &Orders::PlaceBuilding));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "CreateProtossBuilding", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::CreateProtossBuilding));
tableOrder.insert(std::pair<int, const Order*>(Orders::CreateProtossBuilding.getID(), &Orders::CreateProtossBuilding));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "ConstructingBuilding", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::ConstructingBuilding));
tableOrder.insert(std::pair<int, const Order*>(Orders::ConstructingBuilding.getID(), &Orders::ConstructingBuilding));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Repair", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::Repair));
tableOrder.insert(std::pair<int, const Order*>(Orders::Repair.getID(), &Orders::Repair));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "PlaceAddon", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::PlaceAddon));
tableOrder.insert(std::pair<int, const Order*>(Orders::PlaceAddon.getID(), &Orders::PlaceAddon));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "BuildAddon", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::BuildAddon));
tableOrder.insert(std::pair<int, const Order*>(Orders::BuildAddon.getID(), &Orders::BuildAddon));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Train", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::Train));
tableOrder.insert(std::pair<int, const Order*>(Orders::Train.getID(), &Orders::Train));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "RallyPointUnit", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::RallyPointUnit));
tableOrder.insert(std::pair<int, const Order*>(Orders::RallyPointUnit.getID(), &Orders::RallyPointUnit));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "RallyPointTile", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::RallyPointTile));
tableOrder.insert(std::pair<int, const Order*>(Orders::RallyPointTile.getID(), &Orders::RallyPointTile));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "ZergBirth", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::ZergBirth));
tableOrder.insert(std::pair<int, const Order*>(Orders::ZergBirth.getID(), &Orders::ZergBirth));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "ZergUnitMorph", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::ZergUnitMorph));
tableOrder.insert(std::pair<int, const Order*>(Orders::ZergUnitMorph.getID(), &Orders::ZergUnitMorph));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "ZergBuildingMorph", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::ZergBuildingMorph));
tableOrder.insert(std::pair<int, const Order*>(Orders::ZergBuildingMorph.getID(), &Orders::ZergBuildingMorph));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "IncompleteBuilding", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::IncompleteBuilding));
tableOrder.insert(std::pair<int, const Order*>(Orders::IncompleteBuilding.getID(), &Orders::IncompleteBuilding));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "BuildNydusExit", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::BuildNydusExit));
tableOrder.insert(std::pair<int, const Order*>(Orders::BuildNydusExit.getID(), &Orders::BuildNydusExit));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "EnterNydusCanal", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::EnterNydusCanal));
tableOrder.insert(std::pair<int, const Order*>(Orders::EnterNydusCanal.getID(), &Orders::EnterNydusCanal));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Follow", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::Follow));
tableOrder.insert(std::pair<int, const Order*>(Orders::Follow.getID(), &Orders::Follow));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Carrier", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::Carrier));
tableOrder.insert(std::pair<int, const Order*>(Orders::Carrier.getID(), &Orders::Carrier));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "ReaverCarrierMove", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::ReaverCarrierMove));
tableOrder.insert(std::pair<int, const Order*>(Orders::ReaverCarrierMove.getID(), &Orders::ReaverCarrierMove));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "CarrierIgnore2", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::CarrierIgnore2));
tableOrder.insert(std::pair<int, const Order*>(Orders::CarrierIgnore2.getID(), &Orders::CarrierIgnore2));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Reaver", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::Reaver));
tableOrder.insert(std::pair<int, const Order*>(Orders::Reaver.getID(), &Orders::Reaver));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "TrainFighter", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::TrainFighter));
tableOrder.insert(std::pair<int, const Order*>(Orders::TrainFighter.getID(), &Orders::TrainFighter));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "InterceptorAttack", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::InterceptorAttack));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "RechargeShieldsUnit", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::RechargeShieldsUnit));
tableOrder.insert(std::pair<int, const Order*>(Orders::RechargeShieldsUnit.getID(), &Orders::RechargeShieldsUnit));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "RechargeShieldsBattery", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::RechargeShieldsBattery));
tableOrder.insert(std::pair<int, const Order*>(Orders::RechargeShieldsBattery.getID(), &Orders::RechargeShieldsBattery));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "ShieldBattery", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::ShieldBattery));
tableOrder.insert(std::pair<int, const Order*>(Orders::ShieldBattery.getID(), &Orders::ShieldBattery));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "InterceptorReturn", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::InterceptorReturn));
tableOrder.insert(std::pair<int, const Order*>(Orders::InterceptorReturn.getID(), &Orders::InterceptorReturn));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "BuildingLand", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::BuildingLand));
tableOrder.insert(std::pair<int, const Order*>(Orders::BuildingLand.getID(), &Orders::BuildingLand));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "BuildingLiftOff", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::BuildingLiftOff));
tableOrder.insert(std::pair<int, const Order*>(Orders::BuildingLiftOff.getID(), &Orders::BuildingLiftOff));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "DroneLiftOff", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::DroneLiftOff));
tableOrder.insert(std::pair<int, const Order*>(Orders::DroneLiftOff.getID(), &Orders::DroneLiftOff));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "LiftingOff", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::LiftingOff));
tableOrder.insert(std::pair<int, const Order*>(Orders::LiftingOff.getID(), &Orders::LiftingOff));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "ResearchTech", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::ResearchTech));
tableOrder.insert(std::pair<int, const Order*>(Orders::ResearchTech.getID(), &Orders::ResearchTech));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Upgrade", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::Upgrade));
tableOrder.insert(std::pair<int, const Order*>(Orders::Upgrade.getID(), &Orders::Upgrade));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Larva", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::Larva));
tableOrder.insert(std::pair<int, const Order*>(Orders::Larva.getID(), &Orders::Larva));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "SpawningLarva", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::SpawningLarva));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Harvest2", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::Harvest2));
tableOrder.insert(std::pair<int, const Order*>(Orders::Harvest2.getID(), &Orders::Harvest2));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "MoveToGas", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::MoveToGas));
tableOrder.insert(std::pair<int, const Order*>(Orders::MoveToGas.getID(), &Orders::MoveToGas));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "WaitForGas", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::WaitForGas));
tableOrder.insert(std::pair<int, const Order*>(Orders::WaitForGas.getID(), &Orders::WaitForGas));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "HarvestGas", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::HarvestGas));
tableOrder.insert(std::pair<int, const Order*>(Orders::HarvestGas.getID(), &Orders::HarvestGas));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "ReturnGas", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::ReturnGas));
tableOrder.insert(std::pair<int, const Order*>(Orders::ReturnGas.getID(), &Orders::ReturnGas));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "MoveToMinerals", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::MoveToMinerals));
tableOrder.insert(std::pair<int, const Order*>(Orders::MoveToMinerals.getID(), &Orders::MoveToMinerals));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "WaitForMinerals", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::WaitForMinerals));
tableOrder.insert(std::pair<int, const Order*>(Orders::WaitForMinerals.getID(), &Orders::WaitForMinerals));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "MiningMinerals", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::MiningMinerals));
tableOrder.insert(std::pair<int, const Order*>(Orders::MiningMinerals.getID(), &Orders::MiningMinerals));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Harvest3", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::Harvest3));
tableOrder.insert(std::pair<int, const Order*>(Orders::Harvest3.getID(), &Orders::Harvest3));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Harvest4", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::Harvest4));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Interrupted", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::Interrupted));
tableOrder.insert(std::pair<int, const Order*>(Orders::Interrupted.getID(), &Orders::Interrupted));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "EnterTransport", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::EnterTransport));
tableOrder.insert(std::pair<int, const Order*>(Orders::EnterTransport.getID(), &Orders::EnterTransport));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "PickupIdle", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::PickupIdle));
tableOrder.insert(std::pair<int, const Order*>(Orders::PickupIdle.getID(), &Orders::PickupIdle));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "PickupTransport", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::PickupTransport));
tableOrder.insert(std::pair<int, const Order*>(Orders::PickupTransport.getID(), &Orders::PickupTransport));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "PickupBunker", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::PickupBunker));
tableOrder.insert(std::pair<int, const Order*>(Orders::PickupBunker.getID(), &Orders::PickupBunker));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Pickup4", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::Pickup4));
tableOrder.insert(std::pair<int, const Order*>(Orders::Pickup4.getID(), &Orders::Pickup4));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "PowerupIdle", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::PowerupIdle));
tableOrder.insert(std::pair<int, const Order*>(Orders::PowerupIdle.getID(), &Orders::PowerupIdle));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Sieging", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::Sieging));
tableOrder.insert(std::pair<int, const Order*>(Orders::Sieging.getID(), &Orders::Sieging));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Unsieging", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::Unsieging));
tableOrder.insert(std::pair<int, const Order*>(Orders::Unsieging.getID(), &Orders::Unsieging));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "InitCreepGrowth", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::InitCreepGrowth));
tableOrder.insert(std::pair<int, const Order*>(Orders::InitCreepGrowth.getID(), &Orders::InitCreepGrowth));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "SpreadCreep", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::SpreadCreep));
tableOrder.insert(std::pair<int, const Order*>(Orders::SpreadCreep.getID(), &Orders::SpreadCreep));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "StoppingCreepGrowth", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::StoppingCreepGrowth));
tableOrder.insert(std::pair<int, const Order*>(Orders::StoppingCreepGrowth.getID(), &Orders::StoppingCreepGrowth));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "GuardianAspect", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::GuardianAspect));
tableOrder.insert(std::pair<int, const Order*>(Orders::GuardianAspect.getID(), &Orders::GuardianAspect));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "ArchonWarp", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::ArchonWarp));
tableOrder.insert(std::pair<int, const Order*>(Orders::ArchonWarp.getID(), &Orders::ArchonWarp));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "CompletingArchonSummon", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::CompletingArchonSummon));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Decloak", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::Decloak));
tableOrder.insert(std::pair<int, const Order*>(Orders::Decloak.getID(), &Orders::Decloak));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Unload", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::Unload));
tableOrder.insert(std::pair<int, const Order*>(Orders::Unload.getID(), &Orders::Unload));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "MoveUnload", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::MoveUnload));
tableOrder.insert(std::pair<int, const Order*>(Orders::MoveUnload.getID(), &Orders::MoveUnload));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "FireYamatoGun", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::FireYamatoGun));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Burrowing", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::Burrowing));
tableOrder.insert(std::pair<int, const Order*>(Orders::Burrowing.getID(), &Orders::Burrowing));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Burrowed", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::Burrowed));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "CastDarkSwarm", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::CastDarkSwarm));
tableOrder.insert(std::pair<int, const Order*>(Orders::CastDarkSwarm.getID(), &Orders::CastDarkSwarm));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "CastParasite", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::CastParasite));
tableOrder.insert(std::pair<int, const Order*>(Orders::CastParasite.getID(), &Orders::CastParasite));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "CastSpawnBroodlings", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::CastSpawnBroodlings));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "NukeWait", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::NukeWait));
tableOrder.insert(std::pair<int, const Order*>(Orders::NukeWait.getID(), &Orders::NukeWait));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "NukeTrain", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::NukeTrain));
tableOrder.insert(std::pair<int, const Order*>(Orders::NukeTrain.getID(), &Orders::NukeTrain));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "NukeLaunch", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::NukeLaunch));
tableOrder.insert(std::pair<int, const Order*>(Orders::NukeLaunch.getID(), &Orders::NukeLaunch));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "NukePaint", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::NukePaint));
tableOrder.insert(std::pair<int, const Order*>(Orders::NukePaint.getID(), &Orders::NukePaint));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "NukeUnit", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::NukeUnit));
tableOrder.insert(std::pair<int, const Order*>(Orders::NukeUnit.getID(), &Orders::NukeUnit));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "CastNuclearStrike", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::CastNuclearStrike));
tableOrder.insert(std::pair<int, const Order*>(Orders::CastNuclearStrike.getID(), &Orders::CastNuclearStrike));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "NukeTrack", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::NukeTrack));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "PlaceMine", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::PlaceMine));
tableOrder.insert(std::pair<int, const Order*>(Orders::PlaceMine.getID(), &Orders::PlaceMine));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "RightClickAction", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::RightClickAction));
tableOrder.insert(std::pair<int, const Order*>(Orders::RightClickAction.getID(), &Orders::RightClickAction));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "CastRecall", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::CastRecall));
tableOrder.insert(std::pair<int, const Order*>(Orders::CastRecall.getID(), &Orders::CastRecall));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Teleport", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::Teleport));
tableOrder.insert(std::pair<int, const Order*>(Orders::Teleport.getID(), &Orders::Teleport));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "CastScannerSweep", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::CastScannerSweep));
tableOrder.insert(std::pair<int, const Order*>(Orders::CastScannerSweep.getID(), &Orders::CastScannerSweep));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Scanner", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::Scanner));
tableOrder.insert(std::pair<int, const Order*>(Orders::Scanner.getID(), &Orders::Scanner));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "CastDefensiveMatrix", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::CastDefensiveMatrix));
tableOrder.insert(std::pair<int, const Order*>(Orders::CastDefensiveMatrix.getID(), &Orders::CastDefensiveMatrix));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "CastPsionicStorm", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::CastPsionicStorm));
tableOrder.insert(std::pair<int, const Order*>(Orders::CastPsionicStorm.getID(), &Orders::CastPsionicStorm));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "CastIrradiate", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::CastIrradiate));
tableOrder.insert(std::pair<int, const Order*>(Orders::CastIrradiate.getID(), &Orders::CastIrradiate));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "CastPlague", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::CastPlague));
tableOrder.insert(std::pair<int, const Order*>(Orders::CastPlague.getID(), &Orders::CastPlague));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "CastConsume", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::CastConsume));
tableOrder.insert(std::pair<int, const Order*>(Orders::CastConsume.getID(), &Orders::CastConsume));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "CastEnsnare", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::CastEnsnare));
tableOrder.insert(std::pair<int, const Order*>(Orders::CastEnsnare.getID(), &Orders::CastEnsnare));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "CastStasisField", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::CastStasisField));
tableOrder.insert(std::pair<int, const Order*>(Orders::CastStasisField.getID(), &Orders::CastStasisField));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "CastHallucination", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::CastHallucination));
tableOrder.insert(std::pair<int, const Order*>(Orders::CastHallucination.getID(), &Orders::CastHallucination));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Hallucination2", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::Hallucination2));
tableOrder.insert(std::pair<int, const Order*>(Orders::Hallucination2.getID(), &Orders::Hallucination2));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "ResetCollision", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::ResetCollision));
tableOrder.insert(std::pair<int, const Order*>(Orders::ResetCollision.getID(), &Orders::ResetCollision));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Patrol", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::Patrol));
tableOrder.insert(std::pair<int, const Order*>(Orders::Patrol.getID(), &Orders::Patrol));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "CTFCOPInit", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::CTFCOPInit));
tableOrder.insert(std::pair<int, const Order*>(Orders::CTFCOPInit.getID(), &Orders::CTFCOPInit));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "CTFCOPStarted", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::CTFCOPStarted));
tableOrder.insert(std::pair<int, const Order*>(Orders::CTFCOPStarted.getID(), &Orders::CTFCOPStarted));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "CTFCOP2", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::CTFCOP2));
tableOrder.insert(std::pair<int, const Order*>(Orders::CTFCOP2.getID(), &Orders::CTFCOP2));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "ComputerAI", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::ComputerAI));
tableOrder.insert(std::pair<int, const Order*>(Orders::ComputerAI.getID(), &Orders::ComputerAI));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "AtkMoveEP", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::AtkMoveEP));
tableOrder.insert(std::pair<int, const Order*>(Orders::AtkMoveEP.getID(), &Orders::AtkMoveEP));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "HarassMove", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::HarassMove));
tableOrder.insert(std::pair<int, const Order*>(Orders::HarassMove.getID(), &Orders::HarassMove));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "AIPatrol", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::AIPatrol));
tableOrder.insert(std::pair<int, const Order*>(Orders::AIPatrol.getID(), &Orders::AIPatrol));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "GuardPost", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::GuardPost));
tableOrder.insert(std::pair<int, const Order*>(Orders::GuardPost.getID(), &Orders::GuardPost));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "RescuePassive", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::RescuePassive));
tableOrder.insert(std::pair<int, const Order*>(Orders::RescuePassive.getID(), &Orders::RescuePassive));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Neutral", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::Neutral));
tableOrder.insert(std::pair<int, const Order*>(Orders::Neutral.getID(), &Orders::Neutral));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "ComputerReturn", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::ComputerReturn));
tableOrder.insert(std::pair<int, const Order*>(Orders::ComputerReturn.getID(), &Orders::ComputerReturn));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "SelfDestructing", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::SelfDestructing));
tableOrder.insert(std::pair<int, const Order*>(Orders::SelfDestructing.getID(), &Orders::SelfDestructing));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Critter", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::Critter));
tableOrder.insert(std::pair<int, const Order*>(Orders::Critter.getID(), &Orders::Critter));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "HiddenGun", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::HiddenGun));
tableOrder.insert(std::pair<int, const Order*>(Orders::HiddenGun.getID(), &Orders::HiddenGun));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "OpenDoor", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::OpenDoor));
tableOrder.insert(std::pair<int, const Order*>(Orders::OpenDoor.getID(), &Orders::OpenDoor));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "CloseDoor", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::CloseDoor));
tableOrder.insert(std::pair<int, const Order*>(Orders::CloseDoor.getID(), &Orders::CloseDoor));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "HideTrap", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::HideTrap));
tableOrder.insert(std::pair<int, const Order*>(Orders::HideTrap.getID(), &Orders::HideTrap));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "RevealTrap", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::RevealTrap));
tableOrder.insert(std::pair<int, const Order*>(Orders::RevealTrap.getID(), &Orders::RevealTrap));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "EnableDoodad", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::EnableDoodad));
tableOrder.insert(std::pair<int, const Order*>(Orders::EnableDoodad.getID(), &Orders::EnableDoodad));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "DisableDoodad", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::DisableDoodad));
tableOrder.insert(std::pair<int, const Order*>(Orders::DisableDoodad.getID(), &Orders::DisableDoodad));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "WarpIn", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::WarpIn));
tableOrder.insert(std::pair<int, const Order*>(Orders::WarpIn.getID(), &Orders::WarpIn));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Medic", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::Medic));
tableOrder.insert(std::pair<int, const Order*>(Orders::Medic.getID(), &Orders::Medic));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "MedicHeal", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::MedicHeal));
tableOrder.insert(std::pair<int, const Order*>(Orders::MedicHeal.getID(), &Orders::MedicHeal));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "HealMove", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::HealMove));
tableOrder.insert(std::pair<int, const Order*>(Orders::HealMove.getID(), &Orders::HealMove));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "MedicHealToIdle", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::MedicHealToIdle));
tableOrder.insert(std::pair<int, const Order*>(Orders::MedicHealToIdle.getID(), &Orders::MedicHealToIdle));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "CastRestoration", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::CastRestoration));
tableOrder.insert(std::pair<int, const Order*>(Orders::CastRestoration.getID(), &Orders::CastRestoration));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "CastDisruptionWeb", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::CastDisruptionWeb));
tableOrder.insert(std::pair<int, const Order*>(Orders::CastDisruptionWeb.getID(), &Orders::CastDisruptionWeb));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "CastMindControl", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::CastMindControl));
tableOrder.insert(std::pair<int, const Order*>(Orders::CastMindControl.getID(), &Orders::CastMindControl));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "DarkArchonMeld", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::DarkArchonMeld));
tableOrder.insert(std::pair<int, const Order*>(Orders::DarkArchonMeld.getID(), &Orders::DarkArchonMeld));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "CastFeedback", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::CastFeedback));
tableOrder.insert(std::pair<int, const Order*>(Orders::CastFeedback.getID(), &Orders::CastFeedback));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "CastOpticalFlare", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::CastOpticalFlare));
tableOrder.insert(std::pair<int, const Order*>(Orders::CastOpticalFlare.getID(), &Orders::CastOpticalFlare));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "CastMaelstrom", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::CastMaelstrom));
tableOrder.insert(std::pair<int, const Order*>(Orders::CastMaelstrom.getID(), &Orders::CastMaelstrom));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "JunkYardDog", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::JunkYardDog));
tableOrder.insert(std::pair<int, const Order*>(Orders::JunkYardDog.getID(), &Orders::JunkYardDog));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Fatal", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::Fatal));
tableOrder.insert(std::pair<int, const Order*>(Orders::Fatal.getID(), &Orders::Fatal));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "None", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::None));
tableOrder.insert(std::pair<int, const Order*>(Orders::None.getID(), &Orders::None));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Unknown", "Lbwapi4/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::Unknown));
tableOrder.insert(std::pair<int, const Order*>(Orders::Unknown.getID(), &Orders::Unknown));
cls = env->FindClass("Lbwapi4/PlayerType;");
getId = env->GetStaticMethodID(cls, "get", "(J)Lbwapi4/PlayerType;");
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "None", "Lbwapi4/PlayerType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&PlayerTypes::None));
tablePlayerType.insert(std::pair<int, const PlayerType*>(PlayerTypes::None.getID(), &PlayerTypes::None));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Computer", "Lbwapi4/PlayerType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&PlayerTypes::Computer));
tablePlayerType.insert(std::pair<int, const PlayerType*>(PlayerTypes::Computer.getID(), &PlayerTypes::Computer));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Player", "Lbwapi4/PlayerType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&PlayerTypes::Player));
tablePlayerType.insert(std::pair<int, const PlayerType*>(PlayerTypes::Player.getID(), &PlayerTypes::Player));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "RescuePassive", "Lbwapi4/PlayerType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&PlayerTypes::RescuePassive));
tablePlayerType.insert(std::pair<int, const PlayerType*>(PlayerTypes::RescuePassive.getID(), &PlayerTypes::RescuePassive));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "EitherPreferComputer", "Lbwapi4/PlayerType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&PlayerTypes::EitherPreferComputer));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "EitherPreferHuman", "Lbwapi4/PlayerType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&PlayerTypes::EitherPreferHuman));
tablePlayerType.insert(std::pair<int, const PlayerType*>(PlayerTypes::EitherPreferHuman.getID(), &PlayerTypes::EitherPreferHuman));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Neutral", "Lbwapi4/PlayerType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&PlayerTypes::Neutral));
tablePlayerType.insert(std::pair<int, const PlayerType*>(PlayerTypes::Neutral.getID(), &PlayerTypes::Neutral));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Closed", "Lbwapi4/PlayerType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&PlayerTypes::Closed));
tablePlayerType.insert(std::pair<int, const PlayerType*>(PlayerTypes::Closed.getID(), &PlayerTypes::Closed));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "PlayerLeft", "Lbwapi4/PlayerType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&PlayerTypes::PlayerLeft));
tablePlayerType.insert(std::pair<int, const PlayerType*>(PlayerTypes::PlayerLeft.getID(), &PlayerTypes::PlayerLeft));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "ComputerLeft", "Lbwapi4/PlayerType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&PlayerTypes::ComputerLeft));
tablePlayerType.insert(std::pair<int, const PlayerType*>(PlayerTypes::ComputerLeft.getID(), &PlayerTypes::ComputerLeft));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Unknown", "Lbwapi4/PlayerType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&PlayerTypes::Unknown));
tablePlayerType.insert(std::pair<int, const PlayerType*>(PlayerTypes::Unknown.getID(), &PlayerTypes::Unknown));
cls = env->FindClass("Lbwapi4/Race;");
getId = env->GetStaticMethodID(cls, "get", "(J)Lbwapi4/Race;");
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Zerg", "Lbwapi4/Race;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Races::Zerg));
tableRace.insert(std::pair<int, const Race*>(Races::Zerg.getID(), &Races::Zerg));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Terran", "Lbwapi4/Race;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Races::Terran));
tableRace.insert(std::pair<int, const Race*>(Races::Terran.getID(), &Races::Terran));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Protoss", "Lbwapi4/Race;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Races::Protoss));
tableRace.insert(std::pair<int, const Race*>(Races::Protoss.getID(), &Races::Protoss));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Random", "Lbwapi4/Race;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Races::Random));
tableRace.insert(std::pair<int, const Race*>(Races::Random.getID(), &Races::Random));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "None", "Lbwapi4/Race;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Races::None));
tableRace.insert(std::pair<int, const Race*>(Races::None.getID(), &Races::None));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Unknown", "Lbwapi4/Race;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Races::Unknown));
tableRace.insert(std::pair<int, const Race*>(Races::Unknown.getID(), &Races::Unknown));
cls = env->FindClass("Lbwapi4/TechType;");
getId = env->GetStaticMethodID(cls, "get", "(J)Lbwapi4/TechType;");
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Stim_Packs", "Lbwapi4/TechType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&TechTypes::Stim_Packs));
tableTechType.insert(std::pair<int, const TechType*>(TechTypes::Stim_Packs.getID(), &TechTypes::Stim_Packs));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Lockdown", "Lbwapi4/TechType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&TechTypes::Lockdown));
tableTechType.insert(std::pair<int, const TechType*>(TechTypes::Lockdown.getID(), &TechTypes::Lockdown));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "EMP_Shockwave", "Lbwapi4/TechType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&TechTypes::EMP_Shockwave));
tableTechType.insert(std::pair<int, const TechType*>(TechTypes::EMP_Shockwave.getID(), &TechTypes::EMP_Shockwave));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Spider_Mines", "Lbwapi4/TechType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&TechTypes::Spider_Mines));
tableTechType.insert(std::pair<int, const TechType*>(TechTypes::Spider_Mines.getID(), &TechTypes::Spider_Mines));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Scanner_Sweep", "Lbwapi4/TechType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&TechTypes::Scanner_Sweep));
tableTechType.insert(std::pair<int, const TechType*>(TechTypes::Scanner_Sweep.getID(), &TechTypes::Scanner_Sweep));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Tank_Siege_Mode", "Lbwapi4/TechType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&TechTypes::Tank_Siege_Mode));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Irradiate", "Lbwapi4/TechType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&TechTypes::Irradiate));
tableTechType.insert(std::pair<int, const TechType*>(TechTypes::Irradiate.getID(), &TechTypes::Irradiate));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Yamato_Gun", "Lbwapi4/TechType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&TechTypes::Yamato_Gun));
tableTechType.insert(std::pair<int, const TechType*>(TechTypes::Yamato_Gun.getID(), &TechTypes::Yamato_Gun));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Cloaking_Field", "Lbwapi4/TechType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&TechTypes::Cloaking_Field));
tableTechType.insert(std::pair<int, const TechType*>(TechTypes::Cloaking_Field.getID(), &TechTypes::Cloaking_Field));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Personnel_Cloaking", "Lbwapi4/TechType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&TechTypes::Personnel_Cloaking));
tableTechType.insert(std::pair<int, const TechType*>(TechTypes::Personnel_Cloaking.getID(), &TechTypes::Personnel_Cloaking));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Burrowing", "Lbwapi4/TechType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&TechTypes::Burrowing));
tableTechType.insert(std::pair<int, const TechType*>(TechTypes::Burrowing.getID(), &TechTypes::Burrowing));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Infestation", "Lbwapi4/TechType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&TechTypes::Infestation));
tableTechType.insert(std::pair<int, const TechType*>(TechTypes::Infestation.getID(), &TechTypes::Infestation));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Spawn_Broodlings", "Lbwapi4/TechType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&TechTypes::Spawn_Broodlings));
tableTechType.insert(std::pair<int, const TechType*>(TechTypes::Spawn_Broodlings.getID(), &TechTypes::Spawn_Broodlings));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Dark_Swarm", "Lbwapi4/TechType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&TechTypes::Dark_Swarm));
tableTechType.insert(std::pair<int, const TechType*>(TechTypes::Dark_Swarm.getID(), &TechTypes::Dark_Swarm));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Plague", "Lbwapi4/TechType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&TechTypes::Plague));
tableTechType.insert(std::pair<int, const TechType*>(TechTypes::Plague.getID(), &TechTypes::Plague));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Consume", "Lbwapi4/TechType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&TechTypes::Consume));
tableTechType.insert(std::pair<int, const TechType*>(TechTypes::Consume.getID(), &TechTypes::Consume));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Ensnare", "Lbwapi4/TechType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&TechTypes::Ensnare));
tableTechType.insert(std::pair<int, const TechType*>(TechTypes::Ensnare.getID(), &TechTypes::Ensnare));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Parasite", "Lbwapi4/TechType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&TechTypes::Parasite));
tableTechType.insert(std::pair<int, const TechType*>(TechTypes::Parasite.getID(), &TechTypes::Parasite));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Psionic_Storm", "Lbwapi4/TechType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&TechTypes::Psionic_Storm));
tableTechType.insert(std::pair<int, const TechType*>(TechTypes::Psionic_Storm.getID(), &TechTypes::Psionic_Storm));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Hallucination", "Lbwapi4/TechType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&TechTypes::Hallucination));
tableTechType.insert(std::pair<int, const TechType*>(TechTypes::Hallucination.getID(), &TechTypes::Hallucination));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Recall", "Lbwapi4/TechType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&TechTypes::Recall));
tableTechType.insert(std::pair<int, const TechType*>(TechTypes::Recall.getID(), &TechTypes::Recall));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Stasis_Field", "Lbwapi4/TechType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&TechTypes::Stasis_Field));
tableTechType.insert(std::pair<int, const TechType*>(TechTypes::Stasis_Field.getID(), &TechTypes::Stasis_Field));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Archon_Warp", "Lbwapi4/TechType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&TechTypes::Archon_Warp));
tableTechType.insert(std::pair<int, const TechType*>(TechTypes::Archon_Warp.getID(), &TechTypes::Archon_Warp));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Restoration", "Lbwapi4/TechType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&TechTypes::Restoration));
tableTechType.insert(std::pair<int, const TechType*>(TechTypes::Restoration.getID(), &TechTypes::Restoration));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Disruption_Web", "Lbwapi4/TechType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&TechTypes::Disruption_Web));
tableTechType.insert(std::pair<int, const TechType*>(TechTypes::Disruption_Web.getID(), &TechTypes::Disruption_Web));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Mind_Control", "Lbwapi4/TechType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&TechTypes::Mind_Control));
tableTechType.insert(std::pair<int, const TechType*>(TechTypes::Mind_Control.getID(), &TechTypes::Mind_Control));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Dark_Archon_Meld", "Lbwapi4/TechType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&TechTypes::Dark_Archon_Meld));
tableTechType.insert(std::pair<int, const TechType*>(TechTypes::Dark_Archon_Meld.getID(), &TechTypes::Dark_Archon_Meld));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Feedback", "Lbwapi4/TechType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&TechTypes::Feedback));
tableTechType.insert(std::pair<int, const TechType*>(TechTypes::Feedback.getID(), &TechTypes::Feedback));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Optical_Flare", "Lbwapi4/TechType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&TechTypes::Optical_Flare));
tableTechType.insert(std::pair<int, const TechType*>(TechTypes::Optical_Flare.getID(), &TechTypes::Optical_Flare));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Maelstrom", "Lbwapi4/TechType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&TechTypes::Maelstrom));
tableTechType.insert(std::pair<int, const TechType*>(TechTypes::Maelstrom.getID(), &TechTypes::Maelstrom));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Lurker_Aspect", "Lbwapi4/TechType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&TechTypes::Lurker_Aspect));
tableTechType.insert(std::pair<int, const TechType*>(TechTypes::Lurker_Aspect.getID(), &TechTypes::Lurker_Aspect));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Healing", "Lbwapi4/TechType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&TechTypes::Healing));
tableTechType.insert(std::pair<int, const TechType*>(TechTypes::Healing.getID(), &TechTypes::Healing));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "None", "Lbwapi4/TechType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&TechTypes::None));
tableTechType.insert(std::pair<int, const TechType*>(TechTypes::None.getID(), &TechTypes::None));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Nuclear_Strike", "Lbwapi4/TechType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&TechTypes::Nuclear_Strike));
tableTechType.insert(std::pair<int, const TechType*>(TechTypes::Nuclear_Strike.getID(), &TechTypes::Nuclear_Strike));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Unknown", "Lbwapi4/TechType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&TechTypes::Unknown));
tableTechType.insert(std::pair<int, const TechType*>(TechTypes::Unknown.getID(), &TechTypes::Unknown));
cls = env->FindClass("Lbwapi4/UnitCommandType;");
getId = env->GetStaticMethodID(cls, "get", "(J)Lbwapi4/UnitCommandType;");
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Attack_Move", "Lbwapi4/UnitCommandType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitCommandTypes::Attack_Move));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Attack_Unit", "Lbwapi4/UnitCommandType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitCommandTypes::Attack_Unit));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Build", "Lbwapi4/UnitCommandType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitCommandTypes::Build));
tableUnitCommandType.insert(std::pair<int, const UnitCommandType*>(UnitCommandTypes::Build.getID(), &UnitCommandTypes::Build));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Build_Addon", "Lbwapi4/UnitCommandType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitCommandTypes::Build_Addon));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Train", "Lbwapi4/UnitCommandType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitCommandTypes::Train));
tableUnitCommandType.insert(std::pair<int, const UnitCommandType*>(UnitCommandTypes::Train.getID(), &UnitCommandTypes::Train));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Morph", "Lbwapi4/UnitCommandType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitCommandTypes::Morph));
tableUnitCommandType.insert(std::pair<int, const UnitCommandType*>(UnitCommandTypes::Morph.getID(), &UnitCommandTypes::Morph));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Research", "Lbwapi4/UnitCommandType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitCommandTypes::Research));
tableUnitCommandType.insert(std::pair<int, const UnitCommandType*>(UnitCommandTypes::Research.getID(), &UnitCommandTypes::Research));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Upgrade", "Lbwapi4/UnitCommandType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitCommandTypes::Upgrade));
tableUnitCommandType.insert(std::pair<int, const UnitCommandType*>(UnitCommandTypes::Upgrade.getID(), &UnitCommandTypes::Upgrade));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Set_Rally_Position", "Lbwapi4/UnitCommandType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitCommandTypes::Set_Rally_Position));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Set_Rally_Unit", "Lbwapi4/UnitCommandType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitCommandTypes::Set_Rally_Unit));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Move", "Lbwapi4/UnitCommandType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitCommandTypes::Move));
tableUnitCommandType.insert(std::pair<int, const UnitCommandType*>(UnitCommandTypes::Move.getID(), &UnitCommandTypes::Move));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Patrol", "Lbwapi4/UnitCommandType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitCommandTypes::Patrol));
tableUnitCommandType.insert(std::pair<int, const UnitCommandType*>(UnitCommandTypes::Patrol.getID(), &UnitCommandTypes::Patrol));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Hold_Position", "Lbwapi4/UnitCommandType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitCommandTypes::Hold_Position));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Stop", "Lbwapi4/UnitCommandType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitCommandTypes::Stop));
tableUnitCommandType.insert(std::pair<int, const UnitCommandType*>(UnitCommandTypes::Stop.getID(), &UnitCommandTypes::Stop));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Follow", "Lbwapi4/UnitCommandType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitCommandTypes::Follow));
tableUnitCommandType.insert(std::pair<int, const UnitCommandType*>(UnitCommandTypes::Follow.getID(), &UnitCommandTypes::Follow));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Gather", "Lbwapi4/UnitCommandType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitCommandTypes::Gather));
tableUnitCommandType.insert(std::pair<int, const UnitCommandType*>(UnitCommandTypes::Gather.getID(), &UnitCommandTypes::Gather));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Return_Cargo", "Lbwapi4/UnitCommandType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitCommandTypes::Return_Cargo));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Repair", "Lbwapi4/UnitCommandType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitCommandTypes::Repair));
tableUnitCommandType.insert(std::pair<int, const UnitCommandType*>(UnitCommandTypes::Repair.getID(), &UnitCommandTypes::Repair));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Burrow", "Lbwapi4/UnitCommandType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitCommandTypes::Burrow));
tableUnitCommandType.insert(std::pair<int, const UnitCommandType*>(UnitCommandTypes::Burrow.getID(), &UnitCommandTypes::Burrow));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Unburrow", "Lbwapi4/UnitCommandType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitCommandTypes::Unburrow));
tableUnitCommandType.insert(std::pair<int, const UnitCommandType*>(UnitCommandTypes::Unburrow.getID(), &UnitCommandTypes::Unburrow));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Cloak", "Lbwapi4/UnitCommandType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitCommandTypes::Cloak));
tableUnitCommandType.insert(std::pair<int, const UnitCommandType*>(UnitCommandTypes::Cloak.getID(), &UnitCommandTypes::Cloak));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Decloak", "Lbwapi4/UnitCommandType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitCommandTypes::Decloak));
tableUnitCommandType.insert(std::pair<int, const UnitCommandType*>(UnitCommandTypes::Decloak.getID(), &UnitCommandTypes::Decloak));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Siege", "Lbwapi4/UnitCommandType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitCommandTypes::Siege));
tableUnitCommandType.insert(std::pair<int, const UnitCommandType*>(UnitCommandTypes::Siege.getID(), &UnitCommandTypes::Siege));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Unsiege", "Lbwapi4/UnitCommandType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitCommandTypes::Unsiege));
tableUnitCommandType.insert(std::pair<int, const UnitCommandType*>(UnitCommandTypes::Unsiege.getID(), &UnitCommandTypes::Unsiege));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Lift", "Lbwapi4/UnitCommandType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitCommandTypes::Lift));
tableUnitCommandType.insert(std::pair<int, const UnitCommandType*>(UnitCommandTypes::Lift.getID(), &UnitCommandTypes::Lift));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Land", "Lbwapi4/UnitCommandType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitCommandTypes::Land));
tableUnitCommandType.insert(std::pair<int, const UnitCommandType*>(UnitCommandTypes::Land.getID(), &UnitCommandTypes::Land));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Load", "Lbwapi4/UnitCommandType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitCommandTypes::Load));
tableUnitCommandType.insert(std::pair<int, const UnitCommandType*>(UnitCommandTypes::Load.getID(), &UnitCommandTypes::Load));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Unload", "Lbwapi4/UnitCommandType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitCommandTypes::Unload));
tableUnitCommandType.insert(std::pair<int, const UnitCommandType*>(UnitCommandTypes::Unload.getID(), &UnitCommandTypes::Unload));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Unload_All", "Lbwapi4/UnitCommandType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitCommandTypes::Unload_All));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Unload_All_Position", "Lbwapi4/UnitCommandType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitCommandTypes::Unload_All_Position));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Right_Click_Position", "Lbwapi4/UnitCommandType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitCommandTypes::Right_Click_Position));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Right_Click_Unit", "Lbwapi4/UnitCommandType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitCommandTypes::Right_Click_Unit));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Halt_Construction", "Lbwapi4/UnitCommandType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitCommandTypes::Halt_Construction));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Cancel_Construction", "Lbwapi4/UnitCommandType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitCommandTypes::Cancel_Construction));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Cancel_Addon", "Lbwapi4/UnitCommandType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitCommandTypes::Cancel_Addon));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Cancel_Train", "Lbwapi4/UnitCommandType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitCommandTypes::Cancel_Train));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Cancel_Train_Slot", "Lbwapi4/UnitCommandType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitCommandTypes::Cancel_Train_Slot));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Cancel_Morph", "Lbwapi4/UnitCommandType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitCommandTypes::Cancel_Morph));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Cancel_Research", "Lbwapi4/UnitCommandType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitCommandTypes::Cancel_Research));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Cancel_Upgrade", "Lbwapi4/UnitCommandType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitCommandTypes::Cancel_Upgrade));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Use_Tech", "Lbwapi4/UnitCommandType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitCommandTypes::Use_Tech));
tableUnitCommandType.insert(std::pair<int, const UnitCommandType*>(UnitCommandTypes::Use_Tech.getID(), &UnitCommandTypes::Use_Tech));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Use_Tech_Position", "Lbwapi4/UnitCommandType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitCommandTypes::Use_Tech_Position));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Use_Tech_Unit", "Lbwapi4/UnitCommandType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitCommandTypes::Use_Tech_Unit));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Place_COP", "Lbwapi4/UnitCommandType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitCommandTypes::Place_COP));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "None", "Lbwapi4/UnitCommandType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitCommandTypes::None));
tableUnitCommandType.insert(std::pair<int, const UnitCommandType*>(UnitCommandTypes::None.getID(), &UnitCommandTypes::None));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Unknown", "Lbwapi4/UnitCommandType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitCommandTypes::Unknown));
tableUnitCommandType.insert(std::pair<int, const UnitCommandType*>(UnitCommandTypes::Unknown.getID(), &UnitCommandTypes::Unknown));
cls = env->FindClass("Lbwapi4/UnitSizeType;");
getId = env->GetStaticMethodID(cls, "get", "(J)Lbwapi4/UnitSizeType;");
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Independent", "Lbwapi4/UnitSizeType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitSizeTypes::Independent));
tableUnitSizeType.insert(std::pair<int, const UnitSizeType*>(UnitSizeTypes::Independent.getID(), &UnitSizeTypes::Independent));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Small", "Lbwapi4/UnitSizeType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitSizeTypes::Small));
tableUnitSizeType.insert(std::pair<int, const UnitSizeType*>(UnitSizeTypes::Small.getID(), &UnitSizeTypes::Small));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Medium", "Lbwapi4/UnitSizeType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitSizeTypes::Medium));
tableUnitSizeType.insert(std::pair<int, const UnitSizeType*>(UnitSizeTypes::Medium.getID(), &UnitSizeTypes::Medium));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Large", "Lbwapi4/UnitSizeType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitSizeTypes::Large));
tableUnitSizeType.insert(std::pair<int, const UnitSizeType*>(UnitSizeTypes::Large.getID(), &UnitSizeTypes::Large));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "None", "Lbwapi4/UnitSizeType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitSizeTypes::None));
...
cls = env->FindClass("Lbwapi4/UnitType;");
getId = env->GetStaticMethodID(cls, "get", "(J)Lbwapi4/UnitType;");
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Terran_Marine", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Terran_Marine));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Terran_Marine.getID(), &UnitTypes::Terran_Marine));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Terran_Ghost", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Terran_Ghost));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Terran_Ghost.getID(), &UnitTypes::Terran_Ghost));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Terran_Vulture", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Terran_Vulture));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Terran_Vulture.getID(), &UnitTypes::Terran_Vulture));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Terran_Goliath", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Terran_Goliath));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Terran_Goliath.getID(), &UnitTypes::Terran_Goliath));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Terran_Siege_Tank_Tank_Mode", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Terran_Siege_Tank_Tank_Mode));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Terran_SCV", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Terran_SCV));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Terran_SCV.getID(), &UnitTypes::Terran_SCV));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Terran_Wraith", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Terran_Wraith));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Terran_Wraith.getID(), &UnitTypes::Terran_Wraith));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Terran_Science_Vessel", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Terran_Science_Vessel));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Terran_Science_Vessel.getID(), &UnitTypes::Terran_Science_Vessel));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Hero_Gui_Montag", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Hero_Gui_Montag));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Hero_Gui_Montag.getID(), &UnitTypes::Hero_Gui_Montag));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Terran_Dropship", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Terran_Dropship));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Terran_Dropship.getID(), &UnitTypes::Terran_Dropship));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Terran_Battlecruiser", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Terran_Battlecruiser));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Terran_Battlecruiser.getID(), &UnitTypes::Terran_Battlecruiser));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Terran_Vulture_Spider_Mine", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Terran_Vulture_Spider_Mine));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Terran_Nuclear_Missile", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Terran_Nuclear_Missile));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Terran_Nuclear_Missile.getID(), &UnitTypes::Terran_Nuclear_Missile));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Terran_Civilian", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Terran_Civilian));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Terran_Civilian.getID(), &UnitTypes::Terran_Civilian));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Hero_Sarah_Kerrigan", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Hero_Sarah_Kerrigan));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Hero_Sarah_Kerrigan.getID(), &UnitTypes::Hero_Sarah_Kerrigan));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Hero_Alan_Schezar", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Hero_Alan_Schezar));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Hero_Alan_Schezar.getID(), &UnitTypes::Hero_Alan_Schezar));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Hero_Jim_Raynor_Vulture", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Hero_Jim_Raynor_Vulture));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Hero_Jim_Raynor_Marine", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Hero_Jim_Raynor_Marine));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Hero_Jim_Raynor_Marine.getID(), &UnitTypes::Hero_Jim_Raynor_Marine));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Hero_Tom_Kazansky", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Hero_Tom_Kazansky));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Hero_Tom_Kazansky.getID(), &UnitTypes::Hero_Tom_Kazansky));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Hero_Magellan", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Hero_Magellan));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Hero_Magellan.getID(), &UnitTypes::Hero_Magellan));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Hero_Edmund_Duke_Tank_Mode", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Hero_Edmund_Duke_Tank_Mode));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Hero_Edmund_Duke_Siege_Mode", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Hero_Edmund_Duke_Siege_Mode));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Hero_Arcturus_Mengsk", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Hero_Arcturus_Mengsk));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Hero_Arcturus_Mengsk.getID(), &UnitTypes::Hero_Arcturus_Mengsk));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Hero_Hyperion", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Hero_Hyperion));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Hero_Hyperion.getID(), &UnitTypes::Hero_Hyperion));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Hero_Norad_II", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Hero_Norad_II));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Hero_Norad_II.getID(), &UnitTypes::Hero_Norad_II));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Terran_Siege_Tank_Siege_Mode", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Terran_Siege_Tank_Siege_Mode));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Terran_Firebat", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Terran_Firebat));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Terran_Firebat.getID(), &UnitTypes::Terran_Firebat));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Spell_Scanner_Sweep", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Spell_Scanner_Sweep));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Spell_Scanner_Sweep.getID(), &UnitTypes::Spell_Scanner_Sweep));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Terran_Medic", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Terran_Medic));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Terran_Medic.getID(), &UnitTypes::Terran_Medic));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Zerg_Larva", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Zerg_Larva));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Zerg_Larva.getID(), &UnitTypes::Zerg_Larva));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Zerg_Egg", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Zerg_Egg));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Zerg_Egg.getID(), &UnitTypes::Zerg_Egg));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Zerg_Zergling", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Zerg_Zergling));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Zerg_Zergling.getID(), &UnitTypes::Zerg_Zergling));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Zerg_Hydralisk", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Zerg_Hydralisk));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Zerg_Hydralisk.getID(), &UnitTypes::Zerg_Hydralisk));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Zerg_Ultralisk", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Zerg_Ultralisk));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Zerg_Ultralisk.getID(), &UnitTypes::Zerg_Ultralisk));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Zerg_Broodling", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Zerg_Broodling));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Zerg_Broodling.getID(), &UnitTypes::Zerg_Broodling));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Zerg_Drone", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Zerg_Drone));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Zerg_Drone.getID(), &UnitTypes::Zerg_Drone));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Zerg_Overlord", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Zerg_Overlord));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Zerg_Overlord.getID(), &UnitTypes::Zerg_Overlord));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Zerg_Mutalisk", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Zerg_Mutalisk));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Zerg_Mutalisk.getID(), &UnitTypes::Zerg_Mutalisk));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Zerg_Guardian", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Zerg_Guardian));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Zerg_Guardian.getID(), &UnitTypes::Zerg_Guardian));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Zerg_Queen", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Zerg_Queen));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Zerg_Scourge", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Zerg_Scourge));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Zerg_Scourge.getID(), &UnitTypes::Zerg_Scourge));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Hero_Torrasque", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Hero_Torrasque));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Hero_Torrasque.getID(), &UnitTypes::Hero_Torrasque));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Hero_Matriarch", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Hero_Matriarch));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Hero_Matriarch.getID(), &UnitTypes::Hero_Matriarch));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Zerg_Infested_Terran", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Zerg_Infested_Terran));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Zerg_Infested_Terran.getID(), &UnitTypes::Zerg_Infested_Terran));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Hero_Infested_Kerrigan", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Hero_Infested_Kerrigan));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Hero_Infested_Kerrigan.getID(), &UnitTypes::Hero_Infested_Kerrigan));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Hero_Unclean_One", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Hero_Unclean_One));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Hero_Unclean_One.getID(), &UnitTypes::Hero_Unclean_One));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Hero_Hunter_Killer", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Hero_Hunter_Killer));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Hero_Hunter_Killer.getID(), &UnitTypes::Hero_Hunter_Killer));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Hero_Devouring_One", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Hero_Devouring_One));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Hero_Devouring_One.getID(), &UnitTypes::Hero_Devouring_One));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Hero_Kukulza_Mutalisk", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Hero_Kukulza_Mutalisk));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Hero_Yggdrasill", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Hero_Yggdrasill));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Hero_Yggdrasill.getID(), &UnitTypes::Hero_Yggdrasill));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Terran_Valkyrie", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Terran_Valkyrie));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Terran_Valkyrie.getID(), &UnitTypes::Terran_Valkyrie));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Zerg_Cocoon", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Zerg_Cocoon));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Zerg_Cocoon.getID(), &UnitTypes::Zerg_Cocoon));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Protoss_Corsair", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Protoss_Corsair));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Protoss_Corsair.getID(), &UnitTypes::Protoss_Corsair));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Protoss_Dark_Templar", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Protoss_Dark_Templar));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Protoss_Dark_Templar.getID(), &UnitTypes::Protoss_Dark_Templar));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Zerg_Devourer", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Zerg_Devourer));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Zerg_Devourer.getID(), &UnitTypes::Zerg_Devourer));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Protoss_Dark_Archon", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Protoss_Dark_Archon));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Protoss_Dark_Archon.getID(), &UnitTypes::Protoss_Dark_Archon));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Protoss_Probe", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Protoss_Probe));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Protoss_Probe.getID(), &UnitTypes::Protoss_Probe));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Protoss_Zealot", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Protoss_Zealot));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Protoss_Zealot.getID(), &UnitTypes::Protoss_Zealot));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Protoss_Dragoon", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Protoss_Dragoon));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Protoss_Dragoon.getID(), &UnitTypes::Protoss_Dragoon));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Protoss_High_Templar", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Protoss_High_Templar));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Protoss_High_Templar.getID(), &UnitTypes::Protoss_High_Templar));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Protoss_Archon", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Protoss_Archon));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Protoss_Scout", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Protoss_Scout));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Protoss_Scout.getID(), &UnitTypes::Protoss_Scout));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Protoss_Arbiter", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Protoss_Arbiter));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Protoss_Arbiter.getID(), &UnitTypes::Protoss_Arbiter));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Protoss_Carrier", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Protoss_Carrier));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Protoss_Carrier.getID(), &UnitTypes::Protoss_Carrier));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Protoss_Interceptor", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Protoss_Interceptor));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Protoss_Interceptor.getID(), &UnitTypes::Protoss_Interceptor));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Hero_Dark_Templar", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Hero_Dark_Templar));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Hero_Dark_Templar.getID(), &UnitTypes::Hero_Dark_Templar));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Hero_Zeratul", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Hero_Zeratul));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Hero_Zeratul.getID(), &UnitTypes::Hero_Zeratul));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Hero_Tassadar_Zeratul_Archon", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Hero_Tassadar_Zeratul_Archon));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Hero_Fenix_Zealot", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Hero_Fenix_Zealot));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Hero_Tassadar", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Hero_Tassadar));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Hero_Tassadar.getID(), &UnitTypes::Hero_Tassadar));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Hero_Mojo", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Hero_Mojo));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Hero_Mojo.getID(), &UnitTypes::Hero_Mojo));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Hero_Warbringer", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Hero_Warbringer));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Hero_Warbringer.getID(), &UnitTypes::Hero_Warbringer));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Hero_Gantrithor", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Hero_Gantrithor));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Hero_Gantrithor.getID(), &UnitTypes::Hero_Gantrithor));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Protoss_Reaver", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Protoss_Reaver));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Protoss_Scarab", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Protoss_Scarab));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Protoss_Scarab.getID(), &UnitTypes::Protoss_Scarab));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Hero_Danimoth", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Hero_Danimoth));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Hero_Danimoth.getID(), &UnitTypes::Hero_Danimoth));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Hero_Aldaris", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Hero_Aldaris));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Hero_Aldaris.getID(), &UnitTypes::Hero_Aldaris));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Hero_Artanis", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Hero_Artanis));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Hero_Artanis.getID(), &UnitTypes::Hero_Artanis));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Critter_Rhynadon", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Critter_Rhynadon));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Critter_Rhynadon.getID(), &UnitTypes::Critter_Rhynadon));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Critter_Bengalaas", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Critter_Bengalaas));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Critter_Bengalaas.getID(), &UnitTypes::Critter_Bengalaas));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Special_Cargo_Ship", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Special_Cargo_Ship));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Special_Cargo_Ship.getID(), &UnitTypes::Special_Cargo_Ship));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Special_Mercenary_Gunship", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Special_Mercenary_Gunship));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Critter_Scantid", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Critter_Scantid));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Critter_Scantid.getID(), &UnitTypes::Critter_Scantid));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Critter_Kakaru", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Critter_Kakaru));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Critter_Kakaru.getID(), &UnitTypes::Critter_Kakaru));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Critter_Ragnasaur", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Critter_Ragnasaur));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Critter_Ragnasaur.getID(), &UnitTypes::Critter_Ragnasaur));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Critter_Ursadon", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Critter_Ursadon));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Critter_Ursadon.getID(), &UnitTypes::Critter_Ursadon));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Zerg_Lurker_Egg", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Zerg_Lurker_Egg));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Zerg_Lurker_Egg.getID(), &UnitTypes::Zerg_Lurker_Egg));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Hero_Raszagal", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Hero_Raszagal));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Hero_Raszagal.getID(), &UnitTypes::Hero_Raszagal));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Hero_Samir_Duran", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Hero_Samir_Duran));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Hero_Samir_Duran.getID(), &UnitTypes::Hero_Samir_Duran));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Hero_Alexei_Stukov", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Hero_Alexei_Stukov));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Hero_Alexei_Stukov.getID(), &UnitTypes::Hero_Alexei_Stukov));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Special_Map_Revealer", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Special_Map_Revealer));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Special_Map_Revealer.getID(), &UnitTypes::Special_Map_Revealer));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Hero_Gerard_DuGalle", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Hero_Gerard_DuGalle));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Hero_Gerard_DuGalle.getID(), &UnitTypes::Hero_Gerard_DuGalle));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Zerg_Lurker", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Zerg_Lurker));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Zerg_Lurker.getID(), &UnitTypes::Zerg_Lurker));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Hero_Infested_Duran", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Hero_Infested_Duran));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Hero_Infested_Duran.getID(), &UnitTypes::Hero_Infested_Duran));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Spell_Disruption_Web", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Spell_Disruption_Web));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Spell_Disruption_Web.getID(), &UnitTypes::Spell_Disruption_Web));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Terran_Command_Center", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Terran_Command_Center));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Terran_Command_Center.getID(), &UnitTypes::Terran_Command_Center));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Terran_Comsat_Station", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Terran_Comsat_Station));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Terran_Comsat_Station.getID(), &UnitTypes::Terran_Comsat_Station));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Terran_Nuclear_Silo", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Terran_Nuclear_Silo));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Terran_Refinery", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Terran_Refinery));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Terran_Refinery.getID(), &UnitTypes::Terran_Refinery));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Terran_Barracks", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Terran_Barracks));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Terran_Barracks.getID(), &UnitTypes::Terran_Barracks));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Terran_Academy", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Terran_Academy));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Terran_Starport", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Terran_Starport));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Terran_Starport.getID(), &UnitTypes::Terran_Starport));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Terran_Control_Tower", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Terran_Control_Tower));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Terran_Control_Tower.getID(), &UnitTypes::Terran_Control_Tower));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Terran_Science_Facility", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Terran_Science_Facility));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Terran_Physics_Lab", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Terran_Physics_Lab));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Terran_Physics_Lab.getID(), &UnitTypes::Terran_Physics_Lab));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Terran_Machine_Shop", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Terran_Machine_Shop));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Terran_Armory", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Terran_Armory));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Terran_Armory.getID(), &UnitTypes::Terran_Armory));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Terran_Missile_Turret", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Terran_Missile_Turret));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Terran_Missile_Turret.getID(), &UnitTypes::Terran_Missile_Turret));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Terran_Bunker", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Terran_Bunker));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Terran_Bunker.getID(), &UnitTypes::Terran_Bunker));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Special_Crashed_Norad_II", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Special_Crashed_Norad_II));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Special_Ion_Cannon", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Special_Ion_Cannon));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Special_Ion_Cannon.getID(), &UnitTypes::Special_Ion_Cannon));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Powerup_Uraj_Crystal", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Powerup_Uraj_Crystal));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Powerup_Uraj_Crystal.getID(), &UnitTypes::Powerup_Uraj_Crystal));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Powerup_Khalis_Crystal", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Powerup_Khalis_Crystal));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Powerup_Khalis_Crystal.getID(), &UnitTypes::Powerup_Khalis_Crystal));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Zerg_Infested_Command_Center", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Zerg_Infested_Command_Center));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Zerg_Lair", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Zerg_Lair));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Zerg_Lair.getID(), &UnitTypes::Zerg_Lair));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Zerg_Hive", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Zerg_Hive));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Zerg_Hive.getID(), &UnitTypes::Zerg_Hive));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Zerg_Nydus_Canal", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Zerg_Nydus_Canal));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Zerg_Nydus_Canal.getID(), &UnitTypes::Zerg_Nydus_Canal));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Zerg_Hydralisk_Den", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Zerg_Hydralisk_Den));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Zerg_Hydralisk_Den.getID(), &UnitTypes::Zerg_Hydralisk_Den));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Zerg_Defiler_Mound", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Zerg_Defiler_Mound));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Zerg_Defiler_Mound.getID(), &UnitTypes::Zerg_Defiler_Mound));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Zerg_Greater_Spire", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Zerg_Greater_Spire));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Zerg_Greater_Spire.getID(), &UnitTypes::Zerg_Greater_Spire));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Zerg_Queens_Nest", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Zerg_Queens_Nest));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Zerg_Ultralisk_Cavern", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Zerg_Ultralisk_Cavern));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Zerg_Ultralisk_Cavern.getID(), &UnitTypes::Zerg_Ultralisk_Cavern));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Zerg_Spire", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Zerg_Spire));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Zerg_Spire.getID(), &UnitTypes::Zerg_Spire));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Zerg_Spawning_Pool", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Zerg_Spawning_Pool));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Zerg_Spawning_Pool.getID(), &UnitTypes::Zerg_Spawning_Pool));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Zerg_Creep_Colony", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Zerg_Creep_Colony));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Zerg_Creep_Colony.getID(), &UnitTypes::Zerg_Creep_Colony));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Zerg_Spore_Colony", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Zerg_Spore_Colony));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Zerg_Spore_Colony.getID(), &UnitTypes::Zerg_Spore_Colony));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Zerg_Sunken_Colony", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Zerg_Sunken_Colony));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Zerg_Sunken_Colony.getID(), &UnitTypes::Zerg_Sunken_Colony));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Special_Overmind_With_Shell", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Special_Overmind_With_Shell));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Special_Overmind", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Special_Overmind));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Special_Overmind.getID(), &UnitTypes::Special_Overmind));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Zerg_Extractor", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Zerg_Extractor));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Zerg_Extractor.getID(), &UnitTypes::Zerg_Extractor));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Special_Mature_Chrysalis", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Special_Mature_Chrysalis));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Special_Cerebrate", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Special_Cerebrate));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Protoss_Nexus", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Protoss_Nexus));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Protoss_Nexus.getID(), &UnitTypes::Protoss_Nexus));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Protoss_Robotics_Facility", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Protoss_Robotics_Facility));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Protoss_Assimilator", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Protoss_Assimilator));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Protoss_Assimilator.getID(), &UnitTypes::Protoss_Assimilator));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Protoss_Observatory", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Protoss_Observatory));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Protoss_Observatory.getID(), &UnitTypes::Protoss_Observatory));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Protoss_Gateway", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Protoss_Gateway));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Protoss_Gateway.getID(), &UnitTypes::Protoss_Gateway));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Protoss_Photon_Cannon", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Protoss_Photon_Cannon));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Protoss_Photon_Cannon.getID(), &UnitTypes::Protoss_Photon_Cannon));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Protoss_Citadel_of_Adun", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Protoss_Citadel_of_Adun));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Protoss_Templar_Archives", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Protoss_Templar_Archives));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Protoss_Forge", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Protoss_Forge));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Special_Stasis_Cell_Prison", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Special_Stasis_Cell_Prison));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Protoss_Fleet_Beacon", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Protoss_Fleet_Beacon));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Protoss_Fleet_Beacon.getID(), &UnitTypes::Protoss_Fleet_Beacon));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Protoss_Arbiter_Tribunal", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Protoss_Arbiter_Tribunal));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Protoss_Robotics_Support_Bay", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Protoss_Robotics_Support_Bay));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Special_Khaydarin_Crystal_Form", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Special_Khaydarin_Crystal_Form));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Special_XelNaga_Temple", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Special_XelNaga_Temple));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Special_XelNaga_Temple.getID(), &UnitTypes::Special_XelNaga_Temple));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Resource_Mineral_Field", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Resource_Mineral_Field));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Resource_Mineral_Field.getID(), &UnitTypes::Resource_Mineral_Field));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Resource_Mineral_Field_Type_2", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Resource_Mineral_Field_Type_2));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Resource_Mineral_Field_Type_3", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Resource_Mineral_Field_Type_3));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Special_Independant_Starport", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Special_Independant_Starport));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Resource_Vespene_Geyser", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Resource_Vespene_Geyser));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Special_Warp_Gate", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Special_Warp_Gate));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Special_Zerg_Beacon", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Special_Zerg_Beacon));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Special_Zerg_Beacon.getID(), &UnitTypes::Special_Zerg_Beacon));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Special_Terran_Beacon", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Special_Terran_Beacon));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Special_Zerg_Flag_Beacon", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Special_Zerg_Flag_Beacon));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Special_Terran_Flag_Beacon", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Special_Terran_Flag_Beacon));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Special_Protoss_Flag_Beacon", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Special_Protoss_Flag_Beacon));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Special_Power_Generator", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Special_Power_Generator));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Special_Overmind_Cocoon", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Special_Overmind_Cocoon));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Special_Floor_Missile_Trap", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Special_Floor_Missile_Trap));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Special_Floor_Hatch", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Special_Floor_Hatch));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Special_Floor_Hatch.getID(), &UnitTypes::Special_Floor_Hatch));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Special_Upper_Level_Door", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Special_Upper_Level_Door));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Special_Right_Upper_Level_Door", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Special_Right_Upper_Level_Door));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Special_Pit_Door", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Special_Pit_Door));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Special_Pit_Door.getID(), &UnitTypes::Special_Pit_Door));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Special_Right_Pit_Door", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Special_Right_Pit_Door));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Special_Right_Pit_Door.getID(), &UnitTypes::Special_Right_Pit_Door));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Special_Floor_Gun_Trap", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Special_Floor_Gun_Trap));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Special_Wall_Flame_Trap", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Special_Wall_Flame_Trap));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Special_Right_Wall_Missile_Trap", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Special_Right_Wall_Missile_Trap));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Special_Right_Wall_Flame_Trap", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Special_Right_Wall_Flame_Trap));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Special_Start_Location", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Special_Start_Location));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Special_Start_Location.getID(), &UnitTypes::Special_Start_Location));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Powerup_Flag", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Powerup_Flag));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Powerup_Flag.getID(), &UnitTypes::Powerup_Flag));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Powerup_Young_Chrysalis", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Powerup_Young_Chrysalis));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Powerup_Psi_Emitter", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Powerup_Psi_Emitter));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Powerup_Khaydarin_Crystal", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Powerup_Khaydarin_Crystal));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Powerup_Protoss_Gas_Orb_Type_2", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Powerup_Protoss_Gas_Orb_Type_2));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Powerup_Zerg_Gas_Sac_Type_1", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Powerup_Zerg_Gas_Sac_Type_1));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Powerup_Zerg_Gas_Sac_Type_2", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Powerup_Zerg_Gas_Sac_Type_2));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Powerup_Terran_Gas_Tank_Type_1", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Powerup_Terran_Gas_Tank_Type_1));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Powerup_Terran_Gas_Tank_Type_2", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Powerup_Terran_Gas_Tank_Type_2));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "None", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::None));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::None.getID(), &UnitTypes::None));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "AllUnits", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::AllUnits));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::AllUnits.getID(), &UnitTypes::AllUnits));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Men", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Men));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Men.getID(), &UnitTypes::Men));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Buildings", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Buildings));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Buildings.getID(), &UnitTypes::Buildings));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Factories", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Factories));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Factories.getID(), &UnitTypes::Factories));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Unknown", "Lbwapi4/UnitType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UnitTypes::Unknown));
tableUnitType.insert(std::pair<int, const UnitType*>(UnitTypes::Unknown.getID(), &UnitTypes::Unknown));
cls = env->FindClass("Lbwapi4/UpgradeType;");
getId = env->GetStaticMethodID(cls, "get", "(J)Lbwapi4/UpgradeType;");
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Terran_Infantry_Armor", "Lbwapi4/UpgradeType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UpgradeTypes::Terran_Infantry_Armor));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Terran_Vehicle_Plating", "Lbwapi4/UpgradeType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UpgradeTypes::Terran_Vehicle_Plating));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Terran_Ship_Plating", "Lbwapi4/UpgradeType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UpgradeTypes::Terran_Ship_Plating));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Zerg_Carapace", "Lbwapi4/UpgradeType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UpgradeTypes::Zerg_Carapace));
tableUpgradeType.insert(std::pair<int, const UpgradeType*>(UpgradeTypes::Zerg_Carapace.getID(), &UpgradeTypes::Zerg_Carapace));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Zerg_Flyer_Carapace", "Lbwapi4/UpgradeType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UpgradeTypes::Zerg_Flyer_Carapace));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Protoss_Ground_Armor", "Lbwapi4/UpgradeType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UpgradeTypes::Protoss_Ground_Armor));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Protoss_Air_Armor", "Lbwapi4/UpgradeType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UpgradeTypes::Protoss_Air_Armor));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Terran_Infantry_Weapons", "Lbwapi4/UpgradeType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UpgradeTypes::Terran_Infantry_Weapons));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Terran_Vehicle_Weapons", "Lbwapi4/UpgradeType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UpgradeTypes::Terran_Vehicle_Weapons));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Terran_Ship_Weapons", "Lbwapi4/UpgradeType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UpgradeTypes::Terran_Ship_Weapons));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Zerg_Melee_Attacks", "Lbwapi4/UpgradeType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UpgradeTypes::Zerg_Melee_Attacks));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Zerg_Missile_Attacks", "Lbwapi4/UpgradeType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UpgradeTypes::Zerg_Missile_Attacks));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Zerg_Flyer_Attacks", "Lbwapi4/UpgradeType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UpgradeTypes::Zerg_Flyer_Attacks));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Protoss_Ground_Weapons", "Lbwapi4/UpgradeType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UpgradeTypes::Protoss_Ground_Weapons));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Protoss_Air_Weapons", "Lbwapi4/UpgradeType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UpgradeTypes::Protoss_Air_Weapons));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Protoss_Plasma_Shields", "Lbwapi4/UpgradeType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UpgradeTypes::Protoss_Plasma_Shields));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "U_238_Shells", "Lbwapi4/UpgradeType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UpgradeTypes::U_238_Shells));
tableUpgradeType.insert(std::pair<int, const UpgradeType*>(UpgradeTypes::U_238_Shells.getID(), &UpgradeTypes::U_238_Shells));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Ion_Thrusters", "Lbwapi4/UpgradeType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UpgradeTypes::Ion_Thrusters));
tableUpgradeType.insert(std::pair<int, const UpgradeType*>(UpgradeTypes::Ion_Thrusters.getID(), &UpgradeTypes::Ion_Thrusters));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Titan_Reactor", "Lbwapi4/UpgradeType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UpgradeTypes::Titan_Reactor));
tableUpgradeType.insert(std::pair<int, const UpgradeType*>(UpgradeTypes::Titan_Reactor.getID(), &UpgradeTypes::Titan_Reactor));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Ocular_Implants", "Lbwapi4/UpgradeType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UpgradeTypes::Ocular_Implants));
tableUpgradeType.insert(std::pair<int, const UpgradeType*>(UpgradeTypes::Ocular_Implants.getID(), &UpgradeTypes::Ocular_Implants));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Moebius_Reactor", "Lbwapi4/UpgradeType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UpgradeTypes::Moebius_Reactor));
tableUpgradeType.insert(std::pair<int, const UpgradeType*>(UpgradeTypes::Moebius_Reactor.getID(), &UpgradeTypes::Moebius_Reactor));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Apollo_Reactor", "Lbwapi4/UpgradeType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UpgradeTypes::Apollo_Reactor));
tableUpgradeType.insert(std::pair<int, const UpgradeType*>(UpgradeTypes::Apollo_Reactor.getID(), &UpgradeTypes::Apollo_Reactor));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Colossus_Reactor", "Lbwapi4/UpgradeType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UpgradeTypes::Colossus_Reactor));
tableUpgradeType.insert(std::pair<int, const UpgradeType*>(UpgradeTypes::Colossus_Reactor.getID(), &UpgradeTypes::Colossus_Reactor));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Ventral_Sacs", "Lbwapi4/UpgradeType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UpgradeTypes::Ventral_Sacs));
tableUpgradeType.insert(std::pair<int, const UpgradeType*>(UpgradeTypes::Ventral_Sacs.getID(), &UpgradeTypes::Ventral_Sacs));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Antennae", "Lbwapi4/UpgradeType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UpgradeTypes::Antennae));
tableUpgradeType.insert(std::pair<int, const UpgradeType*>(UpgradeTypes::Antennae.getID(), &UpgradeTypes::Antennae));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Pneumatized_Carapace", "Lbwapi4/UpgradeType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UpgradeTypes::Pneumatized_Carapace));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Metabolic_Boost", "Lbwapi4/UpgradeType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UpgradeTypes::Metabolic_Boost));
tableUpgradeType.insert(std::pair<int, const UpgradeType*>(UpgradeTypes::Metabolic_Boost.getID(), &UpgradeTypes::Metabolic_Boost));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Adrenal_Glands", "Lbwapi4/UpgradeType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UpgradeTypes::Adrenal_Glands));
tableUpgradeType.insert(std::pair<int, const UpgradeType*>(UpgradeTypes::Adrenal_Glands.getID(), &UpgradeTypes::Adrenal_Glands));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Muscular_Augments", "Lbwapi4/UpgradeType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UpgradeTypes::Muscular_Augments));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Grooved_Spines", "Lbwapi4/UpgradeType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UpgradeTypes::Grooved_Spines));
tableUpgradeType.insert(std::pair<int, const UpgradeType*>(UpgradeTypes::Grooved_Spines.getID(), &UpgradeTypes::Grooved_Spines));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Gamete_Meiosis", "Lbwapi4/UpgradeType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UpgradeTypes::Gamete_Meiosis));
tableUpgradeType.insert(std::pair<int, const UpgradeType*>(UpgradeTypes::Gamete_Meiosis.getID(), &UpgradeTypes::Gamete_Meiosis));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Metasynaptic_Node", "Lbwapi4/UpgradeType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UpgradeTypes::Metasynaptic_Node));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Singularity_Charge", "Lbwapi4/UpgradeType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UpgradeTypes::Singularity_Charge));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Leg_Enhancements", "Lbwapi4/UpgradeType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UpgradeTypes::Leg_Enhancements));
tableUpgradeType.insert(std::pair<int, const UpgradeType*>(UpgradeTypes::Leg_Enhancements.getID(), &UpgradeTypes::Leg_Enhancements));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Scarab_Damage", "Lbwapi4/UpgradeType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UpgradeTypes::Scarab_Damage));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Gravitic_Drive", "Lbwapi4/UpgradeType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UpgradeTypes::Gravitic_Drive));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Gravitic_Boosters", "Lbwapi4/UpgradeType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UpgradeTypes::Gravitic_Boosters));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Khaydarin_Amulet", "Lbwapi4/UpgradeType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UpgradeTypes::Khaydarin_Amulet));
tableUpgradeType.insert(std::pair<int, const UpgradeType*>(UpgradeTypes::Khaydarin_Amulet.getID(), &UpgradeTypes::Khaydarin_Amulet));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Apial_Sensors", "Lbwapi4/UpgradeType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UpgradeTypes::Apial_Sensors));
tableUpgradeType.insert(std::pair<int, const UpgradeType*>(UpgradeTypes::Apial_Sensors.getID(), &UpgradeTypes::Apial_Sensors));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Gravitic_Thrusters", "Lbwapi4/UpgradeType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UpgradeTypes::Gravitic_Thrusters));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Carrier_Capacity", "Lbwapi4/UpgradeType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UpgradeTypes::Carrier_Capacity));
tableUpgradeType.insert(std::pair<int, const UpgradeType*>(UpgradeTypes::Carrier_Capacity.getID(), &UpgradeTypes::Carrier_Capacity));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Khaydarin_Core", "Lbwapi4/UpgradeType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UpgradeTypes::Khaydarin_Core));
tableUpgradeType.insert(std::pair<int, const UpgradeType*>(UpgradeTypes::Khaydarin_Core.getID(), &UpgradeTypes::Khaydarin_Core));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Argus_Jewel", "Lbwapi4/UpgradeType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UpgradeTypes::Argus_Jewel));
tableUpgradeType.insert(std::pair<int, const UpgradeType*>(UpgradeTypes::Argus_Jewel.getID(), &UpgradeTypes::Argus_Jewel));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Argus_Talisman", "Lbwapi4/UpgradeType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UpgradeTypes::Argus_Talisman));
tableUpgradeType.insert(std::pair<int, const UpgradeType*>(UpgradeTypes::Argus_Talisman.getID(), &UpgradeTypes::Argus_Talisman));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Caduceus_Reactor", "Lbwapi4/UpgradeType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UpgradeTypes::Caduceus_Reactor));
tableUpgradeType.insert(std::pair<int, const UpgradeType*>(UpgradeTypes::Caduceus_Reactor.getID(), &UpgradeTypes::Caduceus_Reactor));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Chitinous_Plating", "Lbwapi4/UpgradeType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UpgradeTypes::Chitinous_Plating));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Anabolic_Synthesis", "Lbwapi4/UpgradeType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UpgradeTypes::Anabolic_Synthesis));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Charon_Boosters", "Lbwapi4/UpgradeType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UpgradeTypes::Charon_Boosters));
tableUpgradeType.insert(std::pair<int, const UpgradeType*>(UpgradeTypes::Charon_Boosters.getID(), &UpgradeTypes::Charon_Boosters));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Upgrade_60", "Lbwapi4/UpgradeType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UpgradeTypes::Upgrade_60));
tableUpgradeType.insert(std::pair<int, const UpgradeType*>(UpgradeTypes::Upgrade_60.getID(), &UpgradeTypes::Upgrade_60));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "None", "Lbwapi4/UpgradeType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UpgradeTypes::None));
tableUpgradeType.insert(std::pair<int, const UpgradeType*>(UpgradeTypes::None.getID(), &UpgradeTypes::None));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Unknown", "Lbwapi4/UpgradeType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UpgradeTypes::Unknown));
tableUpgradeType.insert(std::pair<int, const UpgradeType*>(UpgradeTypes::Unknown.getID(), &UpgradeTypes::Unknown));
cls = env->FindClass("Lbwapi4/WeaponType;");
getId = env->GetStaticMethodID(cls, "get", "(J)Lbwapi4/WeaponType;");
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Gauss_Rifle", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Gauss_Rifle));
tableWeaponType.insert(std::pair<int, const WeaponType*>(WeaponTypes::Gauss_Rifle.getID(), &WeaponTypes::Gauss_Rifle));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Gauss_Rifle_Jim_Raynor", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Gauss_Rifle_Jim_Raynor));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "C_10_Canister_Rifle_Sarah_Kerrigan", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::C_10_Canister_Rifle_Sarah_Kerrigan));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "C_10_Canister_Rifle_Samir_Duran", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::C_10_Canister_Rifle_Samir_Duran));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "C_10_Canister_Rifle_Infested_Duran", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::C_10_Canister_Rifle_Infested_Duran));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "C_10_Canister_Rifle_Alexei_Stukov", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::C_10_Canister_Rifle_Alexei_Stukov));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Fragmentation_Grenade", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Fragmentation_Grenade));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Fragmentation_Grenade_Jim_Raynor", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Fragmentation_Grenade_Jim_Raynor));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Spider_Mines", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Spider_Mines));
tableWeaponType.insert(std::pair<int, const WeaponType*>(WeaponTypes::Spider_Mines.getID(), &WeaponTypes::Spider_Mines));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Twin_Autocannons", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Twin_Autocannons));
tableWeaponType.insert(std::pair<int, const WeaponType*>(WeaponTypes::Twin_Autocannons.getID(), &WeaponTypes::Twin_Autocannons));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Twin_Autocannons_Alan_Schezar", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Twin_Autocannons_Alan_Schezar));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Hellfire_Missile_Pack", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Hellfire_Missile_Pack));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Hellfire_Missile_Pack_Alan_Schezar", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Hellfire_Missile_Pack_Alan_Schezar));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Arclite_Cannon", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Arclite_Cannon));
tableWeaponType.insert(std::pair<int, const WeaponType*>(WeaponTypes::Arclite_Cannon.getID(), &WeaponTypes::Arclite_Cannon));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Arclite_Cannon_Edmund_Duke", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Arclite_Cannon_Edmund_Duke));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Fusion_Cutter", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Fusion_Cutter));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Gemini_Missiles_Tom_Kazansky", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Gemini_Missiles_Tom_Kazansky));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Burst_Lasers", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Burst_Lasers));
tableWeaponType.insert(std::pair<int, const WeaponType*>(WeaponTypes::Burst_Lasers.getID(), &WeaponTypes::Burst_Lasers));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Burst_Lasers_Tom_Kazansky", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Burst_Lasers_Tom_Kazansky));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "ATS_Laser_Battery", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::ATS_Laser_Battery));
tableWeaponType.insert(std::pair<int, const WeaponType*>(WeaponTypes::ATS_Laser_Battery.getID(), &WeaponTypes::ATS_Laser_Battery));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "ATS_Laser_Battery_Hero", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::ATS_Laser_Battery_Hero));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "ATS_Laser_Battery_Hyperion", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::ATS_Laser_Battery_Hyperion));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "ATA_Laser_Battery", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::ATA_Laser_Battery));
tableWeaponType.insert(std::pair<int, const WeaponType*>(WeaponTypes::ATA_Laser_Battery.getID(), &WeaponTypes::ATA_Laser_Battery));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "ATA_Laser_Battery_Hero", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::ATA_Laser_Battery_Hero));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "ATA_Laser_Battery_Hyperion", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::ATA_Laser_Battery_Hyperion));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Flame_Thrower", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Flame_Thrower));
tableWeaponType.insert(std::pair<int, const WeaponType*>(WeaponTypes::Flame_Thrower.getID(), &WeaponTypes::Flame_Thrower));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Flame_Thrower_Gui_Montag", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Flame_Thrower_Gui_Montag));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Arclite_Shock_Cannon", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Arclite_Shock_Cannon));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Arclite_Shock_Cannon_Edmund_Duke", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Arclite_Shock_Cannon_Edmund_Duke));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Longbolt_Missile", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Longbolt_Missile));
tableWeaponType.insert(std::pair<int, const WeaponType*>(WeaponTypes::Longbolt_Missile.getID(), &WeaponTypes::Longbolt_Missile));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Claws", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Claws));
tableWeaponType.insert(std::pair<int, const WeaponType*>(WeaponTypes::Claws.getID(), &WeaponTypes::Claws));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Claws_Devouring_One", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Claws_Devouring_One));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Claws_Infested_Kerrigan", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Claws_Infested_Kerrigan));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Needle_Spines", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Needle_Spines));
tableWeaponType.insert(std::pair<int, const WeaponType*>(WeaponTypes::Needle_Spines.getID(), &WeaponTypes::Needle_Spines));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Needle_Spines_Hunter_Killer", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Needle_Spines_Hunter_Killer));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Kaiser_Blades", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Kaiser_Blades));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Toxic_Spores", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Toxic_Spores));
tableWeaponType.insert(std::pair<int, const WeaponType*>(WeaponTypes::Toxic_Spores.getID(), &WeaponTypes::Toxic_Spores));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Spines", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Spines));
tableWeaponType.insert(std::pair<int, const WeaponType*>(WeaponTypes::Spines.getID(), &WeaponTypes::Spines));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Acid_Spore", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Acid_Spore));
tableWeaponType.insert(std::pair<int, const WeaponType*>(WeaponTypes::Acid_Spore.getID(), &WeaponTypes::Acid_Spore));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Acid_Spore_Kukulza", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Acid_Spore_Kukulza));
tableWeaponType.insert(std::pair<int, const WeaponType*>(WeaponTypes::Acid_Spore_Kukulza.getID(), &WeaponTypes::Acid_Spore_Kukulza));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Glave_Wurm", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Glave_Wurm));
tableWeaponType.insert(std::pair<int, const WeaponType*>(WeaponTypes::Glave_Wurm.getID(), &WeaponTypes::Glave_Wurm));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Glave_Wurm_Kukulza", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Glave_Wurm_Kukulza));
tableWeaponType.insert(std::pair<int, const WeaponType*>(WeaponTypes::Glave_Wurm_Kukulza.getID(), &WeaponTypes::Glave_Wurm_Kukulza));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Seeker_Spores", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Seeker_Spores));
tableWeaponType.insert(std::pair<int, const WeaponType*>(WeaponTypes::Seeker_Spores.getID(), &WeaponTypes::Seeker_Spores));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Subterranean_Tentacle", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Subterranean_Tentacle));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Suicide_Infested_Terran", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Suicide_Infested_Terran));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Suicide_Scourge", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Suicide_Scourge));
tableWeaponType.insert(std::pair<int, const WeaponType*>(WeaponTypes::Suicide_Scourge.getID(), &WeaponTypes::Suicide_Scourge));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Particle_Beam", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Particle_Beam));
tableWeaponType.insert(std::pair<int, const WeaponType*>(WeaponTypes::Particle_Beam.getID(), &WeaponTypes::Particle_Beam));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Psi_Blades", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Psi_Blades));
tableWeaponType.insert(std::pair<int, const WeaponType*>(WeaponTypes::Psi_Blades.getID(), &WeaponTypes::Psi_Blades));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Psi_Blades_Fenix", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Psi_Blades_Fenix));
tableWeaponType.insert(std::pair<int, const WeaponType*>(WeaponTypes::Psi_Blades_Fenix.getID(), &WeaponTypes::Psi_Blades_Fenix));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Phase_Disruptor", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Phase_Disruptor));
tableWeaponType.insert(std::pair<int, const WeaponType*>(WeaponTypes::Phase_Disruptor.getID(), &WeaponTypes::Phase_Disruptor));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Phase_Disruptor_Fenix", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Phase_Disruptor_Fenix));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Psi_Assault", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Psi_Assault));
tableWeaponType.insert(std::pair<int, const WeaponType*>(WeaponTypes::Psi_Assault.getID(), &WeaponTypes::Psi_Assault));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Psionic_Shockwave", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Psionic_Shockwave));
tableWeaponType.insert(std::pair<int, const WeaponType*>(WeaponTypes::Psionic_Shockwave.getID(), &WeaponTypes::Psionic_Shockwave));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Psionic_Shockwave_TZ_Archon", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Psionic_Shockwave_TZ_Archon));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Dual_Photon_Blasters", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Dual_Photon_Blasters));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Dual_Photon_Blasters_Mojo", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Dual_Photon_Blasters_Mojo));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Dual_Photon_Blasters_Artanis", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Dual_Photon_Blasters_Artanis));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Anti_Matter_Missiles", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Anti_Matter_Missiles));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Anti_Matter_Missiles_Mojo", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Anti_Matter_Missiles_Mojo));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Anti_Matter_Missiles_Artanis", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Anti_Matter_Missiles_Artanis));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Phase_Disruptor_Cannon", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Phase_Disruptor_Cannon));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Phase_Disruptor_Cannon_Danimoth", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Phase_Disruptor_Cannon_Danimoth));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Pulse_Cannon", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Pulse_Cannon));
tableWeaponType.insert(std::pair<int, const WeaponType*>(WeaponTypes::Pulse_Cannon.getID(), &WeaponTypes::Pulse_Cannon));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "STS_Photon_Cannon", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::STS_Photon_Cannon));
tableWeaponType.insert(std::pair<int, const WeaponType*>(WeaponTypes::STS_Photon_Cannon.getID(), &WeaponTypes::STS_Photon_Cannon));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "STA_Photon_Cannon", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::STA_Photon_Cannon));
tableWeaponType.insert(std::pair<int, const WeaponType*>(WeaponTypes::STA_Photon_Cannon.getID(), &WeaponTypes::STA_Photon_Cannon));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Scarab", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Scarab));
tableWeaponType.insert(std::pair<int, const WeaponType*>(WeaponTypes::Scarab.getID(), &WeaponTypes::Scarab));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Neutron_Flare", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Neutron_Flare));
tableWeaponType.insert(std::pair<int, const WeaponType*>(WeaponTypes::Neutron_Flare.getID(), &WeaponTypes::Neutron_Flare));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Halo_Rockets", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Halo_Rockets));
tableWeaponType.insert(std::pair<int, const WeaponType*>(WeaponTypes::Halo_Rockets.getID(), &WeaponTypes::Halo_Rockets));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Corrosive_Acid", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Corrosive_Acid));
tableWeaponType.insert(std::pair<int, const WeaponType*>(WeaponTypes::Corrosive_Acid.getID(), &WeaponTypes::Corrosive_Acid));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Subterranean_Spines", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Subterranean_Spines));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Warp_Blades", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Warp_Blades));
tableWeaponType.insert(std::pair<int, const WeaponType*>(WeaponTypes::Warp_Blades.getID(), &WeaponTypes::Warp_Blades));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Warp_Blades_Hero", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Warp_Blades_Hero));
tableWeaponType.insert(std::pair<int, const WeaponType*>(WeaponTypes::Warp_Blades_Hero.getID(), &WeaponTypes::Warp_Blades_Hero));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Warp_Blades_Zeratul", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Warp_Blades_Zeratul));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Independant_Laser_Battery", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Independant_Laser_Battery));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Twin_Autocannons_Floor_Trap", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Twin_Autocannons_Floor_Trap));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Hellfire_Missile_Pack_Wall_Trap", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Hellfire_Missile_Pack_Wall_Trap));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Flame_Thrower_Wall_Trap", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Flame_Thrower_Wall_Trap));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Hellfire_Missile_Pack_Floor_Trap", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Hellfire_Missile_Pack_Floor_Trap));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Yamato_Gun", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Yamato_Gun));
tableWeaponType.insert(std::pair<int, const WeaponType*>(WeaponTypes::Yamato_Gun.getID(), &WeaponTypes::Yamato_Gun));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Nuclear_Strike", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Nuclear_Strike));
tableWeaponType.insert(std::pair<int, const WeaponType*>(WeaponTypes::Nuclear_Strike.getID(), &WeaponTypes::Nuclear_Strike));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Lockdown", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Lockdown));
tableWeaponType.insert(std::pair<int, const WeaponType*>(WeaponTypes::Lockdown.getID(), &WeaponTypes::Lockdown));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "EMP_Shockwave", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::EMP_Shockwave));
tableWeaponType.insert(std::pair<int, const WeaponType*>(WeaponTypes::EMP_Shockwave.getID(), &WeaponTypes::EMP_Shockwave));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Irradiate", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Irradiate));
tableWeaponType.insert(std::pair<int, const WeaponType*>(WeaponTypes::Irradiate.getID(), &WeaponTypes::Irradiate));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Parasite", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Parasite));
tableWeaponType.insert(std::pair<int, const WeaponType*>(WeaponTypes::Parasite.getID(), &WeaponTypes::Parasite));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Spawn_Broodlings", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Spawn_Broodlings));
tableWeaponType.insert(std::pair<int, const WeaponType*>(WeaponTypes::Spawn_Broodlings.getID(), &WeaponTypes::Spawn_Broodlings));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Ensnare", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Ensnare));
tableWeaponType.insert(std::pair<int, const WeaponType*>(WeaponTypes::Ensnare.getID(), &WeaponTypes::Ensnare));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Dark_Swarm", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Dark_Swarm));
tableWeaponType.insert(std::pair<int, const WeaponType*>(WeaponTypes::Dark_Swarm.getID(), &WeaponTypes::Dark_Swarm));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Plague", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Plague));
tableWeaponType.insert(std::pair<int, const WeaponType*>(WeaponTypes::Plague.getID(), &WeaponTypes::Plague));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Consume", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Consume));
tableWeaponType.insert(std::pair<int, const WeaponType*>(WeaponTypes::Consume.getID(), &WeaponTypes::Consume));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Stasis_Field", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Stasis_Field));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Disruption_Web", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Disruption_Web));
tableWeaponType.insert(std::pair<int, const WeaponType*>(WeaponTypes::Disruption_Web.getID(), &WeaponTypes::Disruption_Web));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Restoration", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Restoration));
tableWeaponType.insert(std::pair<int, const WeaponType*>(WeaponTypes::Restoration.getID(), &WeaponTypes::Restoration));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Mind_Control", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Mind_Control));
tableWeaponType.insert(std::pair<int, const WeaponType*>(WeaponTypes::Mind_Control.getID(), &WeaponTypes::Mind_Control));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Feedback", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Feedback));
tableWeaponType.insert(std::pair<int, const WeaponType*>(WeaponTypes::Feedback.getID(), &WeaponTypes::Feedback));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Optical_Flare", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Optical_Flare));
tableWeaponType.insert(std::pair<int, const WeaponType*>(WeaponTypes::Optical_Flare.getID(), &WeaponTypes::Optical_Flare));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Maelstrom", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Maelstrom));
tableWeaponType.insert(std::pair<int, const WeaponType*>(WeaponTypes::Maelstrom.getID(), &WeaponTypes::Maelstrom));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "None", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::None));
tableWeaponType.insert(std::pair<int, const WeaponType*>(WeaponTypes::None.getID(), &WeaponTypes::None));
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Unknown", "Lbwapi4/WeaponType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&WeaponTypes::Unknown));
...
println("Connecting to Broodwar...");
		...
		jclass gamecls = env->FindClass("Lbwapi4/Game;");
		jclass unitCls = env->FindClass("Lbwapi4/Unit;");
		jclass playerCls = env->FindClass("Lbwapi4/Player;");
		jclass posCls = env->FindClass("Lbwapi4/Position;");
		jobject moduleObj = env->GetObjectField(obj, env->GetFieldID(cls, "module", "Lbwapi4/AIModule;"));
		jclass moduleCls = env->GetObjectClass(moduleObj);
		env->SetObjectField(obj, env->GetFieldID(cls, "game", "Lbwapi4/Game;"), env->CallStaticObjectMethod(gamecls, env->GetStaticMethodID(gamecls, "get", "(J)Lbwapi4/Game;"), (long)BroodwarPtr));
		...
		jmethodID receiveTextCallback = env->GetMethodID(moduleCls, "onReceiveText", "(Lbwapi4/Player;Ljava/lang/String;)V");
		jmethodID playerLeftCallback = env->GetMethodID(moduleCls, "onPlayerLeft", "(Lbwapi4/Player;)V");
		jmethodID nukeDetectCallback = env->GetMethodID(moduleCls, "onNukeDetect", "(Lbwapi4/Position;)V");
		jmethodID unitDiscoverCallback = env->GetMethodID(moduleCls, "onUnitDiscover", "(Lbwapi4/Unit;)V");
		jmethodID unitEvadeCallback = env->GetMethodID(moduleCls, "onUnitEvade", "(Lbwapi4/Unit;)V");
		jmethodID unitShowCallback = env->GetMethodID(moduleCls, "onUnitShow", "(Lbwapi4/Unit;)V");
		jmethodID unitHideCallback = env->GetMethodID(moduleCls, "onUnitHide", "(Lbwapi4/Unit;)V");
		jmethodID unitCreateCallback = env->GetMethodID(moduleCls, "onUnitCreate", "(Lbwapi4/Unit;)V");
		jmethodID unitDestroyCallback = env->GetMethodID(moduleCls, "onUnitDestroy", "(Lbwapi4/Unit;)V");
		jmethodID unitMorphCallback = env->GetMethodID(moduleCls, "onUnitMorph", "(Lbwapi4/Unit;)V");
		jmethodID unitRenegadeCallback = env->GetMethodID(moduleCls, "onUnitRenegade", "(Lbwapi4/Unit;)V");
		jmethodID saveGameCallback = env->GetMethodID(moduleCls, "onSaveGame", "(Ljava/lang/String;)V");
		jmethodID unitCompleteCallback = env->GetMethodID(moduleCls, "onUnitComplete", "(Lbwapi4/Unit;)V");
		jmethodID playerDroppedCallback = env->GetMethodID(moduleCls, "onPlayerDropped", "(Lbwapi4/Player;)V");
		while (true) {
				...
				for(std::list<Event>::const_iterator it = Broodwar->getEvents().begin(); it!=Broodwar->getEvents().end(); it++)
				  {
					  switch (it->getType()) {
						  ...
						  case EventType::ReceiveText:
							  env->CallVoidMethod(moduleObj, receiveTextCallback, env->CallStaticObjectMethod(playerCls, env->GetStaticMethodID(playerCls, "get", "(J)Lbwapi4/Player;"), (jlong)it->getPlayer()), env->NewStringUTF(it->getText().c_str()));
						  break;
						  case EventType::PlayerLeft:
							  env->CallVoidMethod(moduleObj, playerLeftCallback, env->CallStaticObjectMethod(playerCls, env->GetStaticMethodID(playerCls, "get", "(J)Lbwapi4/Player;"), (jlong)it->getPlayer()));
						  break;
						  ...
						  case EventType::UnitDiscover:
							  env->CallVoidMethod(moduleObj, unitDiscoverCallback, env->CallStaticObjectMethod(unitCls, env->GetStaticMethodID(unitCls, "get", "(J)Lbwapi4/Unit;"), (jlong)it->getUnit()));
						  break;
						  case EventType::UnitEvade:
							  env->CallVoidMethod(moduleObj, unitEvadeCallback, env->CallStaticObjectMethod(unitCls, env->GetStaticMethodID(unitCls, "get", "(J)Lbwapi4/Unit;"), (jlong)it->getUnit()));
						  break;
						   case EventType::UnitShow:
							  env->CallVoidMethod(moduleObj, unitShowCallback, env->CallStaticObjectMethod(unitCls, env->GetStaticMethodID(unitCls, "get", "(J)Lbwapi4/Unit;"), (jlong)it->getUnit()));
						  break;
						  case EventType::UnitHide:
							  env->CallVoidMethod(moduleObj, unitHideCallback, env->CallStaticObjectMethod(unitCls, env->GetStaticMethodID(unitCls, "get", "(J)Lbwapi4/Unit;"), (jlong)it->getUnit()));
						  break;
						  case EventType::UnitCreate:
							  env->CallVoidMethod(moduleObj, unitCreateCallback, env->CallStaticObjectMethod(unitCls, env->GetStaticMethodID(unitCls, "get", "(J)Lbwapi4/Unit;"), (jlong)it->getUnit()));
						  break;
						  case EventType::UnitDestroy:
							  env->CallVoidMethod(moduleObj, unitDestroyCallback, env->CallStaticObjectMethod(unitCls, env->GetStaticMethodID(unitCls, "get", "(J)Lbwapi4/Unit;"), (jlong)it->getUnit()));
						  break;
						  case EventType::UnitMorph:
							  env->CallVoidMethod(moduleObj, unitMorphCallback, env->CallStaticObjectMethod(unitCls, env->GetStaticMethodID(unitCls, "get", "(J)Lbwapi4/Unit;"), (jlong)it->getUnit()));
						  break;
						  case EventType::UnitRenegade:
							  env->CallVoidMethod(moduleObj, unitRenegadeCallback, env->CallStaticObjectMethod(unitCls, env->GetStaticMethodID(unitCls, "get", "(J)Lbwapi4/Unit;"), (jlong)it->getUnit()));
						  break;
						  case EventType::SaveGame:
							  env->CallVoidMethod(moduleObj, saveGameCallback, env->NewStringUTF(it->getText().c_str()));
						  break;
						  case EventType::UnitComplete:
							  env->CallVoidMethod(moduleObj, unitCompleteCallback, env->CallStaticObjectMethod(unitCls, env->GetStaticMethodID(unitCls, "get", "(J)Lbwapi4/Unit;"), (jlong)it->getUnit()));
						  break;
