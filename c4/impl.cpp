...
PositionOrUnit convertPositionOrUnit(JNIEnv * env, jobject obj){ 
	...
	if(isUnit){
		jobject unitObj = env->CallObjectMethod(obj, FindCachedMethod(env, clz, "getUnit", "()Lbwapi/Unit;"));
	...
	jobject posObj = env->CallObjectMethod(obj, FindCachedMethod(env, clz, "getPosition", "()Lbwapi/Position;"));
...
UnitCommand convertUnitCommand(JNIEnv * env, jobject obj){	jclass clz = FindCachedClass(env, "bwapi/UnitCommand");
	jobject unitObj = env->CallObjectMethod(obj, FindCachedMethod(env, clz, "getUnit", "()Lbwapi/Unit;"));
	Unit unit = (Unit)env->GetLongField(unitObj, FindCachedField(env, env->GetObjectClass(unitObj), "pointer", "J"));
	jobject targetObj = env->CallObjectMethod(obj, FindCachedMethod(env, clz, "getTarget", "()Lbwapi/Unit;"));
	Unit target = (Unit)env->GetLongField(targetObj, FindCachedField(env, env->GetObjectClass(targetObj), "pointer", "J"));
	jobject typeObj = env->CallObjectMethod(obj, FindCachedMethod(env, clz, "getUnitCommandType", "()Lbwapi/UnitCommandType;"));
...
JNIEXPORT jstring JNICALL Java_bwapi_BulletType_toString_1native(JNIEnv * env, jobject obj, jlong pointer){
...
JNIEXPORT jstring JNICALL Java_bwapi_DamageType_toString_1native(JNIEnv * env, jobject obj, jlong pointer){
DamageType* x_damageType = (DamageType*)pointer;
return env->NewStringUTF(x_damageType->toString().c_str());
}
JNIEXPORT jstring JNICALL Java_bwapi_Error_toString_1native(JNIEnv * env, jobject obj, jlong pointer){
Error* x_error = (Error*)pointer;
return env->NewStringUTF(x_error->toString().c_str());
}
JNIEXPORT jobject JNICALL Java_bwapi_Event_getType_1native(JNIEnv * env, jobject obj, jlong pointer){
Event* x_evt = (Event*)pointer;
jlong resptr = (jlong)x_evt->getType();
jclass retcls = FindCachedClass(env, "bwapi/Enum");
jmethodID mid = FindCachedMethodStatic(env, retcls, "get", "(J)Lbwapi/Enum;");
return env->CallStaticObjectMethod(retcls, mid, resptr);
}
...
JNIEXPORT jstring JNICALL Java_bwapi_ExplosionType_toString_1native(JNIEnv * env, jobject obj, jlong pointer){
...
JNIEXPORT jobject JNICALL Java_bwapi_Forceset_getPlayers_1native(JNIEnv * env, jobject obj, jlong pointer){
...
Game* x_game = (Game*)pointer;
std::deque<Position> cresult = x_game->getNukeDots();
jclass listCls = FindCachedClass(env, "java/util/ArrayList");
jmethodID listConsID = FindCachedMethod(env, listCls, "<init>", "()V");
jobject result = env->NewObject(listCls, listConsID);
jmethodID addMethodID = FindCachedMethod(env, listCls, "add", "(Ljava/lang/Object;)Z");
...
for(std::deque<Position>::const_iterator it = cresult.begin(); it != cresult.end(); it++ ){
...
JNIEXPORT jboolean JNICALL Java_bwapi_Game_getMouseState_1native(JNIEnv * env, jobject obj, jlong pointer, jobject p_button){
Game* x_game = (Game*)pointer;
...
JNIEXPORT jboolean JNICALL Java_bwapi_Game_getKeyState_1native(JNIEnv * env, jobject obj, jlong pointer, jobject p_key){
Game* x_game = (Game*)pointer;
...
JNIEXPORT jobject JNICALL Java_bwapi_Game_getUnitsOnTile_1native__JII(JNIEnv * env, jobject obj, jlong pointer, jint tileX, jint tileY){
Game* x_game = (Game*)pointer;
Unitset cresult = x_game->getUnitsOnTile(tileX, tileY);
jclass listCls = FindCachedClass(env, "java/util/ArrayList");
jmethodID listConsID = FindCachedMethod(env, listCls, "<init>", "()V");
jobject result = env->NewObject(listCls, listConsID);
jmethodID addMethodID = FindCachedMethod(env, listCls, "add", "(Ljava/lang/Object;)Z");
...
JNIEXPORT jobject JNICALL Java_bwapi_Game_getUnitsOnTile_1native__JLbwapi_TilePosition_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_tile){
Game* x_game = (Game*)pointer;
...
Unitset cresult = x_game->getUnitsOnTile(tile);
jclass listCls = FindCachedClass(env, "java/util/ArrayList");
jmethodID listConsID = FindCachedMethod(env, listCls, "<init>", "()V");
jobject result = env->NewObject(listCls, listConsID);
jmethodID addMethodID = FindCachedMethod(env, listCls, "add", "(Ljava/lang/Object;)Z");
...
Game* x_game = (Game*)pointer;
Unitset cresult = x_game->getUnitsInRectangle(left, top, right, bottom);
jclass listCls = FindCachedClass(env, "java/util/ArrayList");
jmethodID listConsID = FindCachedMethod(env, listCls, "<init>", "()V");
jobject result = env->NewObject(listCls, listConsID);
jmethodID addMethodID = FindCachedMethod(env, listCls, "add", "(Ljava/lang/Object;)Z");
...
Unitset cresult = x_game->getUnitsInRectangle(topLeft, bottomRight);
jclass listCls = FindCachedClass(env, "java/util/ArrayList");
jmethodID listConsID = FindCachedMethod(env, listCls, "<init>", "()V");
jobject result = env->NewObject(listCls, listConsID);
jmethodID addMethodID = FindCachedMethod(env, listCls, "add", "(Ljava/lang/Object;)Z");
...
JNIEXPORT jobject JNICALL Java_bwapi_Game_getUnitsInRadius_1native__JIII(JNIEnv * env, jobject obj, jlong pointer, jint x, jint y, jint radius){
Game* x_game = (Game*)pointer;
Unitset cresult = x_game->getUnitsInRadius(x, y, radius);
jclass listCls = FindCachedClass(env, "java/util/ArrayList");
jmethodID listConsID = FindCachedMethod(env, listCls, "<init>", "()V");
jobject result = env->NewObject(listCls, listConsID);
jmethodID addMethodID = FindCachedMethod(env, listCls, "add", "(Ljava/lang/Object;)Z");
...
JNIEXPORT jobject JNICALL Java_bwapi_Game_getUnitsInRadius_1native__JLbwapi_Position_2I(JNIEnv * env, jobject obj, jlong pointer, jobject p_center, jint radius){
Game* x_game = (Game*)pointer;
...
Unitset cresult = x_game->getUnitsInRadius(center, radius);
jclass listCls = FindCachedClass(env, "java/util/ArrayList");
jmethodID listConsID = FindCachedMethod(env, listCls, "<init>", "()V");
jobject result = env->NewObject(listCls, listConsID);
jmethodID addMethodID = FindCachedMethod(env, listCls, "add", "(Ljava/lang/Object;)Z");
...
JNIEXPORT jboolean JNICALL Java_bwapi_Game_setLastError_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Game* x_game = (Game*)pointer;
return x_game->setLastError();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Game_setLastError_1native__JLbwapi_Error_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_e){
Game* x_game = (Game*)pointer;
...
JNIEXPORT jboolean JNICALL Java_bwapi_Game_isWalkable_1native__JII(JNIEnv * env, jobject obj, jlong pointer, jint walkX, jint walkY){
Game* x_game = (Game*)pointer;
return x_game->isWalkable(walkX, walkY);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Game_isWalkable_1native__JLbwapi_WalkPosition_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_position){
Game* x_game = (Game*)pointer;
...
JNIEXPORT jint JNICALL Java_bwapi_Game_getGroundHeight_1native__JII(JNIEnv * env, jobject obj, jlong pointer, jint tileX, jint tileY){
Game* x_game = (Game*)pointer;
return x_game->getGroundHeight(tileX, tileY);
}
JNIEXPORT jint JNICALL Java_bwapi_Game_getGroundHeight_1native__JLbwapi_TilePosition_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_position){
Game* x_game = (Game*)pointer;
...
JNIEXPORT jboolean JNICALL Java_bwapi_Game_canBuildHere_1native__JLbwapi_TilePosition_2Lbwapi_UnitType_2Lbwapi_Unit_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_position, jobject p_type, jobject p_builder){
Game* x_game = (Game*)pointer;
TilePosition position((int)env->GetIntField(p_position, FindCachedField(env, env->GetObjectClass(p_position), "x", "I")), (int)env->GetIntField(p_position, FindCachedField(env, env->GetObjectClass(p_position), "y", "I")));
...
JNIEXPORT jboolean JNICALL Java_bwapi_Game_canBuildHere_1native__JLbwapi_TilePosition_2Lbwapi_UnitType_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_position, jobject p_type){
Game* x_game = (Game*)pointer;
TilePosition position((int)env->GetIntField(p_position, FindCachedField(env, env->GetObjectClass(p_position), "x", "I")), (int)env->GetIntField(p_position, FindCachedField(env, env->GetObjectClass(p_position), "y", "I")));
UnitType* type = (UnitType*)env->GetLongField(p_type, FindCachedField(env, env->GetObjectClass(p_type), "pointer", "J"));
return x_game->canBuildHere(position, *type);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Game_canBuildHere_1native__JLbwapi_TilePosition_2Lbwapi_UnitType_2Lbwapi_Unit_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_position, jobject p_type, jobject p_builder, jboolean checkExplored){
Game* x_game = (Game*)pointer;
TilePosition position((int)env->GetIntField(p_position, FindCachedField(env, env->GetObjectClass(p_position), "x", "I")), (int)env->GetIntField(p_position, FindCachedField(env, env->GetObjectClass(p_position), "y", "I")));
UnitType* type = (UnitType*)env->GetLongField(p_type, FindCachedField(env, env->GetObjectClass(p_type), "pointer", "J"));
Unit builder = (Unit)env->GetLongField(p_builder, FindCachedField(env, env->GetObjectClass(p_builder), "pointer", "J"));
...
JNIEXPORT jboolean JNICALL Java_bwapi_Game_canMake_1native__JLbwapi_UnitType_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_type){
Game* x_game = (Game*)pointer;
UnitType* type = (UnitType*)env->GetLongField(p_type, FindCachedField(env, env->GetObjectClass(p_type), "pointer", "J"));
return x_game->canMake(*type);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Game_canMake_1native__JLbwapi_UnitType_2Lbwapi_Unit_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_type, jobject p_builder){
Game* x_game = (Game*)pointer;
UnitType* type = (UnitType*)env->GetLongField(p_type, FindCachedField(env, env->GetObjectClass(p_type), "pointer", "J"));
Unit builder = (Unit)env->GetLongField(p_builder, FindCachedField(env, env->GetObjectClass(p_builder), "pointer", "J"));
return x_game->canMake(*type, builder);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Game_canResearch_1native__JLbwapi_TechType_2Lbwapi_Unit_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_type, jobject p_unit){
Game* x_game = (Game*)pointer;
...
JNIEXPORT jboolean JNICALL Java_bwapi_Game_canResearch_1native__JLbwapi_TechType_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_type){
Game* x_game = (Game*)pointer;
TechType* type = (TechType*)env->GetLongField(p_type, FindCachedField(env, env->GetObjectClass(p_type), "pointer", "J"));
return x_game->canResearch(*type);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Game_canResearch_1native__JLbwapi_TechType_2Lbwapi_Unit_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_type, jobject p_unit, jboolean checkCanIssueCommandType){
Game* x_game = (Game*)pointer;
TechType* type = (TechType*)env->GetLongField(p_type, FindCachedField(env, env->GetObjectClass(p_type), "pointer", "J"));
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
return x_game->canResearch(*type, unit, (bool)checkCanIssueCommandType);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Game_canUpgrade_1native__JLbwapi_UpgradeType_2Lbwapi_Unit_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_type, jobject p_unit){
Game* x_game = (Game*)pointer;
...
JNIEXPORT jboolean JNICALL Java_bwapi_Game_canUpgrade_1native__JLbwapi_UpgradeType_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_type){
Game* x_game = (Game*)pointer;
UpgradeType* type = (UpgradeType*)env->GetLongField(p_type, FindCachedField(env, env->GetObjectClass(p_type), "pointer", "J"));
return x_game->canUpgrade(*type);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Game_canUpgrade_1native__JLbwapi_UpgradeType_2Lbwapi_Unit_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_type, jobject p_unit, jboolean checkCanIssueCommandType){
Game* x_game = (Game*)pointer;
UpgradeType* type = (UpgradeType*)env->GetLongField(p_type, FindCachedField(env, env->GetObjectClass(p_type), "pointer", "J"));
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
...
Game* x_game = (Game*)pointer;
std::deque<TilePosition> cresult = x_game->getStartLocations();
jclass listCls = FindCachedClass(env, "java/util/ArrayList");
jmethodID listConsID = FindCachedMethod(env, listCls, "<init>", "()V");
jobject result = env->NewObject(listCls, listConsID);
jmethodID addMethodID = FindCachedMethod(env, listCls, "add", "(Ljava/lang/Object;)Z");
...
jmethodID elemConsID = FindCachedMethod(env, elemClass, "<init>", "(II)V");
for(std::deque<TilePosition>::const_iterator it = cresult.begin(); it != cresult.end(); it++ ){
...
JNIEXPORT void JNICALL Java_bwapi_Game_setLocalSpeed_1native(JNIEnv * env, jobject obj, jlong pointer, jint speed){
Game* x_game = (Game*)pointer;
...
JNIEXPORT void JNICALL Java_bwapi_Game_setTextSize_1native__JLbwapi_Text_Size_Enum_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_size){
Game* x_game = (Game*)pointer;
...
JNIEXPORT void JNICALL Java_bwapi_Game_drawText_1native(JNIEnv * env, jobject obj, jlong pointer, jobject p_ctype, jint x, jint y, jstring cstr_format){
Game* x_game = (Game*)pointer;
...
JNIEXPORT void JNICALL Java_bwapi_Game_drawTextMap_1native__JIILjava_lang_String_2(JNIEnv * env, jobject obj, jlong pointer, jint x, jint y, jstring cstr_format){
Game* x_game = (Game*)pointer;
x_game->drawTextMap(x, y, std::string(env->GetStringUTFChars(cstr_format, NULL)).c_str());
}
JNIEXPORT void JNICALL Java_bwapi_Game_drawTextMap_1native__JLbwapi_Position_2Ljava_lang_String_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_p, jstring cstr_format){
Game* x_game = (Game*)pointer;
Position p((int)env->GetIntField(p_p, FindCachedField(env, env->GetObjectClass(p_p), "x", "I")), (int)env->GetIntField(p_p, FindCachedField(env, env->GetObjectClass(p_p), "y", "I")));
x_game->drawTextMap(p, std::string(env->GetStringUTFChars(cstr_format, NULL)).c_str());
}
JNIEXPORT void JNICALL Java_bwapi_Game_drawTextMouse_1native__JIILjava_lang_String_2(JNIEnv * env, jobject obj, jlong pointer, jint x, jint y, jstring cstr_format){
Game* x_game = (Game*)pointer;
x_game->drawTextMouse(x, y, std::string(env->GetStringUTFChars(cstr_format, NULL)).c_str());
}
JNIEXPORT void JNICALL Java_bwapi_Game_drawTextMouse_1native__JLbwapi_Position_2Ljava_lang_String_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_p, jstring cstr_format){
Game* x_game = (Game*)pointer;
Position p((int)env->GetIntField(p_p, FindCachedField(env, env->GetObjectClass(p_p), "x", "I")), (int)env->GetIntField(p_p, FindCachedField(env, env->GetObjectClass(p_p), "y", "I")));
x_game->drawTextMouse(p, std::string(env->GetStringUTFChars(cstr_format, NULL)).c_str());
}
JNIEXPORT void JNICALL Java_bwapi_Game_drawTextScreen_1native__JIILjava_lang_String_2(JNIEnv * env, jobject obj, jlong pointer, jint x, jint y, jstring cstr_format){
Game* x_game = (Game*)pointer;
x_game->drawTextScreen(x, y, std::string(env->GetStringUTFChars(cstr_format, NULL)).c_str());
}
JNIEXPORT void JNICALL Java_bwapi_Game_drawTextScreen_1native__JLbwapi_Position_2Ljava_lang_String_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_p, jstring cstr_format){
Game* x_game = (Game*)pointer;
Position p((int)env->GetIntField(p_p, FindCachedField(env, env->GetObjectClass(p_p), "x", "I")), (int)env->GetIntField(p_p, FindCachedField(env, env->GetObjectClass(p_p), "y", "I")));
x_game->drawTextScreen(p, std::string(env->GetStringUTFChars(cstr_format, NULL)).c_str());
}
JNIEXPORT void JNICALL Java_bwapi_Game_drawBox_1native__JLbwapi_CoordinateType_Enum_2IIIILbwapi_Color_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_ctype, jint left, jint top, jint right, jint bottom, jobject p_color){
Game* x_game = (Game*)pointer;
CoordinateType::Enum ctype = (CoordinateType::Enum)(int)env->GetIntField(p_ctype, FindCachedField(env, env->GetObjectClass(p_ctype), "value", "I"));
...
JNIEXPORT void JNICALL Java_bwapi_Game_drawBox_1native__JLbwapi_CoordinateType_Enum_2IIIILbwapi_Color_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_ctype, jint left, jint top, jint right, jint bottom, jobject p_color, jboolean isSolid){
Game* x_game = (Game*)pointer;
CoordinateType::Enum ctype = (CoordinateType::Enum)(int)env->GetIntField(p_ctype, FindCachedField(env, env->GetObjectClass(p_ctype), "value", "I"));
Color color((int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "r", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "g", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "b", "I")));
...
JNIEXPORT void JNICALL Java_bwapi_Game_drawBoxMap_1native__JLbwapi_Position_2Lbwapi_Position_2Lbwapi_Color_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_leftTop, jobject p_rightBottom, jobject p_color){
Game* x_game = (Game*)pointer;
...
JNIEXPORT void JNICALL Java_bwapi_Game_drawBoxMap_1native__JLbwapi_Position_2Lbwapi_Position_2Lbwapi_Color_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_leftTop, jobject p_rightBottom, jobject p_color, jboolean isSolid){
Game* x_game = (Game*)pointer;
Position leftTop((int)env->GetIntField(p_leftTop, FindCachedField(env, env->GetObjectClass(p_leftTop), "x", "I")), (int)env->GetIntField(p_leftTop, FindCachedField(env, env->GetObjectClass(p_leftTop), "y", "I")));
Position rightBottom((int)env->GetIntField(p_rightBottom, FindCachedField(env, env->GetObjectClass(p_rightBottom), "x", "I")), (int)env->GetIntField(p_rightBottom, FindCachedField(env, env->GetObjectClass(p_rightBottom), "y", "I")));
Color color((int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "r", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "g", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "b", "I")));
...
JNIEXPORT void JNICALL Java_bwapi_Game_drawBoxMouse_1native__JLbwapi_Position_2Lbwapi_Position_2Lbwapi_Color_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_leftTop, jobject p_rightBottom, jobject p_color){
Game* x_game = (Game*)pointer;
Position leftTop((int)env->GetIntField(p_leftTop, FindCachedField(env, env->GetObjectClass(p_leftTop), "x", "I")), (int)env->GetIntField(p_leftTop, FindCachedField(env, env->GetObjectClass(p_leftTop), "y", "I")));
Position rightBottom((int)env->GetIntField(p_rightBottom, FindCachedField(env, env->GetObjectClass(p_rightBottom), "x", "I")), (int)env->GetIntField(p_rightBottom, FindCachedField(env, env->GetObjectClass(p_rightBottom), "y", "I")));
Color color((int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "r", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "g", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "b", "I")));
...
JNIEXPORT void JNICALL Java_bwapi_Game_drawBoxMouse_1native__JLbwapi_Position_2Lbwapi_Position_2Lbwapi_Color_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_leftTop, jobject p_rightBottom, jobject p_color, jboolean isSolid){
Game* x_game = (Game*)pointer;
Position leftTop((int)env->GetIntField(p_leftTop, FindCachedField(env, env->GetObjectClass(p_leftTop), "x", "I")), (int)env->GetIntField(p_leftTop, FindCachedField(env, env->GetObjectClass(p_leftTop), "y", "I")));
Position rightBottom((int)env->GetIntField(p_rightBottom, FindCachedField(env, env->GetObjectClass(p_rightBottom), "x", "I")), (int)env->GetIntField(p_rightBottom, FindCachedField(env, env->GetObjectClass(p_rightBottom), "y", "I")));
Color color((int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "r", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "g", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "b", "I")));
...
JNIEXPORT void JNICALL Java_bwapi_Game_drawBoxScreen_1native__JLbwapi_Position_2Lbwapi_Position_2Lbwapi_Color_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_leftTop, jobject p_rightBottom, jobject p_color){
Game* x_game = (Game*)pointer;
Position leftTop((int)env->GetIntField(p_leftTop, FindCachedField(env, env->GetObjectClass(p_leftTop), "x", "I")), (int)env->GetIntField(p_leftTop, FindCachedField(env, env->GetObjectClass(p_leftTop), "y", "I")));
Position rightBottom((int)env->GetIntField(p_rightBottom, FindCachedField(env, env->GetObjectClass(p_rightBottom), "x", "I")), (int)env->GetIntField(p_rightBottom, FindCachedField(env, env->GetObjectClass(p_rightBottom), "y", "I")));
Color color((int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "r", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "g", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "b", "I")));
...
JNIEXPORT void JNICALL Java_bwapi_Game_drawBoxScreen_1native__JLbwapi_Position_2Lbwapi_Position_2Lbwapi_Color_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_leftTop, jobject p_rightBottom, jobject p_color, jboolean isSolid){
Game* x_game = (Game*)pointer;
Position leftTop((int)env->GetIntField(p_leftTop, FindCachedField(env, env->GetObjectClass(p_leftTop), "x", "I")), (int)env->GetIntField(p_leftTop, FindCachedField(env, env->GetObjectClass(p_leftTop), "y", "I")));
Position rightBottom((int)env->GetIntField(p_rightBottom, FindCachedField(env, env->GetObjectClass(p_rightBottom), "x", "I")), (int)env->GetIntField(p_rightBottom, FindCachedField(env, env->GetObjectClass(p_rightBottom), "y", "I")));
Color color((int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "r", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "g", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "b", "I")));
...
JNIEXPORT void JNICALL Java_bwapi_Game_drawTriangle_1native__JLbwapi_CoordinateType_Enum_2IIIIIILbwapi_Color_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_ctype, jint ax, jint ay, jint bx, jint by, jint cx, jint cy, jobject p_color){
Game* x_game = (Game*)pointer;
CoordinateType::Enum ctype = (CoordinateType::Enum)(int)env->GetIntField(p_ctype, FindCachedField(env, env->GetObjectClass(p_ctype), "value", "I"));
Color color((int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "r", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "g", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "b", "I")));
x_game->drawTriangle(ctype, ax, ay, bx, by, cx, cy, color);
}
JNIEXPORT void JNICALL Java_bwapi_Game_drawTriangle_1native__JLbwapi_CoordinateType_Enum_2IIIIIILbwapi_Color_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_ctype, jint ax, jint ay, jint bx, jint by, jint cx, jint cy, jobject p_color, jboolean isSolid){
Game* x_game = (Game*)pointer;
CoordinateType::Enum ctype = (CoordinateType::Enum)(int)env->GetIntField(p_ctype, FindCachedField(env, env->GetObjectClass(p_ctype), "value", "I"));
Color color((int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "r", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "g", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "b", "I")));
...
JNIEXPORT void JNICALL Java_bwapi_Game_drawTriangleMap_1native__JLbwapi_Position_2Lbwapi_Position_2Lbwapi_Position_2Lbwapi_Color_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_a, jobject p_b, jobject p_c, jobject p_color){
Game* x_game = (Game*)pointer;
...
JNIEXPORT void JNICALL Java_bwapi_Game_drawTriangleMap_1native__JLbwapi_Position_2Lbwapi_Position_2Lbwapi_Position_2Lbwapi_Color_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_a, jobject p_b, jobject p_c, jobject p_color, jboolean isSolid){
Game* x_game = (Game*)pointer;
Position a((int)env->GetIntField(p_a, FindCachedField(env, env->GetObjectClass(p_a), "x", "I")), (int)env->GetIntField(p_a, FindCachedField(env, env->GetObjectClass(p_a), "y", "I")));
Position b((int)env->GetIntField(p_b, FindCachedField(env, env->GetObjectClass(p_b), "x", "I")), (int)env->GetIntField(p_b, FindCachedField(env, env->GetObjectClass(p_b), "y", "I")));
Position c((int)env->GetIntField(p_c, FindCachedField(env, env->GetObjectClass(p_c), "x", "I")), (int)env->GetIntField(p_c, FindCachedField(env, env->GetObjectClass(p_c), "y", "I")));
...
JNIEXPORT void JNICALL Java_bwapi_Game_drawTriangleMouse_1native__JLbwapi_Position_2Lbwapi_Position_2Lbwapi_Position_2Lbwapi_Color_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_a, jobject p_b, jobject p_c, jobject p_color){
Game* x_game = (Game*)pointer;
Position a((int)env->GetIntField(p_a, FindCachedField(env, env->GetObjectClass(p_a), "x", "I")), (int)env->GetIntField(p_a, FindCachedField(env, env->GetObjectClass(p_a), "y", "I")));
Position b((int)env->GetIntField(p_b, FindCachedField(env, env->GetObjectClass(p_b), "x", "I")), (int)env->GetIntField(p_b, FindCachedField(env, env->GetObjectClass(p_b), "y", "I")));
Position c((int)env->GetIntField(p_c, FindCachedField(env, env->GetObjectClass(p_c), "x", "I")), (int)env->GetIntField(p_c, FindCachedField(env, env->GetObjectClass(p_c), "y", "I")));
...
JNIEXPORT void JNICALL Java_bwapi_Game_drawTriangleMouse_1native__JLbwapi_Position_2Lbwapi_Position_2Lbwapi_Position_2Lbwapi_Color_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_a, jobject p_b, jobject p_c, jobject p_color, jboolean isSolid){
Game* x_game = (Game*)pointer;
Position a((int)env->GetIntField(p_a, FindCachedField(env, env->GetObjectClass(p_a), "x", "I")), (int)env->GetIntField(p_a, FindCachedField(env, env->GetObjectClass(p_a), "y", "I")));
Position b((int)env->GetIntField(p_b, FindCachedField(env, env->GetObjectClass(p_b), "x", "I")), (int)env->GetIntField(p_b, FindCachedField(env, env->GetObjectClass(p_b), "y", "I")));
Position c((int)env->GetIntField(p_c, FindCachedField(env, env->GetObjectClass(p_c), "x", "I")), (int)env->GetIntField(p_c, FindCachedField(env, env->GetObjectClass(p_c), "y", "I")));
...
JNIEXPORT void JNICALL Java_bwapi_Game_drawTriangleScreen_1native__JLbwapi_Position_2Lbwapi_Position_2Lbwapi_Position_2Lbwapi_Color_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_a, jobject p_b, jobject p_c, jobject p_color){
Game* x_game = (Game*)pointer;
Position a((int)env->GetIntField(p_a, FindCachedField(env, env->GetObjectClass(p_a), "x", "I")), (int)env->GetIntField(p_a, FindCachedField(env, env->GetObjectClass(p_a), "y", "I")));
Position b((int)env->GetIntField(p_b, FindCachedField(env, env->GetObjectClass(p_b), "x", "I")), (int)env->GetIntField(p_b, FindCachedField(env, env->GetObjectClass(p_b), "y", "I")));
Position c((int)env->GetIntField(p_c, FindCachedField(env, env->GetObjectClass(p_c), "x", "I")), (int)env->GetIntField(p_c, FindCachedField(env, env->GetObjectClass(p_c), "y", "I")));
...
JNIEXPORT void JNICALL Java_bwapi_Game_drawTriangleScreen_1native__JLbwapi_Position_2Lbwapi_Position_2Lbwapi_Position_2Lbwapi_Color_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_a, jobject p_b, jobject p_c, jobject p_color, jboolean isSolid){
Game* x_game = (Game*)pointer;
Position a((int)env->GetIntField(p_a, FindCachedField(env, env->GetObjectClass(p_a), "x", "I")), (int)env->GetIntField(p_a, FindCachedField(env, env->GetObjectClass(p_a), "y", "I")));
Position b((int)env->GetIntField(p_b, FindCachedField(env, env->GetObjectClass(p_b), "x", "I")), (int)env->GetIntField(p_b, FindCachedField(env, env->GetObjectClass(p_b), "y", "I")));
Position c((int)env->GetIntField(p_c, FindCachedField(env, env->GetObjectClass(p_c), "x", "I")), (int)env->GetIntField(p_c, FindCachedField(env, env->GetObjectClass(p_c), "y", "I")));
...
JNIEXPORT void JNICALL Java_bwapi_Game_drawCircle_1native__JLbwapi_CoordinateType_Enum_2IIILbwapi_Color_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_ctype, jint x, jint y, jint radius, jobject p_color){
Game* x_game = (Game*)pointer;
CoordinateType::Enum ctype = (CoordinateType::Enum)(int)env->GetIntField(p_ctype, FindCachedField(env, env->GetObjectClass(p_ctype), "value", "I"));
Color color((int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "r", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "g", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "b", "I")));
x_game->drawCircle(ctype, x, y, radius, color);
}
JNIEXPORT void JNICALL Java_bwapi_Game_drawCircle_1native__JLbwapi_CoordinateType_Enum_2IIILbwapi_Color_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_ctype, jint x, jint y, jint radius, jobject p_color, jboolean isSolid){
Game* x_game = (Game*)pointer;
CoordinateType::Enum ctype = (CoordinateType::Enum)(int)env->GetIntField(p_ctype, FindCachedField(env, env->GetObjectClass(p_ctype), "value", "I"));
Color color((int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "r", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "g", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "b", "I")));
...
JNIEXPORT void JNICALL Java_bwapi_Game_drawCircleMap_1native__JLbwapi_Position_2ILbwapi_Color_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_p, jint radius, jobject p_color){
Game* x_game = (Game*)pointer;
Position p((int)env->GetIntField(p_p, FindCachedField(env, env->GetObjectClass(p_p), "x", "I")), (int)env->GetIntField(p_p, FindCachedField(env, env->GetObjectClass(p_p), "y", "I")));
Color color((int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "r", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "g", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "b", "I")));
x_game->drawCircleMap(p, radius, color);
}
JNIEXPORT void JNICALL Java_bwapi_Game_drawCircleMap_1native__JLbwapi_Position_2ILbwapi_Color_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_p, jint radius, jobject p_color, jboolean isSolid){
Game* x_game = (Game*)pointer;
Position p((int)env->GetIntField(p_p, FindCachedField(env, env->GetObjectClass(p_p), "x", "I")), (int)env->GetIntField(p_p, FindCachedField(env, env->GetObjectClass(p_p), "y", "I")));
Color color((int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "r", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "g", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "b", "I")));
...
JNIEXPORT void JNICALL Java_bwapi_Game_drawCircleMouse_1native__JLbwapi_Position_2ILbwapi_Color_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_p, jint radius, jobject p_color){
Game* x_game = (Game*)pointer;
Position p((int)env->GetIntField(p_p, FindCachedField(env, env->GetObjectClass(p_p), "x", "I")), (int)env->GetIntField(p_p, FindCachedField(env, env->GetObjectClass(p_p), "y", "I")));
Color color((int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "r", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "g", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "b", "I")));
x_game->drawCircleMouse(p, radius, color);
}
JNIEXPORT void JNICALL Java_bwapi_Game_drawCircleMouse_1native__JLbwapi_Position_2ILbwapi_Color_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_p, jint radius, jobject p_color, jboolean isSolid){
Game* x_game = (Game*)pointer;
Position p((int)env->GetIntField(p_p, FindCachedField(env, env->GetObjectClass(p_p), "x", "I")), (int)env->GetIntField(p_p, FindCachedField(env, env->GetObjectClass(p_p), "y", "I")));
Color color((int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "r", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "g", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "b", "I")));
...
JNIEXPORT void JNICALL Java_bwapi_Game_drawCircleScreen_1native__JLbwapi_Position_2ILbwapi_Color_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_p, jint radius, jobject p_color){
Game* x_game = (Game*)pointer;
Position p((int)env->GetIntField(p_p, FindCachedField(env, env->GetObjectClass(p_p), "x", "I")), (int)env->GetIntField(p_p, FindCachedField(env, env->GetObjectClass(p_p), "y", "I")));
Color color((int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "r", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "g", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "b", "I")));
x_game->drawCircleScreen(p, radius, color);
}
JNIEXPORT void JNICALL Java_bwapi_Game_drawCircleScreen_1native__JLbwapi_Position_2ILbwapi_Color_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_p, jint radius, jobject p_color, jboolean isSolid){
Game* x_game = (Game*)pointer;
Position p((int)env->GetIntField(p_p, FindCachedField(env, env->GetObjectClass(p_p), "x", "I")), (int)env->GetIntField(p_p, FindCachedField(env, env->GetObjectClass(p_p), "y", "I")));
Color color((int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "r", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "g", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "b", "I")));
x_game->drawCircleScreen(p, radius, color, (bool)isSolid);
}
JNIEXPORT void JNICALL Java_bwapi_Game_drawEllipse_1native__JLbwapi_CoordinateType_Enum_2IIIILbwapi_Color_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_ctype, jint x, jint y, jint xrad, jint yrad, jobject p_color){
Game* x_game = (Game*)pointer;
CoordinateType::Enum ctype = (CoordinateType::Enum)(int)env->GetIntField(p_ctype, FindCachedField(env, env->GetObjectClass(p_ctype), "value", "I"));
Color color((int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "r", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "g", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "b", "I")));
x_game->drawEllipse(ctype, x, y, xrad, yrad, color);
}
JNIEXPORT void JNICALL Java_bwapi_Game_drawEllipse_1native__JLbwapi_CoordinateType_Enum_2IIIILbwapi_Color_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_ctype, jint x, jint y, jint xrad, jint yrad, jobject p_color, jboolean isSolid){
Game* x_game = (Game*)pointer;
CoordinateType::Enum ctype = (CoordinateType::Enum)(int)env->GetIntField(p_ctype, FindCachedField(env, env->GetObjectClass(p_ctype), "value", "I"));
Color color((int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "r", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "g", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "b", "I")));
...
JNIEXPORT void JNICALL Java_bwapi_Game_drawEllipseMap_1native__JLbwapi_Position_2IILbwapi_Color_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_p, jint xrad, jint yrad, jobject p_color){
Game* x_game = (Game*)pointer;
Position p((int)env->GetIntField(p_p, FindCachedField(env, env->GetObjectClass(p_p), "x", "I")), (int)env->GetIntField(p_p, FindCachedField(env, env->GetObjectClass(p_p), "y", "I")));
Color color((int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "r", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "g", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "b", "I")));
x_game->drawEllipseMap(p, xrad, yrad, color);
}
JNIEXPORT void JNICALL Java_bwapi_Game_drawEllipseMap_1native__JLbwapi_Position_2IILbwapi_Color_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_p, jint xrad, jint yrad, jobject p_color, jboolean isSolid){
Game* x_game = (Game*)pointer;
Position p((int)env->GetIntField(p_p, FindCachedField(env, env->GetObjectClass(p_p), "x", "I")), (int)env->GetIntField(p_p, FindCachedField(env, env->GetObjectClass(p_p), "y", "I")));
Color color((int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "r", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "g", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "b", "I")));
...
JNIEXPORT void JNICALL Java_bwapi_Game_drawEllipseMouse_1native__JLbwapi_Position_2IILbwapi_Color_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_p, jint xrad, jint yrad, jobject p_color){
Game* x_game = (Game*)pointer;
Position p((int)env->GetIntField(p_p, FindCachedField(env, env->GetObjectClass(p_p), "x", "I")), (int)env->GetIntField(p_p, FindCachedField(env, env->GetObjectClass(p_p), "y", "I")));
Color color((int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "r", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "g", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "b", "I")));
x_game->drawEllipseMouse(p, xrad, yrad, color);
}
JNIEXPORT void JNICALL Java_bwapi_Game_drawEllipseMouse_1native__JLbwapi_Position_2IILbwapi_Color_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_p, jint xrad, jint yrad, jobject p_color, jboolean isSolid){
Game* x_game = (Game*)pointer;
Position p((int)env->GetIntField(p_p, FindCachedField(env, env->GetObjectClass(p_p), "x", "I")), (int)env->GetIntField(p_p, FindCachedField(env, env->GetObjectClass(p_p), "y", "I")));
Color color((int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "r", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "g", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "b", "I")));
...
JNIEXPORT void JNICALL Java_bwapi_Game_drawEllipseScreen_1native__JLbwapi_Position_2IILbwapi_Color_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_p, jint xrad, jint yrad, jobject p_color){
Game* x_game = (Game*)pointer;
Position p((int)env->GetIntField(p_p, FindCachedField(env, env->GetObjectClass(p_p), "x", "I")), (int)env->GetIntField(p_p, FindCachedField(env, env->GetObjectClass(p_p), "y", "I")));
Color color((int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "r", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "g", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "b", "I")));
x_game->drawEllipseScreen(p, xrad, yrad, color);
}
JNIEXPORT void JNICALL Java_bwapi_Game_drawEllipseScreen_1native__JLbwapi_Position_2IILbwapi_Color_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_p, jint xrad, jint yrad, jobject p_color, jboolean isSolid){
Game* x_game = (Game*)pointer;
Position p((int)env->GetIntField(p_p, FindCachedField(env, env->GetObjectClass(p_p), "x", "I")), (int)env->GetIntField(p_p, FindCachedField(env, env->GetObjectClass(p_p), "y", "I")));
Color color((int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "r", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "g", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "b", "I")));
x_game->drawEllipseScreen(p, xrad, yrad, color, (bool)isSolid);
}
JNIEXPORT void JNICALL Java_bwapi_Game_drawDot_1native(JNIEnv * env, jobject obj, jlong pointer, jobject p_ctype, jint x, jint y, jobject p_color){
Game* x_game = (Game*)pointer;
CoordinateType::Enum ctype = (CoordinateType::Enum)(int)env->GetIntField(p_ctype, FindCachedField(env, env->GetObjectClass(p_ctype), "value", "I"));
Color color((int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "r", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "g", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "b", "I")));
x_game->drawDot(ctype, x, y, color);
}
JNIEXPORT void JNICALL Java_bwapi_Game_drawDotMap_1native__JIILbwapi_Color_2(JNIEnv * env, jobject obj, jlong pointer, jint x, jint y, jobject p_color){
Game* x_game = (Game*)pointer;
Color color((int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "r", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "g", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "b", "I")));
x_game->drawDotMap(x, y, color);
}
JNIEXPORT void JNICALL Java_bwapi_Game_drawDotMap_1native__JLbwapi_Position_2Lbwapi_Color_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_p, jobject p_color){
Game* x_game = (Game*)pointer;
Position p((int)env->GetIntField(p_p, FindCachedField(env, env->GetObjectClass(p_p), "x", "I")), (int)env->GetIntField(p_p, FindCachedField(env, env->GetObjectClass(p_p), "y", "I")));
Color color((int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "r", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "g", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "b", "I")));
x_game->drawDotMap(p, color);
}
JNIEXPORT void JNICALL Java_bwapi_Game_drawDotMouse_1native__JIILbwapi_Color_2(JNIEnv * env, jobject obj, jlong pointer, jint x, jint y, jobject p_color){
Game* x_game = (Game*)pointer;
Color color((int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "r", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "g", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "b", "I")));
x_game->drawDotMouse(x, y, color);
}
JNIEXPORT void JNICALL Java_bwapi_Game_drawDotMouse_1native__JLbwapi_Position_2Lbwapi_Color_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_p, jobject p_color){
Game* x_game = (Game*)pointer;
Position p((int)env->GetIntField(p_p, FindCachedField(env, env->GetObjectClass(p_p), "x", "I")), (int)env->GetIntField(p_p, FindCachedField(env, env->GetObjectClass(p_p), "y", "I")));
Color color((int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "r", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "g", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "b", "I")));
x_game->drawDotMouse(p, color);
}
JNIEXPORT void JNICALL Java_bwapi_Game_drawDotScreen_1native__JIILbwapi_Color_2(JNIEnv * env, jobject obj, jlong pointer, jint x, jint y, jobject p_color){
Game* x_game = (Game*)pointer;
Color color((int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "r", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "g", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "b", "I")));
x_game->drawDotScreen(x, y, color);
}
JNIEXPORT void JNICALL Java_bwapi_Game_drawDotScreen_1native__JLbwapi_Position_2Lbwapi_Color_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_p, jobject p_color){
Game* x_game = (Game*)pointer;
Position p((int)env->GetIntField(p_p, FindCachedField(env, env->GetObjectClass(p_p), "x", "I")), (int)env->GetIntField(p_p, FindCachedField(env, env->GetObjectClass(p_p), "y", "I")));
Color color((int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "r", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "g", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "b", "I")));
x_game->drawDotScreen(p, color);
}
JNIEXPORT void JNICALL Java_bwapi_Game_drawLine_1native(JNIEnv * env, jobject obj, jlong pointer, jobject p_ctype, jint x1, jint y1, jint x2, jint y2, jobject p_color){
Game* x_game = (Game*)pointer;
CoordinateType::Enum ctype = (CoordinateType::Enum)(int)env->GetIntField(p_ctype, FindCachedField(env, env->GetObjectClass(p_ctype), "value", "I"));
Color color((int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "r", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "g", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "b", "I")));
x_game->drawLine(ctype, x1, y1, x2, y2, color);
}
JNIEXPORT void JNICALL Java_bwapi_Game_drawLineMap_1native__JIIIILbwapi_Color_2(JNIEnv * env, jobject obj, jlong pointer, jint x1, jint y1, jint x2, jint y2, jobject p_color){
Game* x_game = (Game*)pointer;
Color color((int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "r", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "g", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "b", "I")));
x_game->drawLineMap(x1, y1, x2, y2, color);
}
JNIEXPORT void JNICALL Java_bwapi_Game_drawLineMap_1native__JLbwapi_Position_2Lbwapi_Position_2Lbwapi_Color_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_a, jobject p_b, jobject p_color){
Game* x_game = (Game*)pointer;
Position a((int)env->GetIntField(p_a, FindCachedField(env, env->GetObjectClass(p_a), "x", "I")), (int)env->GetIntField(p_a, FindCachedField(env, env->GetObjectClass(p_a), "y", "I")));
Position b((int)env->GetIntField(p_b, FindCachedField(env, env->GetObjectClass(p_b), "x", "I")), (int)env->GetIntField(p_b, FindCachedField(env, env->GetObjectClass(p_b), "y", "I")));
Color color((int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "r", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "g", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "b", "I")));
...
JNIEXPORT void JNICALL Java_bwapi_Game_drawLineMouse_1native__JIIIILbwapi_Color_2(JNIEnv * env, jobject obj, jlong pointer, jint x1, jint y1, jint x2, jint y2, jobject p_color){
Game* x_game = (Game*)pointer;
Color color((int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "r", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "g", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "b", "I")));
x_game->drawLineMouse(x1, y1, x2, y2, color);
}
JNIEXPORT void JNICALL Java_bwapi_Game_drawLineMouse_1native__JLbwapi_Position_2Lbwapi_Position_2Lbwapi_Color_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_a, jobject p_b, jobject p_color){
Game* x_game = (Game*)pointer;
Position a((int)env->GetIntField(p_a, FindCachedField(env, env->GetObjectClass(p_a), "x", "I")), (int)env->GetIntField(p_a, FindCachedField(env, env->GetObjectClass(p_a), "y", "I")));
Position b((int)env->GetIntField(p_b, FindCachedField(env, env->GetObjectClass(p_b), "x", "I")), (int)env->GetIntField(p_b, FindCachedField(env, env->GetObjectClass(p_b), "y", "I")));
Color color((int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "r", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "g", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "b", "I")));
...
JNIEXPORT void JNICALL Java_bwapi_Game_drawLineScreen_1native__JIIIILbwapi_Color_2(JNIEnv * env, jobject obj, jlong pointer, jint x1, jint y1, jint x2, jint y2, jobject p_color){
Game* x_game = (Game*)pointer;
Color color((int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "r", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "g", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "b", "I")));
x_game->drawLineScreen(x1, y1, x2, y2, color);
}
JNIEXPORT void JNICALL Java_bwapi_Game_drawLineScreen_1native__JLbwapi_Position_2Lbwapi_Position_2Lbwapi_Color_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_a, jobject p_b, jobject p_color){
Game* x_game = (Game*)pointer;
Position a((int)env->GetIntField(p_a, FindCachedField(env, env->GetObjectClass(p_a), "x", "I")), (int)env->GetIntField(p_a, FindCachedField(env, env->GetObjectClass(p_a), "y", "I")));
Position b((int)env->GetIntField(p_b, FindCachedField(env, env->GetObjectClass(p_b), "x", "I")), (int)env->GetIntField(p_b, FindCachedField(env, env->GetObjectClass(p_b), "y", "I")));
Color color((int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "r", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "g", "I")), (int)env->GetIntField(p_color, FindCachedField(env, env->GetObjectClass(p_color), "b", "I")));
...
JNIEXPORT jboolean JNICALL Java_bwapi_Game_isGUIEnabled_1native(JNIEnv * env, jobject obj, jlong pointer){
Game* x_game = (Game*)pointer;
return x_game->isGUIEnabled();
}
JNIEXPORT void JNICALL Java_bwapi_Game_setGUI_1native(JNIEnv * env, jobject obj, jlong pointer, jboolean enabled){
Game* x_game = (Game*)pointer;
x_game->setGUI((bool)enabled);
}
JNIEXPORT jint JNICALL Java_bwapi_Game_getInstanceNumber_1native(JNIEnv * env, jobject obj, jlong pointer){
Game* x_game = (Game*)pointer;
...
JNIEXPORT void JNICALL Java_bwapi_Game_setFrameSkip_1native(JNIEnv * env, jobject obj, jlong pointer, jint frameSkip){
Game* x_game = (Game*)pointer;
...
JNIEXPORT jint JNICALL Java_bwapi_Game_elapsedTime_1native(JNIEnv * env, jobject obj, jlong pointer){
Game* x_game = (Game*)pointer;
return x_game->elapsedTime();
}
JNIEXPORT void JNICALL Java_bwapi_Game_setCommandOptimizationLevel_1native(JNIEnv * env, jobject obj, jlong pointer, jint level){
Game* x_game = (Game*)pointer;
x_game->setCommandOptimizationLevel(level);
}
JNIEXPORT jint JNICALL Java_bwapi_Game_countdownTimer_1native(JNIEnv * env, jobject obj, jlong pointer){
Game* x_game = (Game*)pointer;
return x_game->countdownTimer();
}
JNIEXPORT jobject JNICALL Java_bwapi_Game_getAllRegions_1native(JNIEnv * env, jobject obj, jlong pointer){
Game* x_game = (Game*)pointer;
...
JNIEXPORT jobject JNICALL Java_bwapi_Game_getBuildLocation_1native__JLbwapi_UnitType_2Lbwapi_TilePosition_2I(JNIEnv * env, jobject obj, jlong pointer, jobject p_type, jobject p_desiredPosition, jint maxRange){
Game* x_game = (Game*)pointer;
UnitType* type = (UnitType*)env->GetLongField(p_type, FindCachedField(env, env->GetObjectClass(p_type), "pointer", "J"));
...
JNIEXPORT jobject JNICALL Java_bwapi_Game_getBuildLocation_1native__JLbwapi_UnitType_2Lbwapi_TilePosition_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_type, jobject p_desiredPosition){
Game* x_game = (Game*)pointer;
UnitType* type = (UnitType*)env->GetLongField(p_type, FindCachedField(env, env->GetObjectClass(p_type), "pointer", "J"));
TilePosition desiredPosition((int)env->GetIntField(p_desiredPosition, FindCachedField(env, env->GetObjectClass(p_desiredPosition), "x", "I")), (int)env->GetIntField(p_desiredPosition, FindCachedField(env, env->GetObjectClass(p_desiredPosition), "y", "I")));
...
JNIEXPORT jobject JNICALL Java_bwapi_Game_getBuildLocation_1native__JLbwapi_UnitType_2Lbwapi_TilePosition_2IZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_type, jobject p_desiredPosition, jint maxRange, jboolean creep){
Game* x_game = (Game*)pointer;
UnitType* type = (UnitType*)env->GetLongField(p_type, FindCachedField(env, env->GetObjectClass(p_type), "pointer", "J"));
TilePosition desiredPosition((int)env->GetIntField(p_desiredPosition, FindCachedField(env, env->GetObjectClass(p_desiredPosition), "x", "I")), (int)env->GetIntField(p_desiredPosition, FindCachedField(env, env->GetObjectClass(p_desiredPosition), "y", "I")));
...
JNIEXPORT jint JNICALL Java_bwapi_Game_getDamageFrom_1native__JLbwapi_UnitType_2Lbwapi_UnitType_2Lbwapi_Player_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_fromType, jobject p_toType, jobject p_fromPlayer){
Game* x_game = (Game*)pointer;
...
JNIEXPORT jint JNICALL Java_bwapi_Game_getDamageFrom_1native__JLbwapi_UnitType_2Lbwapi_UnitType_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_fromType, jobject p_toType){
Game* x_game = (Game*)pointer;
UnitType* fromType = (UnitType*)env->GetLongField(p_fromType, FindCachedField(env, env->GetObjectClass(p_fromType), "pointer", "J"));
UnitType* toType = (UnitType*)env->GetLongField(p_toType, FindCachedField(env, env->GetObjectClass(p_toType), "pointer", "J"));
return x_game->getDamageFrom(*fromType, *toType);
}
JNIEXPORT jint JNICALL Java_bwapi_Game_getDamageFrom_1native__JLbwapi_UnitType_2Lbwapi_UnitType_2Lbwapi_Player_2Lbwapi_Player_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_fromType, jobject p_toType, jobject p_fromPlayer, jobject p_toPlayer){
Game* x_game = (Game*)pointer;
UnitType* fromType = (UnitType*)env->GetLongField(p_fromType, FindCachedField(env, env->GetObjectClass(p_fromType), "pointer", "J"));
UnitType* toType = (UnitType*)env->GetLongField(p_toType, FindCachedField(env, env->GetObjectClass(p_toType), "pointer", "J"));
Player fromPlayer = (Player)env->GetLongField(p_fromPlayer, FindCachedField(env, env->GetObjectClass(p_fromPlayer), "pointer", "J"));
...
JNIEXPORT jint JNICALL Java_bwapi_Game_getDamageTo_1native__JLbwapi_UnitType_2Lbwapi_UnitType_2Lbwapi_Player_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_toType, jobject p_fromType, jobject p_toPlayer){
Game* x_game = (Game*)pointer;
UnitType* toType = (UnitType*)env->GetLongField(p_toType, FindCachedField(env, env->GetObjectClass(p_toType), "pointer", "J"));
UnitType* fromType = (UnitType*)env->GetLongField(p_fromType, FindCachedField(env, env->GetObjectClass(p_fromType), "pointer", "J"));
Player toPlayer = (Player)env->GetLongField(p_toPlayer, FindCachedField(env, env->GetObjectClass(p_toPlayer), "pointer", "J"));
...
JNIEXPORT jint JNICALL Java_bwapi_Game_getDamageTo_1native__JLbwapi_UnitType_2Lbwapi_UnitType_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_toType, jobject p_fromType){
Game* x_game = (Game*)pointer;
UnitType* toType = (UnitType*)env->GetLongField(p_toType, FindCachedField(env, env->GetObjectClass(p_toType), "pointer", "J"));
UnitType* fromType = (UnitType*)env->GetLongField(p_fromType, FindCachedField(env, env->GetObjectClass(p_fromType), "pointer", "J"));
return x_game->getDamageTo(*toType, *fromType);
}
JNIEXPORT jint JNICALL Java_bwapi_Game_getDamageTo_1native__JLbwapi_UnitType_2Lbwapi_UnitType_2Lbwapi_Player_2Lbwapi_Player_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_toType, jobject p_fromType, jobject p_toPlayer, jobject p_fromPlayer){
Game* x_game = (Game*)pointer;
UnitType* toType = (UnitType*)env->GetLongField(p_toType, FindCachedField(env, env->GetObjectClass(p_toType), "pointer", "J"));
UnitType* fromType = (UnitType*)env->GetLongField(p_fromType, FindCachedField(env, env->GetObjectClass(p_fromType), "pointer", "J"));
Player toPlayer = (Player)env->GetLongField(p_toPlayer, FindCachedField(env, env->GetObjectClass(p_toPlayer), "pointer", "J"));
...
JNIEXPORT jstring JNICALL Java_bwapi_GameType_toString_1native(JNIEnv * env, jobject obj, jlong pointer){
...
JNIEXPORT jint JNICALL Java_bwapi_Player_allUnitCount_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Player x_player = (Player)pointer;
return x_player->allUnitCount();
}
JNIEXPORT jint JNICALL Java_bwapi_Player_allUnitCount_1native__JLbwapi_UnitType_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_unit){
Player x_player = (Player)pointer;
...
JNIEXPORT jint JNICALL Java_bwapi_Player_visibleUnitCount_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Player x_player = (Player)pointer;
return x_player->visibleUnitCount();
}
JNIEXPORT jint JNICALL Java_bwapi_Player_visibleUnitCount_1native__JLbwapi_UnitType_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_unit){
Player x_player = (Player)pointer;
UnitType* unit = (UnitType*)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
return x_player->visibleUnitCount(*unit);
}
JNIEXPORT jint JNICALL Java_bwapi_Player_completedUnitCount_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Player x_player = (Player)pointer;
return x_player->completedUnitCount();
}
JNIEXPORT jint JNICALL Java_bwapi_Player_completedUnitCount_1native__JLbwapi_UnitType_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_unit){
Player x_player = (Player)pointer;
UnitType* unit = (UnitType*)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
return x_player->completedUnitCount(*unit);
}
JNIEXPORT jint JNICALL Java_bwapi_Player_incompleteUnitCount_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Player x_player = (Player)pointer;
return x_player->incompleteUnitCount();
}
JNIEXPORT jint JNICALL Java_bwapi_Player_incompleteUnitCount_1native__JLbwapi_UnitType_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_unit){
Player x_player = (Player)pointer;
UnitType* unit = (UnitType*)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
return x_player->incompleteUnitCount(*unit);
}
JNIEXPORT jint JNICALL Java_bwapi_Player_deadUnitCount_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Player x_player = (Player)pointer;
return x_player->deadUnitCount();
}
JNIEXPORT jint JNICALL Java_bwapi_Player_deadUnitCount_1native__JLbwapi_UnitType_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_unit){
Player x_player = (Player)pointer;
UnitType* unit = (UnitType*)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
return x_player->deadUnitCount(*unit);
}
JNIEXPORT jint JNICALL Java_bwapi_Player_killedUnitCount_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Player x_player = (Player)pointer;
return x_player->killedUnitCount();
}
JNIEXPORT jint JNICALL Java_bwapi_Player_killedUnitCount_1native__JLbwapi_UnitType_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_unit){
Player x_player = (Player)pointer;
UnitType* unit = (UnitType*)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
return x_player->killedUnitCount(*unit);
}
JNIEXPORT jint JNICALL Java_bwapi_Player_getUpgradeLevel_1native(JNIEnv * env, jobject obj, jlong pointer, jobject p_upgrade){
Player x_player = (Player)pointer;
...
JNIEXPORT jchar JNICALL Java_bwapi_Player_getTextColor_1native(JNIEnv * env, jobject obj, jlong pointer){
Player x_player = (Player)pointer;
...
JNIEXPORT jint JNICALL Java_bwapi_Player_weaponDamageCooldown_1native(JNIEnv * env, jobject obj, jlong pointer, jobject p_unit){
Player x_player = (Player)pointer;
UnitType* unit = (UnitType*)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
...
JNIEXPORT jint JNICALL Java_bwapi_Player_damage_1native(JNIEnv * env, jobject obj, jlong pointer, jobject p_wpn){
Player x_player = (Player)pointer;
...
JNIEXPORT jint JNICALL Java_bwapi_Player_getMaxUpgradeLevel_1native(JNIEnv * env, jobject obj, jlong pointer, jobject p_upgrade){
Player x_player = (Player)pointer;
UpgradeType* upgrade = (UpgradeType*)env->GetLongField(p_upgrade, FindCachedField(env, env->GetObjectClass(p_upgrade), "pointer", "J"));
...
JNIEXPORT jboolean JNICALL Java_bwapi_Player_hasUnitTypeRequirement_1native__JLbwapi_UnitType_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_unit){
Player x_player = (Player)pointer;
UnitType* unit = (UnitType*)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
return x_player->hasUnitTypeRequirement(*unit);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Player_hasUnitTypeRequirement_1native__JLbwapi_UnitType_2I(JNIEnv * env, jobject obj, jlong pointer, jobject p_unit, jint amount){
Player x_player = (Player)pointer;
UnitType* unit = (UnitType*)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
return x_player->hasUnitTypeRequirement(*unit, amount);
}
JNIEXPORT jobject JNICALL Java_bwapi_Playerset_getUnits_1native(JNIEnv * env, jobject obj, jlong pointer){
...
JNIEXPORT void JNICALL Java_bwapi_Playerset_setAlliance_1native__JZ(JNIEnv * env, jobject obj, jlong pointer, jboolean allies){
Playerset* x_playerset = (Playerset*)pointer;
x_playerset->setAlliance((bool)allies);
}
JNIEXPORT void JNICALL Java_bwapi_Playerset_setAlliance_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Playerset* x_playerset = (Playerset*)pointer;
x_playerset->setAlliance();
}
JNIEXPORT void JNICALL Java_bwapi_Playerset_setAlliance_1native__JZZ(JNIEnv * env, jobject obj, jlong pointer, jboolean allies, jboolean alliedVictory){
Playerset* x_playerset = (Playerset*)pointer;
x_playerset->setAlliance((bool)allies, (bool)alliedVictory);
}
JNIEXPORT jstring JNICALL Java_bwapi_PlayerType_toString_1native(JNIEnv * env, jobject obj, jlong pointer){
PlayerType* x_playerType = (PlayerType*)pointer;
return env->NewStringUTF(x_playerType->toString().c_str());
}
JNIEXPORT jboolean JNICALL Java_bwapi_PlayerType_isLobbyType_1native(JNIEnv * env, jobject obj, jlong pointer){
PlayerType* x_playerType = (PlayerType*)pointer;
return x_playerType->isLobbyType();
}
JNIEXPORT jboolean JNICALL Java_bwapi_PlayerType_isGameType_1native(JNIEnv * env, jobject obj, jlong pointer){
PlayerType* x_playerType = (PlayerType*)pointer;
...
JNIEXPORT jstring JNICALL Java_bwapi_Race_toString_1native(JNIEnv * env, jobject obj, jlong pointer){
...
JNIEXPORT jboolean JNICALL Java_bwapi_Region_isAccessible_1native(JNIEnv * env, jobject obj, jlong pointer){
Region x_region = (Region)pointer;
return x_region->isAccessible();
}
JNIEXPORT jobject JNICALL Java_bwapi_Region_getNeighbors_1native(JNIEnv * env, jobject obj, jlong pointer){
Region x_region = (Region)pointer;
...
JNIEXPORT jobject JNICALL Java_bwapi_Region_getUnits_1native(JNIEnv * env, jobject obj, jlong pointer){
Region x_region = (Region)pointer;
Unitset cresult = x_region->getUnits();
jclass listCls = FindCachedClass(env, "java/util/ArrayList");
jmethodID listConsID = FindCachedMethod(env, listCls, "<init>", "()V");
jobject result = env->NewObject(listCls, listConsID);
jmethodID addMethodID = FindCachedMethod(env, listCls, "add", "(Ljava/lang/Object;)Z");
...
JNIEXPORT jobject JNICALL Java_bwapi_Regionset_getCenter_1native(JNIEnv * env, jobject obj, jlong pointer){
...
JNIEXPORT jobject JNICALL Java_bwapi_Regionset_getUnits_1native(JNIEnv * env, jobject obj, jlong pointer){
Regionset* x_regionset = (Regionset*)pointer;
Unitset cresult = x_regionset->getUnits();
jclass listCls = FindCachedClass(env, "java/util/ArrayList");
jmethodID listConsID = FindCachedMethod(env, listCls, "<init>", "()V");
jobject result = env->NewObject(listCls, listConsID);
jmethodID addMethodID = FindCachedMethod(env, listCls, "add", "(Ljava/lang/Object;)Z");
...
JNIEXPORT jstring JNICALL Java_bwapi_TechType_toString_1native(JNIEnv * env, jobject obj, jlong pointer){
...
JNIEXPORT jint JNICALL Java_bwapi_TechType_energyCost_1native(JNIEnv * env, jobject obj, jlong pointer){
TechType* x_techType = (TechType*)pointer;
...
JNIEXPORT jobject JNICALL Java_bwapi_TechType_requiredUnit_1native(JNIEnv * env, jobject obj, jlong pointer){
TechType* x_techType = (TechType*)pointer;
jlong resptr = (jlong)tableUnitType.find(x_techType->requiredUnit().getID())->second;
jclass retcls = FindCachedClass(env, "bwapi/UnitType");
jmethodID mid = FindCachedMethodStatic(env, retcls, "get", "(J)Lbwapi/UnitType;");
return env->CallStaticObjectMethod(retcls, mid, resptr);
}
...
JNIEXPORT jint JNICALL Java_bwapi_Unit_getDistance_1native__JLbwapi_PositionOrUnit_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_target){
Unit x_unit = (Unit)pointer;
...
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_hasPath_1native__JLbwapi_PositionOrUnit_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_target){
Unit x_unit = (Unit)pointer;
PositionOrUnit target(convertPositionOrUnit(env, p_target ));
return x_unit->hasPath(target);
}
...
JNIEXPORT jobject JNICALL Java_bwapi_Unit_getLastCommand_1native(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
UnitCommand cresult = x_unit->getLastCommand();
jclass retcls = FindCachedClass(env, "bwapi/UnitCommand");
jmethodID retConsID = FindCachedMethod(env, retcls, "<init>", "(Lbwapi/Unit;Lbwapi/UnitCommandType;Lbwapi/Unit;III)V");
...
JNIEXPORT jobject JNICALL Java_bwapi_Unit_getTrainingQueue_1native(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
std::deque<UnitType> cresult = x_unit->getTrainingQueue();
jclass listCls = FindCachedClass(env, "java/util/ArrayList");
jmethodID listConsID = FindCachedMethod(env, listCls, "<init>", "()V");
jobject result = env->NewObject(listCls, listConsID);
jmethodID addMethodID = FindCachedMethod(env, listCls, "add", "(Ljava/lang/Object;)Z");
...
for(std::deque<UnitType>::const_iterator it = cresult.begin(); it != cresult.end(); it++ ){
...
JNIEXPORT jint JNICALL Java_bwapi_Unit_getSpaceRemaining_1native(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
...
Unit x_unit = (Unit)pointer;
Unitset cresult = x_unit->getUnitsInRadius(radius);
jclass listCls = FindCachedClass(env, "java/util/ArrayList");
jmethodID listConsID = FindCachedMethod(env, listCls, "<init>", "()V");
jobject result = env->NewObject(listCls, listConsID);
jmethodID addMethodID = FindCachedMethod(env, listCls, "add", "(Ljava/lang/Object;)Z");
...
Unit x_unit = (Unit)pointer;
WeaponType* weapon = (WeaponType*)env->GetLongField(p_weapon, FindCachedField(env, env->GetObjectClass(p_weapon), "pointer", "J"));
Unitset cresult = x_unit->getUnitsInWeaponRange(*weapon);
jclass listCls = FindCachedClass(env, "java/util/ArrayList");
jmethodID listConsID = FindCachedMethod(env, listCls, "<init>", "()V");
jobject result = env->NewObject(listCls, listConsID);
jmethodID addMethodID = FindCachedMethod(env, listCls, "add", "(Ljava/lang/Object;)Z");
...
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_isFlying_1native(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
...
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_isPowered_1native(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
...
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_isTargetable_1native(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
...
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_attack_1native__JLbwapi_PositionOrUnit_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_target){
Unit x_unit = (Unit)pointer;
PositionOrUnit target(convertPositionOrUnit(env, p_target ));
return x_unit->attack(target);
}
...
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_attack_1native__JLbwapi_PositionOrUnit_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean shiftQueueCommand){
Unit x_unit = (Unit)pointer;
PositionOrUnit target(convertPositionOrUnit(env, p_target ));
return x_unit->attack(target, (bool)shiftQueueCommand);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_build_1native__JLbwapi_UnitType_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_type){
Unit x_unit = (Unit)pointer;
UnitType* type = (UnitType*)env->GetLongField(p_type, FindCachedField(env, env->GetObjectClass(p_type), "pointer", "J"));
return x_unit->build(*type);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_build_1native__JLbwapi_UnitType_2Lbwapi_TilePosition_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_type, jobject p_target){
Unit x_unit = (Unit)pointer;
UnitType* type = (UnitType*)env->GetLongField(p_type, FindCachedField(env, env->GetObjectClass(p_type), "pointer", "J"));
...
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_train_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
return x_unit->train();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_train_1native__JLbwapi_UnitType_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_type){
Unit x_unit = (Unit)pointer;
UnitType* type = (UnitType*)env->GetLongField(p_type, FindCachedField(env, env->GetObjectClass(p_type), "pointer", "J"));
...
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_setRallyPoint_1native__JLbwapi_PositionOrUnit_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_target){
Unit x_unit = (Unit)pointer;
PositionOrUnit target(convertPositionOrUnit(env, p_target ));
return x_unit->setRallyPoint(target);
}
...
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_rightClick_1native__JLbwapi_PositionOrUnit_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_target){
Unit x_unit = (Unit)pointer;
PositionOrUnit target(convertPositionOrUnit(env, p_target ));
return x_unit->rightClick(target);
}
...
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_rightClick_1native__JLbwapi_PositionOrUnit_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean shiftQueueCommand){
Unit x_unit = (Unit)pointer;
PositionOrUnit target(convertPositionOrUnit(env, p_target ));
return x_unit->rightClick(target, (bool)shiftQueueCommand);
}
...
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_useTech_1native__JLbwapi_TechType_2Lbwapi_PositionOrUnit_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_tech, jobject p_target){
Unit x_unit = (Unit)pointer;
TechType* tech = (TechType*)env->GetLongField(p_tech, FindCachedField(env, env->GetObjectClass(p_tech), "pointer", "J"));
PositionOrUnit target(convertPositionOrUnit(env, p_target ));
return x_unit->useTech(*tech, target);
...
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canIssueCommand_1native__JLbwapi_UnitCommand_2ZZZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_command, jboolean checkCanUseTechPositionOnPositions, jboolean checkCanUseTechUnitOnUnits, jboolean checkCanBuildUnitType, jboolean checkCanTargetUnit){
Unit x_unit = (Unit)pointer;
UnitCommand command(convertUnitCommand(env, p_command ));
...
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canIssueCommand_1native__JLbwapi_UnitCommand_2ZZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_command, jboolean checkCanUseTechPositionOnPositions, jboolean checkCanUseTechUnitOnUnits, jboolean checkCanBuildUnitType){
Unit x_unit = (Unit)pointer;
UnitCommand command(convertUnitCommand(env, p_command ));
...
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canIssueCommand_1native__JLbwapi_UnitCommand_2ZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_command, jboolean checkCanUseTechPositionOnPositions, jboolean checkCanUseTechUnitOnUnits){
Unit x_unit = (Unit)pointer;
UnitCommand command(convertUnitCommand(env, p_command ));
return x_unit->canIssueCommand(command, (bool)checkCanUseTechPositionOnPositions, (bool)checkCanUseTechUnitOnUnits);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canIssueCommand_1native__JLbwapi_UnitCommand_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_command, jboolean checkCanUseTechPositionOnPositions){
Unit x_unit = (Unit)pointer;
UnitCommand command(convertUnitCommand(env, p_command ));
return x_unit->canIssueCommand(command, (bool)checkCanUseTechPositionOnPositions);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canIssueCommand_1native__JLbwapi_UnitCommand_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_command){
Unit x_unit = (Unit)pointer;
UnitCommand command(convertUnitCommand(env, p_command ));
return x_unit->canIssueCommand(command);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canIssueCommand_1native__JLbwapi_UnitCommand_2ZZZZZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_command, jboolean checkCanUseTechPositionOnPositions, jboolean checkCanUseTechUnitOnUnits, jboolean checkCanBuildUnitType, jboolean checkCanTargetUnit, jboolean checkCanIssueCommandType, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
UnitCommand command(convertUnitCommand(env, p_command ));
...
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canIssueCommandGrouped_1native__JLbwapi_UnitCommand_2ZZZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_command, jboolean checkCanUseTechPositionOnPositions, jboolean checkCanUseTechUnitOnUnits, jboolean checkCanTargetUnit, jboolean checkCanIssueCommandType){
Unit x_unit = (Unit)pointer;
UnitCommand command(convertUnitCommand(env, p_command ));
...
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canIssueCommandGrouped_1native__JLbwapi_UnitCommand_2ZZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_command, jboolean checkCanUseTechPositionOnPositions, jboolean checkCanUseTechUnitOnUnits, jboolean checkCanTargetUnit){
Unit x_unit = (Unit)pointer;
UnitCommand command(convertUnitCommand(env, p_command ));
...
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canIssueCommandGrouped_1native__JLbwapi_UnitCommand_2ZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_command, jboolean checkCanUseTechPositionOnPositions, jboolean checkCanUseTechUnitOnUnits){
Unit x_unit = (Unit)pointer;
UnitCommand command(convertUnitCommand(env, p_command ));
return x_unit->canIssueCommandGrouped(command, (bool)checkCanUseTechPositionOnPositions, (bool)checkCanUseTechUnitOnUnits);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canIssueCommandGrouped_1native__JLbwapi_UnitCommand_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_command, jboolean checkCanUseTechPositionOnPositions){
Unit x_unit = (Unit)pointer;
UnitCommand command(convertUnitCommand(env, p_command ));
return x_unit->canIssueCommandGrouped(command, (bool)checkCanUseTechPositionOnPositions);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canIssueCommandGrouped_1native__JLbwapi_UnitCommand_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_command){
Unit x_unit = (Unit)pointer;
UnitCommand command(convertUnitCommand(env, p_command ));
return x_unit->canIssueCommandGrouped(command);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canIssueCommandGrouped_1native__JLbwapi_UnitCommand_2ZZZZZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_command, jboolean checkCanUseTechPositionOnPositions, jboolean checkCanUseTechUnitOnUnits, jboolean checkCanTargetUnit, jboolean checkCanIssueCommandType, jboolean checkCommandibilityGrouped, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
UnitCommand command(convertUnitCommand(env, p_command ));
...
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canCommand_1native(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
return x_unit->canCommand();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canCommandGrouped_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
return x_unit->canCommandGrouped();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canCommandGrouped_1native__JZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
return x_unit->canCommandGrouped((bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canIssueCommandType_1native__JLbwapi_UnitCommandType_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_ct){
Unit x_unit = (Unit)pointer;
...
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canIssueCommandType_1native__JLbwapi_UnitCommandType_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_ct, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
UnitCommandType* ct = (UnitCommandType*)env->GetLongField(p_ct, FindCachedField(env, env->GetObjectClass(p_ct), "pointer", "J"));
return x_unit->canIssueCommandType(*ct, (bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canIssueCommandTypeGrouped_1native__JLbwapi_UnitCommandType_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_ct, jboolean checkCommandibilityGrouped){
Unit x_unit = (Unit)pointer;
UnitCommandType* ct = (UnitCommandType*)env->GetLongField(p_ct, FindCachedField(env, env->GetObjectClass(p_ct), "pointer", "J"));
return x_unit->canIssueCommandTypeGrouped(*ct, (bool)checkCommandibilityGrouped);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canIssueCommandTypeGrouped_1native__JLbwapi_UnitCommandType_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_ct){
Unit x_unit = (Unit)pointer;
UnitCommandType* ct = (UnitCommandType*)env->GetLongField(p_ct, FindCachedField(env, env->GetObjectClass(p_ct), "pointer", "J"));
return x_unit->canIssueCommandTypeGrouped(*ct);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canIssueCommandTypeGrouped_1native__JLbwapi_UnitCommandType_2ZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_ct, jboolean checkCommandibilityGrouped, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
UnitCommandType* ct = (UnitCommandType*)env->GetLongField(p_ct, FindCachedField(env, env->GetObjectClass(p_ct), "pointer", "J"));
return x_unit->canIssueCommandTypeGrouped(*ct, (bool)checkCommandibilityGrouped, (bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canTargetUnit_1native__JLbwapi_Unit_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_targetUnit){
Unit x_unit = (Unit)pointer;
...
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canTargetUnit_1native__JLbwapi_Unit_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_targetUnit, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
Unit targetUnit = (Unit)env->GetLongField(p_targetUnit, FindCachedField(env, env->GetObjectClass(p_targetUnit), "pointer", "J"));
return x_unit->canTargetUnit(targetUnit, (bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canAttack_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
return x_unit->canAttack();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canAttack_1native__JZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
return x_unit->canAttack((bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canAttack_1native__JLbwapi_Position_2ZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean checkCanTargetUnit, jboolean checkCanIssueCommandType){
Unit x_unit = (Unit)pointer;
Position target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
return x_unit->canAttack(target, (bool)checkCanTargetUnit, (bool)checkCanIssueCommandType);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canAttack_1native__JLbwapi_Unit_2ZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean checkCanTargetUnit, jboolean checkCanIssueCommandType){
Unit x_unit = (Unit)pointer;
Unit target = (Unit)env->GetLongField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "pointer", "J"));
return x_unit->canAttack(target, (bool)checkCanTargetUnit, (bool)checkCanIssueCommandType);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canAttack_1native__JLbwapi_PositionOrUnit_2ZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean checkCanTargetUnit, jboolean checkCanIssueCommandType){
Unit x_unit = (Unit)pointer;
PositionOrUnit target(convertPositionOrUnit(env, p_target ));
return x_unit->canAttack(target, (bool)checkCanTargetUnit, (bool)checkCanIssueCommandType);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canAttack_1native__JLbwapi_Position_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean checkCanTargetUnit){
Unit x_unit = (Unit)pointer;
Position target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
return x_unit->canAttack(target, (bool)checkCanTargetUnit);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canAttack_1native__JLbwapi_Unit_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean checkCanTargetUnit){
Unit x_unit = (Unit)pointer;
Unit target = (Unit)env->GetLongField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "pointer", "J"));
return x_unit->canAttack(target, (bool)checkCanTargetUnit);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canAttack_1native__JLbwapi_PositionOrUnit_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean checkCanTargetUnit){
Unit x_unit = (Unit)pointer;
PositionOrUnit target(convertPositionOrUnit(env, p_target ));
return x_unit->canAttack(target, (bool)checkCanTargetUnit);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canAttack_1native__JLbwapi_Position_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_target){
Unit x_unit = (Unit)pointer;
Position target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
return x_unit->canAttack(target);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canAttack_1native__JLbwapi_Unit_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_target){
Unit x_unit = (Unit)pointer;
Unit target = (Unit)env->GetLongField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "pointer", "J"));
return x_unit->canAttack(target);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canAttack_1native__JLbwapi_PositionOrUnit_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_target){
Unit x_unit = (Unit)pointer;
PositionOrUnit target(convertPositionOrUnit(env, p_target ));
return x_unit->canAttack(target);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canAttack_1native__JLbwapi_Position_2ZZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean checkCanTargetUnit, jboolean checkCanIssueCommandType, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
Position target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
return x_unit->canAttack(target, (bool)checkCanTargetUnit, (bool)checkCanIssueCommandType, (bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canAttack_1native__JLbwapi_Unit_2ZZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean checkCanTargetUnit, jboolean checkCanIssueCommandType, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
Unit target = (Unit)env->GetLongField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "pointer", "J"));
return x_unit->canAttack(target, (bool)checkCanTargetUnit, (bool)checkCanIssueCommandType, (bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canAttack_1native__JLbwapi_PositionOrUnit_2ZZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean checkCanTargetUnit, jboolean checkCanIssueCommandType, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
PositionOrUnit target(convertPositionOrUnit(env, p_target ));
return x_unit->canAttack(target, (bool)checkCanTargetUnit, (bool)checkCanIssueCommandType, (bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canAttackGrouped_1native__JZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibilityGrouped){
Unit x_unit = (Unit)pointer;
return x_unit->canAttackGrouped((bool)checkCommandibilityGrouped);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canAttackGrouped_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
return x_unit->canAttackGrouped();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canAttackGrouped_1native__JZZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibilityGrouped, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
return x_unit->canAttackGrouped((bool)checkCommandibilityGrouped, (bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canAttackGrouped_1native__JLbwapi_Position_2ZZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean checkCanTargetUnit, jboolean checkCanIssueCommandType, jboolean checkCommandibilityGrouped){
Unit x_unit = (Unit)pointer;
Position target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
...
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canAttackGrouped_1native__JLbwapi_Unit_2ZZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean checkCanTargetUnit, jboolean checkCanIssueCommandType, jboolean checkCommandibilityGrouped){
Unit x_unit = (Unit)pointer;
Unit target = (Unit)env->GetLongField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "pointer", "J"));
return x_unit->canAttackGrouped(target, (bool)checkCanTargetUnit, (bool)checkCanIssueCommandType, (bool)checkCommandibilityGrouped);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canAttackGrouped_1native__JLbwapi_PositionOrUnit_2ZZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean checkCanTargetUnit, jboolean checkCanIssueCommandType, jboolean checkCommandibilityGrouped){
Unit x_unit = (Unit)pointer;
PositionOrUnit target(convertPositionOrUnit(env, p_target ));
return x_unit->canAttackGrouped(target, (bool)checkCanTargetUnit, (bool)checkCanIssueCommandType, (bool)checkCommandibilityGrouped);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canAttackGrouped_1native__JLbwapi_Position_2ZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean checkCanTargetUnit, jboolean checkCanIssueCommandType){
Unit x_unit = (Unit)pointer;
Position target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
return x_unit->canAttackGrouped(target, (bool)checkCanTargetUnit, (bool)checkCanIssueCommandType);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canAttackGrouped_1native__JLbwapi_Unit_2ZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean checkCanTargetUnit, jboolean checkCanIssueCommandType){
Unit x_unit = (Unit)pointer;
Unit target = (Unit)env->GetLongField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "pointer", "J"));
return x_unit->canAttackGrouped(target, (bool)checkCanTargetUnit, (bool)checkCanIssueCommandType);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canAttackGrouped_1native__JLbwapi_PositionOrUnit_2ZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean checkCanTargetUnit, jboolean checkCanIssueCommandType){
Unit x_unit = (Unit)pointer;
PositionOrUnit target(convertPositionOrUnit(env, p_target ));
return x_unit->canAttackGrouped(target, (bool)checkCanTargetUnit, (bool)checkCanIssueCommandType);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canAttackGrouped_1native__JLbwapi_Position_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean checkCanTargetUnit){
Unit x_unit = (Unit)pointer;
Position target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
return x_unit->canAttackGrouped(target, (bool)checkCanTargetUnit);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canAttackGrouped_1native__JLbwapi_Unit_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean checkCanTargetUnit){
Unit x_unit = (Unit)pointer;
Unit target = (Unit)env->GetLongField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "pointer", "J"));
return x_unit->canAttackGrouped(target, (bool)checkCanTargetUnit);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canAttackGrouped_1native__JLbwapi_PositionOrUnit_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean checkCanTargetUnit){
Unit x_unit = (Unit)pointer;
PositionOrUnit target(convertPositionOrUnit(env, p_target ));
return x_unit->canAttackGrouped(target, (bool)checkCanTargetUnit);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canAttackGrouped_1native__JLbwapi_Position_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_target){
Unit x_unit = (Unit)pointer;
Position target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
return x_unit->canAttackGrouped(target);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canAttackGrouped_1native__JLbwapi_Unit_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_target){
Unit x_unit = (Unit)pointer;
Unit target = (Unit)env->GetLongField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "pointer", "J"));
return x_unit->canAttackGrouped(target);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canAttackGrouped_1native__JLbwapi_PositionOrUnit_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_target){
Unit x_unit = (Unit)pointer;
PositionOrUnit target(convertPositionOrUnit(env, p_target ));
return x_unit->canAttackGrouped(target);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canAttackGrouped_1native__JLbwapi_Position_2ZZZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean checkCanTargetUnit, jboolean checkCanIssueCommandType, jboolean checkCommandibilityGrouped, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
Position target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
...
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canAttackGrouped_1native__JLbwapi_Unit_2ZZZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean checkCanTargetUnit, jboolean checkCanIssueCommandType, jboolean checkCommandibilityGrouped, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
Unit target = (Unit)env->GetLongField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "pointer", "J"));
return x_unit->canAttackGrouped(target, (bool)checkCanTargetUnit, (bool)checkCanIssueCommandType, (bool)checkCommandibilityGrouped, (bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canAttackGrouped_1native__JLbwapi_PositionOrUnit_2ZZZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean checkCanTargetUnit, jboolean checkCanIssueCommandType, jboolean checkCommandibilityGrouped, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
PositionOrUnit target(convertPositionOrUnit(env, p_target ));
return x_unit->canAttackGrouped(target, (bool)checkCanTargetUnit, (bool)checkCanIssueCommandType, (bool)checkCommandibilityGrouped, (bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canAttackMove_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
return x_unit->canAttackMove();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canAttackMove_1native__JZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
return x_unit->canAttackMove((bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canAttackMoveGrouped_1native__JZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibilityGrouped){
Unit x_unit = (Unit)pointer;
return x_unit->canAttackMoveGrouped((bool)checkCommandibilityGrouped);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canAttackMoveGrouped_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
return x_unit->canAttackMoveGrouped();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canAttackMoveGrouped_1native__JZZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibilityGrouped, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
return x_unit->canAttackMoveGrouped((bool)checkCommandibilityGrouped, (bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canAttackUnit_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
return x_unit->canAttackUnit();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canAttackUnit_1native__JZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
return x_unit->canAttackUnit((bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canAttackUnit_1native__JLbwapi_Unit_2ZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_targetUnit, jboolean checkCanTargetUnit, jboolean checkCanIssueCommandType){
Unit x_unit = (Unit)pointer;
Unit targetUnit = (Unit)env->GetLongField(p_targetUnit, FindCachedField(env, env->GetObjectClass(p_targetUnit), "pointer", "J"));
return x_unit->canAttackUnit(targetUnit, (bool)checkCanTargetUnit, (bool)checkCanIssueCommandType);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canAttackUnit_1native__JLbwapi_Unit_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_targetUnit, jboolean checkCanTargetUnit){
Unit x_unit = (Unit)pointer;
Unit targetUnit = (Unit)env->GetLongField(p_targetUnit, FindCachedField(env, env->GetObjectClass(p_targetUnit), "pointer", "J"));
return x_unit->canAttackUnit(targetUnit, (bool)checkCanTargetUnit);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canAttackUnit_1native__JLbwapi_Unit_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_targetUnit){
Unit x_unit = (Unit)pointer;
Unit targetUnit = (Unit)env->GetLongField(p_targetUnit, FindCachedField(env, env->GetObjectClass(p_targetUnit), "pointer", "J"));
return x_unit->canAttackUnit(targetUnit);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canAttackUnit_1native__JLbwapi_Unit_2ZZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_targetUnit, jboolean checkCanTargetUnit, jboolean checkCanIssueCommandType, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
Unit targetUnit = (Unit)env->GetLongField(p_targetUnit, FindCachedField(env, env->GetObjectClass(p_targetUnit), "pointer", "J"));
return x_unit->canAttackUnit(targetUnit, (bool)checkCanTargetUnit, (bool)checkCanIssueCommandType, (bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canAttackUnitGrouped_1native__JZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibilityGrouped){
Unit x_unit = (Unit)pointer;
return x_unit->canAttackUnitGrouped((bool)checkCommandibilityGrouped);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canAttackUnitGrouped_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
return x_unit->canAttackUnitGrouped();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canAttackUnitGrouped_1native__JZZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibilityGrouped, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
return x_unit->canAttackUnitGrouped((bool)checkCommandibilityGrouped, (bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canAttackUnitGrouped_1native__JLbwapi_Unit_2ZZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_targetUnit, jboolean checkCanTargetUnit, jboolean checkCanIssueCommandType, jboolean checkCommandibilityGrouped){
Unit x_unit = (Unit)pointer;
Unit targetUnit = (Unit)env->GetLongField(p_targetUnit, FindCachedField(env, env->GetObjectClass(p_targetUnit), "pointer", "J"));
...
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canAttackUnitGrouped_1native__JLbwapi_Unit_2ZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_targetUnit, jboolean checkCanTargetUnit, jboolean checkCanIssueCommandType){
Unit x_unit = (Unit)pointer;
Unit targetUnit = (Unit)env->GetLongField(p_targetUnit, FindCachedField(env, env->GetObjectClass(p_targetUnit), "pointer", "J"));
return x_unit->canAttackUnitGrouped(targetUnit, (bool)checkCanTargetUnit, (bool)checkCanIssueCommandType);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canAttackUnitGrouped_1native__JLbwapi_Unit_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_targetUnit, jboolean checkCanTargetUnit){
Unit x_unit = (Unit)pointer;
Unit targetUnit = (Unit)env->GetLongField(p_targetUnit, FindCachedField(env, env->GetObjectClass(p_targetUnit), "pointer", "J"));
return x_unit->canAttackUnitGrouped(targetUnit, (bool)checkCanTargetUnit);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canAttackUnitGrouped_1native__JLbwapi_Unit_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_targetUnit){
Unit x_unit = (Unit)pointer;
Unit targetUnit = (Unit)env->GetLongField(p_targetUnit, FindCachedField(env, env->GetObjectClass(p_targetUnit), "pointer", "J"));
return x_unit->canAttackUnitGrouped(targetUnit);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canAttackUnitGrouped_1native__JLbwapi_Unit_2ZZZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_targetUnit, jboolean checkCanTargetUnit, jboolean checkCanIssueCommandType, jboolean checkCommandibilityGrouped, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
Unit targetUnit = (Unit)env->GetLongField(p_targetUnit, FindCachedField(env, env->GetObjectClass(p_targetUnit), "pointer", "J"));
...
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canBuild_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
return x_unit->canBuild();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canBuild_1native__JZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
return x_unit->canBuild((bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canBuild_1native__JLbwapi_UnitType_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_uType, jboolean checkCanIssueCommandType){
Unit x_unit = (Unit)pointer;
...
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canBuild_1native__JLbwapi_UnitType_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_uType){
Unit x_unit = (Unit)pointer;
UnitType* uType = (UnitType*)env->GetLongField(p_uType, FindCachedField(env, env->GetObjectClass(p_uType), "pointer", "J"));
return x_unit->canBuild(*uType);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canBuild_1native__JLbwapi_UnitType_2ZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_uType, jboolean checkCanIssueCommandType, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
UnitType* uType = (UnitType*)env->GetLongField(p_uType, FindCachedField(env, env->GetObjectClass(p_uType), "pointer", "J"));
return x_unit->canBuild(*uType, (bool)checkCanIssueCommandType, (bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canBuild_1native__JLbwapi_UnitType_2Lbwapi_TilePosition_2ZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_uType, jobject p_tilePos, jboolean checkTargetUnitType, jboolean checkCanIssueCommandType){
Unit x_unit = (Unit)pointer;
UnitType* uType = (UnitType*)env->GetLongField(p_uType, FindCachedField(env, env->GetObjectClass(p_uType), "pointer", "J"));
...
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canBuild_1native__JLbwapi_UnitType_2Lbwapi_TilePosition_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_uType, jobject p_tilePos, jboolean checkTargetUnitType){
Unit x_unit = (Unit)pointer;
UnitType* uType = (UnitType*)env->GetLongField(p_uType, FindCachedField(env, env->GetObjectClass(p_uType), "pointer", "J"));
TilePosition tilePos((int)env->GetIntField(p_tilePos, FindCachedField(env, env->GetObjectClass(p_tilePos), "x", "I")), (int)env->GetIntField(p_tilePos, FindCachedField(env, env->GetObjectClass(p_tilePos), "y", "I")));
return x_unit->canBuild(*uType, tilePos, (bool)checkTargetUnitType);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canBuild_1native__JLbwapi_UnitType_2Lbwapi_TilePosition_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_uType, jobject p_tilePos){
Unit x_unit = (Unit)pointer;
UnitType* uType = (UnitType*)env->GetLongField(p_uType, FindCachedField(env, env->GetObjectClass(p_uType), "pointer", "J"));
TilePosition tilePos((int)env->GetIntField(p_tilePos, FindCachedField(env, env->GetObjectClass(p_tilePos), "x", "I")), (int)env->GetIntField(p_tilePos, FindCachedField(env, env->GetObjectClass(p_tilePos), "y", "I")));
return x_unit->canBuild(*uType, tilePos);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canBuild_1native__JLbwapi_UnitType_2Lbwapi_TilePosition_2ZZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_uType, jobject p_tilePos, jboolean checkTargetUnitType, jboolean checkCanIssueCommandType, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
UnitType* uType = (UnitType*)env->GetLongField(p_uType, FindCachedField(env, env->GetObjectClass(p_uType), "pointer", "J"));
TilePosition tilePos((int)env->GetIntField(p_tilePos, FindCachedField(env, env->GetObjectClass(p_tilePos), "x", "I")), (int)env->GetIntField(p_tilePos, FindCachedField(env, env->GetObjectClass(p_tilePos), "y", "I")));
return x_unit->canBuild(*uType, tilePos, (bool)checkTargetUnitType, (bool)checkCanIssueCommandType, (bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canBuildAddon_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
return x_unit->canBuildAddon();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canBuildAddon_1native__JZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
return x_unit->canBuildAddon((bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canBuildAddon_1native__JLbwapi_UnitType_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_uType, jboolean checkCanIssueCommandType){
Unit x_unit = (Unit)pointer;
UnitType* uType = (UnitType*)env->GetLongField(p_uType, FindCachedField(env, env->GetObjectClass(p_uType), "pointer", "J"));
return x_unit->canBuildAddon(*uType, (bool)checkCanIssueCommandType);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canBuildAddon_1native__JLbwapi_UnitType_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_uType){
Unit x_unit = (Unit)pointer;
UnitType* uType = (UnitType*)env->GetLongField(p_uType, FindCachedField(env, env->GetObjectClass(p_uType), "pointer", "J"));
return x_unit->canBuildAddon(*uType);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canBuildAddon_1native__JLbwapi_UnitType_2ZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_uType, jboolean checkCanIssueCommandType, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
UnitType* uType = (UnitType*)env->GetLongField(p_uType, FindCachedField(env, env->GetObjectClass(p_uType), "pointer", "J"));
return x_unit->canBuildAddon(*uType, (bool)checkCanIssueCommandType, (bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canTrain_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
return x_unit->canTrain();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canTrain_1native__JZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
return x_unit->canTrain((bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canTrain_1native__JLbwapi_UnitType_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_uType, jboolean checkCanIssueCommandType){
Unit x_unit = (Unit)pointer;
UnitType* uType = (UnitType*)env->GetLongField(p_uType, FindCachedField(env, env->GetObjectClass(p_uType), "pointer", "J"));
return x_unit->canTrain(*uType, (bool)checkCanIssueCommandType);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canTrain_1native__JLbwapi_UnitType_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_uType){
Unit x_unit = (Unit)pointer;
UnitType* uType = (UnitType*)env->GetLongField(p_uType, FindCachedField(env, env->GetObjectClass(p_uType), "pointer", "J"));
return x_unit->canTrain(*uType);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canTrain_1native__JLbwapi_UnitType_2ZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_uType, jboolean checkCanIssueCommandType, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
UnitType* uType = (UnitType*)env->GetLongField(p_uType, FindCachedField(env, env->GetObjectClass(p_uType), "pointer", "J"));
return x_unit->canTrain(*uType, (bool)checkCanIssueCommandType, (bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canMorph_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
return x_unit->canMorph();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canMorph_1native__JZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
return x_unit->canMorph((bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canMorph_1native__JLbwapi_UnitType_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_uType, jboolean checkCanIssueCommandType){
Unit x_unit = (Unit)pointer;
UnitType* uType = (UnitType*)env->GetLongField(p_uType, FindCachedField(env, env->GetObjectClass(p_uType), "pointer", "J"));
return x_unit->canMorph(*uType, (bool)checkCanIssueCommandType);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canMorph_1native__JLbwapi_UnitType_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_uType){
Unit x_unit = (Unit)pointer;
UnitType* uType = (UnitType*)env->GetLongField(p_uType, FindCachedField(env, env->GetObjectClass(p_uType), "pointer", "J"));
return x_unit->canMorph(*uType);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canMorph_1native__JLbwapi_UnitType_2ZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_uType, jboolean checkCanIssueCommandType, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
UnitType* uType = (UnitType*)env->GetLongField(p_uType, FindCachedField(env, env->GetObjectClass(p_uType), "pointer", "J"));
return x_unit->canMorph(*uType, (bool)checkCanIssueCommandType, (bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canResearch_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
return x_unit->canResearch();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canResearch_1native__JZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
return x_unit->canResearch((bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canResearch_1native__JLbwapi_TechType_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_type){
Unit x_unit = (Unit)pointer;
TechType* type = (TechType*)env->GetLongField(p_type, FindCachedField(env, env->GetObjectClass(p_type), "pointer", "J"));
return x_unit->canResearch(*type);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canResearch_1native__JLbwapi_TechType_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_type, jboolean checkCanIssueCommandType){
Unit x_unit = (Unit)pointer;
TechType* type = (TechType*)env->GetLongField(p_type, FindCachedField(env, env->GetObjectClass(p_type), "pointer", "J"));
return x_unit->canResearch(*type, (bool)checkCanIssueCommandType);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUpgrade_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
return x_unit->canUpgrade();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUpgrade_1native__JZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
return x_unit->canUpgrade((bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUpgrade_1native__JLbwapi_UpgradeType_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_type){
Unit x_unit = (Unit)pointer;
UpgradeType* type = (UpgradeType*)env->GetLongField(p_type, FindCachedField(env, env->GetObjectClass(p_type), "pointer", "J"));
return x_unit->canUpgrade(*type);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUpgrade_1native__JLbwapi_UpgradeType_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_type, jboolean checkCanIssueCommandType){
Unit x_unit = (Unit)pointer;
UpgradeType* type = (UpgradeType*)env->GetLongField(p_type, FindCachedField(env, env->GetObjectClass(p_type), "pointer", "J"));
return x_unit->canUpgrade(*type, (bool)checkCanIssueCommandType);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canSetRallyPoint_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
return x_unit->canSetRallyPoint();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canSetRallyPoint_1native__JZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
return x_unit->canSetRallyPoint((bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canSetRallyPoint_1native__JLbwapi_Position_2ZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean checkCanTargetUnit, jboolean checkCanIssueCommandType){
Unit x_unit = (Unit)pointer;
Position target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
return x_unit->canSetRallyPoint(target, (bool)checkCanTargetUnit, (bool)checkCanIssueCommandType);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canSetRallyPoint_1native__JLbwapi_Unit_2ZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean checkCanTargetUnit, jboolean checkCanIssueCommandType){
Unit x_unit = (Unit)pointer;
Unit target = (Unit)env->GetLongField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "pointer", "J"));
return x_unit->canSetRallyPoint(target, (bool)checkCanTargetUnit, (bool)checkCanIssueCommandType);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canSetRallyPoint_1native__JLbwapi_PositionOrUnit_2ZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean checkCanTargetUnit, jboolean checkCanIssueCommandType){
Unit x_unit = (Unit)pointer;
PositionOrUnit target(convertPositionOrUnit(env, p_target ));
return x_unit->canSetRallyPoint(target, (bool)checkCanTargetUnit, (bool)checkCanIssueCommandType);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canSetRallyPoint_1native__JLbwapi_Position_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean checkCanTargetUnit){
Unit x_unit = (Unit)pointer;
Position target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
return x_unit->canSetRallyPoint(target, (bool)checkCanTargetUnit);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canSetRallyPoint_1native__JLbwapi_Unit_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean checkCanTargetUnit){
Unit x_unit = (Unit)pointer;
Unit target = (Unit)env->GetLongField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "pointer", "J"));
return x_unit->canSetRallyPoint(target, (bool)checkCanTargetUnit);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canSetRallyPoint_1native__JLbwapi_PositionOrUnit_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean checkCanTargetUnit){
Unit x_unit = (Unit)pointer;
PositionOrUnit target(convertPositionOrUnit(env, p_target ));
return x_unit->canSetRallyPoint(target, (bool)checkCanTargetUnit);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canSetRallyPoint_1native__JLbwapi_Position_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_target){
Unit x_unit = (Unit)pointer;
Position target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
return x_unit->canSetRallyPoint(target);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canSetRallyPoint_1native__JLbwapi_Unit_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_target){
Unit x_unit = (Unit)pointer;
Unit target = (Unit)env->GetLongField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "pointer", "J"));
return x_unit->canSetRallyPoint(target);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canSetRallyPoint_1native__JLbwapi_PositionOrUnit_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_target){
Unit x_unit = (Unit)pointer;
PositionOrUnit target(convertPositionOrUnit(env, p_target ));
return x_unit->canSetRallyPoint(target);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canSetRallyPoint_1native__JLbwapi_Position_2ZZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean checkCanTargetUnit, jboolean checkCanIssueCommandType, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
Position target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
return x_unit->canSetRallyPoint(target, (bool)checkCanTargetUnit, (bool)checkCanIssueCommandType, (bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canSetRallyPoint_1native__JLbwapi_Unit_2ZZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean checkCanTargetUnit, jboolean checkCanIssueCommandType, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
Unit target = (Unit)env->GetLongField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "pointer", "J"));
return x_unit->canSetRallyPoint(target, (bool)checkCanTargetUnit, (bool)checkCanIssueCommandType, (bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canSetRallyPoint_1native__JLbwapi_PositionOrUnit_2ZZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean checkCanTargetUnit, jboolean checkCanIssueCommandType, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
PositionOrUnit target(convertPositionOrUnit(env, p_target ));
return x_unit->canSetRallyPoint(target, (bool)checkCanTargetUnit, (bool)checkCanIssueCommandType, (bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canSetRallyPosition_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
return x_unit->canSetRallyPosition();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canSetRallyPosition_1native__JZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
return x_unit->canSetRallyPosition((bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canSetRallyUnit_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
return x_unit->canSetRallyUnit();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canSetRallyUnit_1native__JZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
return x_unit->canSetRallyUnit((bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canSetRallyUnit_1native__JLbwapi_Unit_2ZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_targetUnit, jboolean checkCanTargetUnit, jboolean checkCanIssueCommandType){
Unit x_unit = (Unit)pointer;
Unit targetUnit = (Unit)env->GetLongField(p_targetUnit, FindCachedField(env, env->GetObjectClass(p_targetUnit), "pointer", "J"));
return x_unit->canSetRallyUnit(targetUnit, (bool)checkCanTargetUnit, (bool)checkCanIssueCommandType);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canSetRallyUnit_1native__JLbwapi_Unit_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_targetUnit, jboolean checkCanTargetUnit){
Unit x_unit = (Unit)pointer;
Unit targetUnit = (Unit)env->GetLongField(p_targetUnit, FindCachedField(env, env->GetObjectClass(p_targetUnit), "pointer", "J"));
return x_unit->canSetRallyUnit(targetUnit, (bool)checkCanTargetUnit);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canSetRallyUnit_1native__JLbwapi_Unit_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_targetUnit){
Unit x_unit = (Unit)pointer;
Unit targetUnit = (Unit)env->GetLongField(p_targetUnit, FindCachedField(env, env->GetObjectClass(p_targetUnit), "pointer", "J"));
return x_unit->canSetRallyUnit(targetUnit);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canSetRallyUnit_1native__JLbwapi_Unit_2ZZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_targetUnit, jboolean checkCanTargetUnit, jboolean checkCanIssueCommandType, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
Unit targetUnit = (Unit)env->GetLongField(p_targetUnit, FindCachedField(env, env->GetObjectClass(p_targetUnit), "pointer", "J"));
return x_unit->canSetRallyUnit(targetUnit, (bool)checkCanTargetUnit, (bool)checkCanIssueCommandType, (bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canMove_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
return x_unit->canMove();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canMove_1native__JZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
return x_unit->canMove((bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canMoveGrouped_1native__JZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibilityGrouped){
Unit x_unit = (Unit)pointer;
return x_unit->canMoveGrouped((bool)checkCommandibilityGrouped);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canMoveGrouped_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
return x_unit->canMoveGrouped();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canMoveGrouped_1native__JZZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibilityGrouped, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
return x_unit->canMoveGrouped((bool)checkCommandibilityGrouped, (bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canPatrol_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
return x_unit->canPatrol();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canPatrol_1native__JZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
return x_unit->canPatrol((bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canPatrolGrouped_1native__JZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibilityGrouped){
Unit x_unit = (Unit)pointer;
return x_unit->canPatrolGrouped((bool)checkCommandibilityGrouped);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canPatrolGrouped_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
return x_unit->canPatrolGrouped();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canPatrolGrouped_1native__JZZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibilityGrouped, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
return x_unit->canPatrolGrouped((bool)checkCommandibilityGrouped, (bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canFollow_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
return x_unit->canFollow();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canFollow_1native__JZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
return x_unit->canFollow((bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canFollow_1native__JLbwapi_Unit_2ZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_targetUnit, jboolean checkCanTargetUnit, jboolean checkCanIssueCommandType){
Unit x_unit = (Unit)pointer;
Unit targetUnit = (Unit)env->GetLongField(p_targetUnit, FindCachedField(env, env->GetObjectClass(p_targetUnit), "pointer", "J"));
return x_unit->canFollow(targetUnit, (bool)checkCanTargetUnit, (bool)checkCanIssueCommandType);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canFollow_1native__JLbwapi_Unit_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_targetUnit, jboolean checkCanTargetUnit){
Unit x_unit = (Unit)pointer;
Unit targetUnit = (Unit)env->GetLongField(p_targetUnit, FindCachedField(env, env->GetObjectClass(p_targetUnit), "pointer", "J"));
return x_unit->canFollow(targetUnit, (bool)checkCanTargetUnit);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canFollow_1native__JLbwapi_Unit_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_targetUnit){
Unit x_unit = (Unit)pointer;
Unit targetUnit = (Unit)env->GetLongField(p_targetUnit, FindCachedField(env, env->GetObjectClass(p_targetUnit), "pointer", "J"));
return x_unit->canFollow(targetUnit);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canFollow_1native__JLbwapi_Unit_2ZZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_targetUnit, jboolean checkCanTargetUnit, jboolean checkCanIssueCommandType, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
Unit targetUnit = (Unit)env->GetLongField(p_targetUnit, FindCachedField(env, env->GetObjectClass(p_targetUnit), "pointer", "J"));
return x_unit->canFollow(targetUnit, (bool)checkCanTargetUnit, (bool)checkCanIssueCommandType, (bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canGather_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
return x_unit->canGather();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canGather_1native__JZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
return x_unit->canGather((bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canGather_1native__JLbwapi_Unit_2ZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_targetUnit, jboolean checkCanTargetUnit, jboolean checkCanIssueCommandType){
Unit x_unit = (Unit)pointer;
Unit targetUnit = (Unit)env->GetLongField(p_targetUnit, FindCachedField(env, env->GetObjectClass(p_targetUnit), "pointer", "J"));
return x_unit->canGather(targetUnit, (bool)checkCanTargetUnit, (bool)checkCanIssueCommandType);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canGather_1native__JLbwapi_Unit_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_targetUnit, jboolean checkCanTargetUnit){
Unit x_unit = (Unit)pointer;
Unit targetUnit = (Unit)env->GetLongField(p_targetUnit, FindCachedField(env, env->GetObjectClass(p_targetUnit), "pointer", "J"));
return x_unit->canGather(targetUnit, (bool)checkCanTargetUnit);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canGather_1native__JLbwapi_Unit_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_targetUnit){
Unit x_unit = (Unit)pointer;
Unit targetUnit = (Unit)env->GetLongField(p_targetUnit, FindCachedField(env, env->GetObjectClass(p_targetUnit), "pointer", "J"));
return x_unit->canGather(targetUnit);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canGather_1native__JLbwapi_Unit_2ZZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_targetUnit, jboolean checkCanTargetUnit, jboolean checkCanIssueCommandType, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
Unit targetUnit = (Unit)env->GetLongField(p_targetUnit, FindCachedField(env, env->GetObjectClass(p_targetUnit), "pointer", "J"));
return x_unit->canGather(targetUnit, (bool)checkCanTargetUnit, (bool)checkCanIssueCommandType, (bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canReturnCargo_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
return x_unit->canReturnCargo();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canReturnCargo_1native__JZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
return x_unit->canReturnCargo((bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canHoldPosition_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
return x_unit->canHoldPosition();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canHoldPosition_1native__JZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
return x_unit->canHoldPosition((bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canStop_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
return x_unit->canStop();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canStop_1native__JZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
return x_unit->canStop((bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canRepair_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
return x_unit->canRepair();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canRepair_1native__JZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
return x_unit->canRepair((bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canRepair_1native__JLbwapi_Unit_2ZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_targetUnit, jboolean checkCanTargetUnit, jboolean checkCanIssueCommandType){
Unit x_unit = (Unit)pointer;
Unit targetUnit = (Unit)env->GetLongField(p_targetUnit, FindCachedField(env, env->GetObjectClass(p_targetUnit), "pointer", "J"));
return x_unit->canRepair(targetUnit, (bool)checkCanTargetUnit, (bool)checkCanIssueCommandType);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canRepair_1native__JLbwapi_Unit_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_targetUnit, jboolean checkCanTargetUnit){
Unit x_unit = (Unit)pointer;
Unit targetUnit = (Unit)env->GetLongField(p_targetUnit, FindCachedField(env, env->GetObjectClass(p_targetUnit), "pointer", "J"));
return x_unit->canRepair(targetUnit, (bool)checkCanTargetUnit);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canRepair_1native__JLbwapi_Unit_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_targetUnit){
Unit x_unit = (Unit)pointer;
Unit targetUnit = (Unit)env->GetLongField(p_targetUnit, FindCachedField(env, env->GetObjectClass(p_targetUnit), "pointer", "J"));
return x_unit->canRepair(targetUnit);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canRepair_1native__JLbwapi_Unit_2ZZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_targetUnit, jboolean checkCanTargetUnit, jboolean checkCanIssueCommandType, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
Unit targetUnit = (Unit)env->GetLongField(p_targetUnit, FindCachedField(env, env->GetObjectClass(p_targetUnit), "pointer", "J"));
return x_unit->canRepair(targetUnit, (bool)checkCanTargetUnit, (bool)checkCanIssueCommandType, (bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canBurrow_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
return x_unit->canBurrow();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canBurrow_1native__JZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
return x_unit->canBurrow((bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUnburrow_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
return x_unit->canUnburrow();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUnburrow_1native__JZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
return x_unit->canUnburrow((bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canCloak_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
return x_unit->canCloak();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canCloak_1native__JZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
return x_unit->canCloak((bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canDecloak_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
return x_unit->canDecloak();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canDecloak_1native__JZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
return x_unit->canDecloak((bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canSiege_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
return x_unit->canSiege();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canSiege_1native__JZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
return x_unit->canSiege((bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUnsiege_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
return x_unit->canUnsiege();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUnsiege_1native__JZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
return x_unit->canUnsiege((bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canLift_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
return x_unit->canLift();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canLift_1native__JZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
return x_unit->canLift((bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canLand_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
return x_unit->canLand();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canLand_1native__JZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
return x_unit->canLand((bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canLand_1native__JLbwapi_TilePosition_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean checkCanIssueCommandType){
Unit x_unit = (Unit)pointer;
TilePosition target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
return x_unit->canLand(target, (bool)checkCanIssueCommandType);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canLand_1native__JLbwapi_TilePosition_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_target){
Unit x_unit = (Unit)pointer;
TilePosition target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
return x_unit->canLand(target);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canLand_1native__JLbwapi_TilePosition_2ZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean checkCanIssueCommandType, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
TilePosition target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
return x_unit->canLand(target, (bool)checkCanIssueCommandType, (bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canLoad_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
return x_unit->canLoad();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canLoad_1native__JZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
return x_unit->canLoad((bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canLoad_1native__JLbwapi_Unit_2ZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_targetUnit, jboolean checkCanTargetUnit, jboolean checkCanIssueCommandType){
Unit x_unit = (Unit)pointer;
Unit targetUnit = (Unit)env->GetLongField(p_targetUnit, FindCachedField(env, env->GetObjectClass(p_targetUnit), "pointer", "J"));
return x_unit->canLoad(targetUnit, (bool)checkCanTargetUnit, (bool)checkCanIssueCommandType);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canLoad_1native__JLbwapi_Unit_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_targetUnit, jboolean checkCanTargetUnit){
Unit x_unit = (Unit)pointer;
Unit targetUnit = (Unit)env->GetLongField(p_targetUnit, FindCachedField(env, env->GetObjectClass(p_targetUnit), "pointer", "J"));
return x_unit->canLoad(targetUnit, (bool)checkCanTargetUnit);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canLoad_1native__JLbwapi_Unit_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_targetUnit){
Unit x_unit = (Unit)pointer;
Unit targetUnit = (Unit)env->GetLongField(p_targetUnit, FindCachedField(env, env->GetObjectClass(p_targetUnit), "pointer", "J"));
return x_unit->canLoad(targetUnit);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canLoad_1native__JLbwapi_Unit_2ZZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_targetUnit, jboolean checkCanTargetUnit, jboolean checkCanIssueCommandType, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
Unit targetUnit = (Unit)env->GetLongField(p_targetUnit, FindCachedField(env, env->GetObjectClass(p_targetUnit), "pointer", "J"));
return x_unit->canLoad(targetUnit, (bool)checkCanTargetUnit, (bool)checkCanIssueCommandType, (bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUnloadWithOrWithoutTarget_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
return x_unit->canUnloadWithOrWithoutTarget();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUnloadWithOrWithoutTarget_1native__JZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
return x_unit->canUnloadWithOrWithoutTarget((bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUnloadAtPosition_1native__JLbwapi_Position_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_targDropPos, jboolean checkCanIssueCommandType){
Unit x_unit = (Unit)pointer;
...
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUnloadAtPosition_1native__JLbwapi_Position_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_targDropPos){
Unit x_unit = (Unit)pointer;
Position targDropPos((int)env->GetIntField(p_targDropPos, FindCachedField(env, env->GetObjectClass(p_targDropPos), "x", "I")), (int)env->GetIntField(p_targDropPos, FindCachedField(env, env->GetObjectClass(p_targDropPos), "y", "I")));
return x_unit->canUnloadAtPosition(targDropPos);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUnloadAtPosition_1native__JLbwapi_Position_2ZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_targDropPos, jboolean checkCanIssueCommandType, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
Position targDropPos((int)env->GetIntField(p_targDropPos, FindCachedField(env, env->GetObjectClass(p_targDropPos), "x", "I")), (int)env->GetIntField(p_targDropPos, FindCachedField(env, env->GetObjectClass(p_targDropPos), "y", "I")));
return x_unit->canUnloadAtPosition(targDropPos, (bool)checkCanIssueCommandType, (bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUnload_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
return x_unit->canUnload();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUnload_1native__JZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
return x_unit->canUnload((bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUnload_1native__JLbwapi_Unit_2ZZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_targetUnit, jboolean checkCanTargetUnit, jboolean checkPosition, jboolean checkCanIssueCommandType){
Unit x_unit = (Unit)pointer;
Unit targetUnit = (Unit)env->GetLongField(p_targetUnit, FindCachedField(env, env->GetObjectClass(p_targetUnit), "pointer", "J"));
return x_unit->canUnload(targetUnit, (bool)checkCanTargetUnit, (bool)checkPosition, (bool)checkCanIssueCommandType);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUnload_1native__JLbwapi_Unit_2ZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_targetUnit, jboolean checkCanTargetUnit, jboolean checkPosition){
Unit x_unit = (Unit)pointer;
Unit targetUnit = (Unit)env->GetLongField(p_targetUnit, FindCachedField(env, env->GetObjectClass(p_targetUnit), "pointer", "J"));
return x_unit->canUnload(targetUnit, (bool)checkCanTargetUnit, (bool)checkPosition);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUnload_1native__JLbwapi_Unit_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_targetUnit, jboolean checkCanTargetUnit){
Unit x_unit = (Unit)pointer;
Unit targetUnit = (Unit)env->GetLongField(p_targetUnit, FindCachedField(env, env->GetObjectClass(p_targetUnit), "pointer", "J"));
return x_unit->canUnload(targetUnit, (bool)checkCanTargetUnit);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUnload_1native__JLbwapi_Unit_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_targetUnit){
Unit x_unit = (Unit)pointer;
Unit targetUnit = (Unit)env->GetLongField(p_targetUnit, FindCachedField(env, env->GetObjectClass(p_targetUnit), "pointer", "J"));
return x_unit->canUnload(targetUnit);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUnload_1native__JLbwapi_Unit_2ZZZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_targetUnit, jboolean checkCanTargetUnit, jboolean checkPosition, jboolean checkCanIssueCommandType, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
Unit targetUnit = (Unit)env->GetLongField(p_targetUnit, FindCachedField(env, env->GetObjectClass(p_targetUnit), "pointer", "J"));
...
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUnloadAll_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
return x_unit->canUnloadAll();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUnloadAll_1native__JZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
return x_unit->canUnloadAll((bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUnloadAllPosition_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
return x_unit->canUnloadAllPosition();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUnloadAllPosition_1native__JZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
return x_unit->canUnloadAllPosition((bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUnloadAllPosition_1native__JLbwapi_Position_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_targDropPos, jboolean checkCanIssueCommandType){
Unit x_unit = (Unit)pointer;
Position targDropPos((int)env->GetIntField(p_targDropPos, FindCachedField(env, env->GetObjectClass(p_targDropPos), "x", "I")), (int)env->GetIntField(p_targDropPos, FindCachedField(env, env->GetObjectClass(p_targDropPos), "y", "I")));
return x_unit->canUnloadAllPosition(targDropPos, (bool)checkCanIssueCommandType);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUnloadAllPosition_1native__JLbwapi_Position_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_targDropPos){
Unit x_unit = (Unit)pointer;
Position targDropPos((int)env->GetIntField(p_targDropPos, FindCachedField(env, env->GetObjectClass(p_targDropPos), "x", "I")), (int)env->GetIntField(p_targDropPos, FindCachedField(env, env->GetObjectClass(p_targDropPos), "y", "I")));
return x_unit->canUnloadAllPosition(targDropPos);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUnloadAllPosition_1native__JLbwapi_Position_2ZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_targDropPos, jboolean checkCanIssueCommandType, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
Position targDropPos((int)env->GetIntField(p_targDropPos, FindCachedField(env, env->GetObjectClass(p_targDropPos), "x", "I")), (int)env->GetIntField(p_targDropPos, FindCachedField(env, env->GetObjectClass(p_targDropPos), "y", "I")));
return x_unit->canUnloadAllPosition(targDropPos, (bool)checkCanIssueCommandType, (bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canRightClick_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
return x_unit->canRightClick();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canRightClick_1native__JZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
return x_unit->canRightClick((bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canRightClick_1native__JLbwapi_Position_2ZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean checkCanTargetUnit, jboolean checkCanIssueCommandType){
Unit x_unit = (Unit)pointer;
Position target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
return x_unit->canRightClick(target, (bool)checkCanTargetUnit, (bool)checkCanIssueCommandType);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canRightClick_1native__JLbwapi_Unit_2ZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean checkCanTargetUnit, jboolean checkCanIssueCommandType){
Unit x_unit = (Unit)pointer;
Unit target = (Unit)env->GetLongField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "pointer", "J"));
return x_unit->canRightClick(target, (bool)checkCanTargetUnit, (bool)checkCanIssueCommandType);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canRightClick_1native__JLbwapi_PositionOrUnit_2ZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean checkCanTargetUnit, jboolean checkCanIssueCommandType){
Unit x_unit = (Unit)pointer;
PositionOrUnit target(convertPositionOrUnit(env, p_target ));
return x_unit->canRightClick(target, (bool)checkCanTargetUnit, (bool)checkCanIssueCommandType);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canRightClick_1native__JLbwapi_Position_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean checkCanTargetUnit){
Unit x_unit = (Unit)pointer;
Position target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
return x_unit->canRightClick(target, (bool)checkCanTargetUnit);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canRightClick_1native__JLbwapi_Unit_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean checkCanTargetUnit){
Unit x_unit = (Unit)pointer;
Unit target = (Unit)env->GetLongField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "pointer", "J"));
return x_unit->canRightClick(target, (bool)checkCanTargetUnit);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canRightClick_1native__JLbwapi_PositionOrUnit_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean checkCanTargetUnit){
Unit x_unit = (Unit)pointer;
PositionOrUnit target(convertPositionOrUnit(env, p_target ));
return x_unit->canRightClick(target, (bool)checkCanTargetUnit);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canRightClick_1native__JLbwapi_Position_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_target){
Unit x_unit = (Unit)pointer;
Position target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
return x_unit->canRightClick(target);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canRightClick_1native__JLbwapi_Unit_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_target){
Unit x_unit = (Unit)pointer;
Unit target = (Unit)env->GetLongField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "pointer", "J"));
return x_unit->canRightClick(target);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canRightClick_1native__JLbwapi_PositionOrUnit_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_target){
Unit x_unit = (Unit)pointer;
PositionOrUnit target(convertPositionOrUnit(env, p_target ));
return x_unit->canRightClick(target);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canRightClick_1native__JLbwapi_Position_2ZZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean checkCanTargetUnit, jboolean checkCanIssueCommandType, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
Position target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
return x_unit->canRightClick(target, (bool)checkCanTargetUnit, (bool)checkCanIssueCommandType, (bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canRightClick_1native__JLbwapi_Unit_2ZZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean checkCanTargetUnit, jboolean checkCanIssueCommandType, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
Unit target = (Unit)env->GetLongField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "pointer", "J"));
return x_unit->canRightClick(target, (bool)checkCanTargetUnit, (bool)checkCanIssueCommandType, (bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canRightClick_1native__JLbwapi_PositionOrUnit_2ZZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean checkCanTargetUnit, jboolean checkCanIssueCommandType, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
PositionOrUnit target(convertPositionOrUnit(env, p_target ));
return x_unit->canRightClick(target, (bool)checkCanTargetUnit, (bool)checkCanIssueCommandType, (bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canRightClickGrouped_1native__JZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibilityGrouped){
Unit x_unit = (Unit)pointer;
return x_unit->canRightClickGrouped((bool)checkCommandibilityGrouped);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canRightClickGrouped_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
return x_unit->canRightClickGrouped();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canRightClickGrouped_1native__JZZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibilityGrouped, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
return x_unit->canRightClickGrouped((bool)checkCommandibilityGrouped, (bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canRightClickGrouped_1native__JLbwapi_Position_2ZZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean checkCanTargetUnit, jboolean checkCanIssueCommandType, jboolean checkCommandibilityGrouped){
Unit x_unit = (Unit)pointer;
Position target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
...
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canRightClickGrouped_1native__JLbwapi_Unit_2ZZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean checkCanTargetUnit, jboolean checkCanIssueCommandType, jboolean checkCommandibilityGrouped){
Unit x_unit = (Unit)pointer;
Unit target = (Unit)env->GetLongField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "pointer", "J"));
return x_unit->canRightClickGrouped(target, (bool)checkCanTargetUnit, (bool)checkCanIssueCommandType, (bool)checkCommandibilityGrouped);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canRightClickGrouped_1native__JLbwapi_PositionOrUnit_2ZZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean checkCanTargetUnit, jboolean checkCanIssueCommandType, jboolean checkCommandibilityGrouped){
Unit x_unit = (Unit)pointer;
PositionOrUnit target(convertPositionOrUnit(env, p_target ));
return x_unit->canRightClickGrouped(target, (bool)checkCanTargetUnit, (bool)checkCanIssueCommandType, (bool)checkCommandibilityGrouped);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canRightClickGrouped_1native__JLbwapi_Position_2ZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean checkCanTargetUnit, jboolean checkCanIssueCommandType){
Unit x_unit = (Unit)pointer;
Position target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
return x_unit->canRightClickGrouped(target, (bool)checkCanTargetUnit, (bool)checkCanIssueCommandType);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canRightClickGrouped_1native__JLbwapi_Unit_2ZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean checkCanTargetUnit, jboolean checkCanIssueCommandType){
Unit x_unit = (Unit)pointer;
Unit target = (Unit)env->GetLongField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "pointer", "J"));
return x_unit->canRightClickGrouped(target, (bool)checkCanTargetUnit, (bool)checkCanIssueCommandType);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canRightClickGrouped_1native__JLbwapi_PositionOrUnit_2ZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean checkCanTargetUnit, jboolean checkCanIssueCommandType){
Unit x_unit = (Unit)pointer;
PositionOrUnit target(convertPositionOrUnit(env, p_target ));
return x_unit->canRightClickGrouped(target, (bool)checkCanTargetUnit, (bool)checkCanIssueCommandType);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canRightClickGrouped_1native__JLbwapi_Position_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean checkCanTargetUnit){
Unit x_unit = (Unit)pointer;
Position target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
return x_unit->canRightClickGrouped(target, (bool)checkCanTargetUnit);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canRightClickGrouped_1native__JLbwapi_Unit_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean checkCanTargetUnit){
Unit x_unit = (Unit)pointer;
Unit target = (Unit)env->GetLongField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "pointer", "J"));
return x_unit->canRightClickGrouped(target, (bool)checkCanTargetUnit);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canRightClickGrouped_1native__JLbwapi_PositionOrUnit_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean checkCanTargetUnit){
Unit x_unit = (Unit)pointer;
PositionOrUnit target(convertPositionOrUnit(env, p_target ));
return x_unit->canRightClickGrouped(target, (bool)checkCanTargetUnit);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canRightClickGrouped_1native__JLbwapi_Position_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_target){
Unit x_unit = (Unit)pointer;
Position target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
return x_unit->canRightClickGrouped(target);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canRightClickGrouped_1native__JLbwapi_Unit_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_target){
Unit x_unit = (Unit)pointer;
Unit target = (Unit)env->GetLongField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "pointer", "J"));
return x_unit->canRightClickGrouped(target);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canRightClickGrouped_1native__JLbwapi_PositionOrUnit_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_target){
Unit x_unit = (Unit)pointer;
PositionOrUnit target(convertPositionOrUnit(env, p_target ));
return x_unit->canRightClickGrouped(target);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canRightClickGrouped_1native__JLbwapi_Position_2ZZZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean checkCanTargetUnit, jboolean checkCanIssueCommandType, jboolean checkCommandibilityGrouped, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
Position target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
...
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canRightClickGrouped_1native__JLbwapi_Unit_2ZZZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean checkCanTargetUnit, jboolean checkCanIssueCommandType, jboolean checkCommandibilityGrouped, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
Unit target = (Unit)env->GetLongField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "pointer", "J"));
return x_unit->canRightClickGrouped(target, (bool)checkCanTargetUnit, (bool)checkCanIssueCommandType, (bool)checkCommandibilityGrouped, (bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canRightClickGrouped_1native__JLbwapi_PositionOrUnit_2ZZZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean checkCanTargetUnit, jboolean checkCanIssueCommandType, jboolean checkCommandibilityGrouped, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
PositionOrUnit target(convertPositionOrUnit(env, p_target ));
return x_unit->canRightClickGrouped(target, (bool)checkCanTargetUnit, (bool)checkCanIssueCommandType, (bool)checkCommandibilityGrouped, (bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canRightClickPosition_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
return x_unit->canRightClickPosition();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canRightClickPosition_1native__JZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
return x_unit->canRightClickPosition((bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canRightClickPositionGrouped_1native__JZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibilityGrouped){
Unit x_unit = (Unit)pointer;
return x_unit->canRightClickPositionGrouped((bool)checkCommandibilityGrouped);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canRightClickPositionGrouped_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
return x_unit->canRightClickPositionGrouped();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canRightClickPositionGrouped_1native__JZZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibilityGrouped, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
return x_unit->canRightClickPositionGrouped((bool)checkCommandibilityGrouped, (bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canRightClickUnit_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
return x_unit->canRightClickUnit();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canRightClickUnit_1native__JZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
return x_unit->canRightClickUnit((bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canRightClickUnit_1native__JLbwapi_Unit_2ZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_targetUnit, jboolean checkCanTargetUnit, jboolean checkCanIssueCommandType){
Unit x_unit = (Unit)pointer;
Unit targetUnit = (Unit)env->GetLongField(p_targetUnit, FindCachedField(env, env->GetObjectClass(p_targetUnit), "pointer", "J"));
return x_unit->canRightClickUnit(targetUnit, (bool)checkCanTargetUnit, (bool)checkCanIssueCommandType);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canRightClickUnit_1native__JLbwapi_Unit_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_targetUnit, jboolean checkCanTargetUnit){
Unit x_unit = (Unit)pointer;
Unit targetUnit = (Unit)env->GetLongField(p_targetUnit, FindCachedField(env, env->GetObjectClass(p_targetUnit), "pointer", "J"));
return x_unit->canRightClickUnit(targetUnit, (bool)checkCanTargetUnit);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canRightClickUnit_1native__JLbwapi_Unit_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_targetUnit){
Unit x_unit = (Unit)pointer;
Unit targetUnit = (Unit)env->GetLongField(p_targetUnit, FindCachedField(env, env->GetObjectClass(p_targetUnit), "pointer", "J"));
return x_unit->canRightClickUnit(targetUnit);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canRightClickUnit_1native__JLbwapi_Unit_2ZZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_targetUnit, jboolean checkCanTargetUnit, jboolean checkCanIssueCommandType, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
Unit targetUnit = (Unit)env->GetLongField(p_targetUnit, FindCachedField(env, env->GetObjectClass(p_targetUnit), "pointer", "J"));
...
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canRightClickUnitGrouped_1native__JZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibilityGrouped){
Unit x_unit = (Unit)pointer;
return x_unit->canRightClickUnitGrouped((bool)checkCommandibilityGrouped);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canRightClickUnitGrouped_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
return x_unit->canRightClickUnitGrouped();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canRightClickUnitGrouped_1native__JZZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibilityGrouped, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
return x_unit->canRightClickUnitGrouped((bool)checkCommandibilityGrouped, (bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canRightClickUnitGrouped_1native__JLbwapi_Unit_2ZZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_targetUnit, jboolean checkCanTargetUnit, jboolean checkCanIssueCommandType, jboolean checkCommandibilityGrouped){
Unit x_unit = (Unit)pointer;
Unit targetUnit = (Unit)env->GetLongField(p_targetUnit, FindCachedField(env, env->GetObjectClass(p_targetUnit), "pointer", "J"));
...
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canRightClickUnitGrouped_1native__JLbwapi_Unit_2ZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_targetUnit, jboolean checkCanTargetUnit, jboolean checkCanIssueCommandType){
Unit x_unit = (Unit)pointer;
Unit targetUnit = (Unit)env->GetLongField(p_targetUnit, FindCachedField(env, env->GetObjectClass(p_targetUnit), "pointer", "J"));
return x_unit->canRightClickUnitGrouped(targetUnit, (bool)checkCanTargetUnit, (bool)checkCanIssueCommandType);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canRightClickUnitGrouped_1native__JLbwapi_Unit_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_targetUnit, jboolean checkCanTargetUnit){
Unit x_unit = (Unit)pointer;
Unit targetUnit = (Unit)env->GetLongField(p_targetUnit, FindCachedField(env, env->GetObjectClass(p_targetUnit), "pointer", "J"));
return x_unit->canRightClickUnitGrouped(targetUnit, (bool)checkCanTargetUnit);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canRightClickUnitGrouped_1native__JLbwapi_Unit_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_targetUnit){
Unit x_unit = (Unit)pointer;
Unit targetUnit = (Unit)env->GetLongField(p_targetUnit, FindCachedField(env, env->GetObjectClass(p_targetUnit), "pointer", "J"));
return x_unit->canRightClickUnitGrouped(targetUnit);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canRightClickUnitGrouped_1native__JLbwapi_Unit_2ZZZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_targetUnit, jboolean checkCanTargetUnit, jboolean checkCanIssueCommandType, jboolean checkCommandibilityGrouped, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
Unit targetUnit = (Unit)env->GetLongField(p_targetUnit, FindCachedField(env, env->GetObjectClass(p_targetUnit), "pointer", "J"));
...
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canHaltConstruction_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
return x_unit->canHaltConstruction();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canHaltConstruction_1native__JZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
return x_unit->canHaltConstruction((bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canCancelConstruction_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
return x_unit->canCancelConstruction();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canCancelConstruction_1native__JZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
return x_unit->canCancelConstruction((bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canCancelAddon_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
return x_unit->canCancelAddon();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canCancelAddon_1native__JZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
return x_unit->canCancelAddon((bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canCancelTrain_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
return x_unit->canCancelTrain();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canCancelTrain_1native__JZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
return x_unit->canCancelTrain((bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canCancelTrainSlot_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
return x_unit->canCancelTrainSlot();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canCancelTrainSlot_1native__JZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
return x_unit->canCancelTrainSlot((bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canCancelTrainSlot_1native__JIZ(JNIEnv * env, jobject obj, jlong pointer, jint slot, jboolean checkCanIssueCommandType){
Unit x_unit = (Unit)pointer;
return x_unit->canCancelTrainSlot(slot, (bool)checkCanIssueCommandType);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canCancelTrainSlot_1native__JI(JNIEnv * env, jobject obj, jlong pointer, jint slot){
Unit x_unit = (Unit)pointer;
return x_unit->canCancelTrainSlot(slot);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canCancelTrainSlot_1native__JIZZ(JNIEnv * env, jobject obj, jlong pointer, jint slot, jboolean checkCanIssueCommandType, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
return x_unit->canCancelTrainSlot(slot, (bool)checkCanIssueCommandType, (bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canCancelMorph_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
return x_unit->canCancelMorph();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canCancelMorph_1native__JZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
return x_unit->canCancelMorph((bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canCancelResearch_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
return x_unit->canCancelResearch();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canCancelResearch_1native__JZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
return x_unit->canCancelResearch((bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canCancelUpgrade_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
return x_unit->canCancelUpgrade();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canCancelUpgrade_1native__JZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
return x_unit->canCancelUpgrade((bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUseTechWithOrWithoutTarget_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
return x_unit->canUseTechWithOrWithoutTarget();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUseTechWithOrWithoutTarget_1native__JZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
return x_unit->canUseTechWithOrWithoutTarget((bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUseTechWithOrWithoutTarget_1native__JLbwapi_TechType_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_tech, jboolean checkCanIssueCommandType){
Unit x_unit = (Unit)pointer;
TechType* tech = (TechType*)env->GetLongField(p_tech, FindCachedField(env, env->GetObjectClass(p_tech), "pointer", "J"));
return x_unit->canUseTechWithOrWithoutTarget(*tech, (bool)checkCanIssueCommandType);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUseTechWithOrWithoutTarget_1native__JLbwapi_TechType_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_tech){
Unit x_unit = (Unit)pointer;
TechType* tech = (TechType*)env->GetLongField(p_tech, FindCachedField(env, env->GetObjectClass(p_tech), "pointer", "J"));
return x_unit->canUseTechWithOrWithoutTarget(*tech);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUseTechWithOrWithoutTarget_1native__JLbwapi_TechType_2ZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_tech, jboolean checkCanIssueCommandType, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
TechType* tech = (TechType*)env->GetLongField(p_tech, FindCachedField(env, env->GetObjectClass(p_tech), "pointer", "J"));
return x_unit->canUseTechWithOrWithoutTarget(*tech, (bool)checkCanIssueCommandType, (bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUseTech_1native__JLbwapi_TechType_2Lbwapi_Position_2ZZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_tech, jobject p_target, jboolean checkCanTargetUnit, jboolean checkTargetsType, jboolean checkCanIssueCommandType){
Unit x_unit = (Unit)pointer;
TechType* tech = (TechType*)env->GetLongField(p_tech, FindCachedField(env, env->GetObjectClass(p_tech), "pointer", "J"));
Position target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
return x_unit->canUseTech(*tech, target, (bool)checkCanTargetUnit, (bool)checkTargetsType, (bool)checkCanIssueCommandType);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUseTech_1native__JLbwapi_TechType_2Lbwapi_Unit_2ZZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_tech, jobject p_target, jboolean checkCanTargetUnit, jboolean checkTargetsType, jboolean checkCanIssueCommandType){
Unit x_unit = (Unit)pointer;
TechType* tech = (TechType*)env->GetLongField(p_tech, FindCachedField(env, env->GetObjectClass(p_tech), "pointer", "J"));
Unit target = (Unit)env->GetLongField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "pointer", "J"));
return x_unit->canUseTech(*tech, target, (bool)checkCanTargetUnit, (bool)checkTargetsType, (bool)checkCanIssueCommandType);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUseTech_1native__JLbwapi_TechType_2Lbwapi_PositionOrUnit_2ZZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_tech, jobject p_target, jboolean checkCanTargetUnit, jboolean checkTargetsType, jboolean checkCanIssueCommandType){
Unit x_unit = (Unit)pointer;
TechType* tech = (TechType*)env->GetLongField(p_tech, FindCachedField(env, env->GetObjectClass(p_tech), "pointer", "J"));
PositionOrUnit target(convertPositionOrUnit(env, p_target ));
return x_unit->canUseTech(*tech, target, (bool)checkCanTargetUnit, (bool)checkTargetsType, (bool)checkCanIssueCommandType);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUseTech_1native__JLbwapi_TechType_2Lbwapi_Position_2ZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_tech, jobject p_target, jboolean checkCanTargetUnit, jboolean checkTargetsType){
Unit x_unit = (Unit)pointer;
TechType* tech = (TechType*)env->GetLongField(p_tech, FindCachedField(env, env->GetObjectClass(p_tech), "pointer", "J"));
Position target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
return x_unit->canUseTech(*tech, target, (bool)checkCanTargetUnit, (bool)checkTargetsType);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUseTech_1native__JLbwapi_TechType_2Lbwapi_Unit_2ZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_tech, jobject p_target, jboolean checkCanTargetUnit, jboolean checkTargetsType){
Unit x_unit = (Unit)pointer;
TechType* tech = (TechType*)env->GetLongField(p_tech, FindCachedField(env, env->GetObjectClass(p_tech), "pointer", "J"));
Unit target = (Unit)env->GetLongField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "pointer", "J"));
return x_unit->canUseTech(*tech, target, (bool)checkCanTargetUnit, (bool)checkTargetsType);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUseTech_1native__JLbwapi_TechType_2Lbwapi_PositionOrUnit_2ZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_tech, jobject p_target, jboolean checkCanTargetUnit, jboolean checkTargetsType){
Unit x_unit = (Unit)pointer;
TechType* tech = (TechType*)env->GetLongField(p_tech, FindCachedField(env, env->GetObjectClass(p_tech), "pointer", "J"));
PositionOrUnit target(convertPositionOrUnit(env, p_target ));
return x_unit->canUseTech(*tech, target, (bool)checkCanTargetUnit, (bool)checkTargetsType);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUseTech_1native__JLbwapi_TechType_2Lbwapi_Position_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_tech, jobject p_target, jboolean checkCanTargetUnit){
Unit x_unit = (Unit)pointer;
TechType* tech = (TechType*)env->GetLongField(p_tech, FindCachedField(env, env->GetObjectClass(p_tech), "pointer", "J"));
Position target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
return x_unit->canUseTech(*tech, target, (bool)checkCanTargetUnit);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUseTech_1native__JLbwapi_TechType_2Lbwapi_Unit_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_tech, jobject p_target, jboolean checkCanTargetUnit){
Unit x_unit = (Unit)pointer;
TechType* tech = (TechType*)env->GetLongField(p_tech, FindCachedField(env, env->GetObjectClass(p_tech), "pointer", "J"));
Unit target = (Unit)env->GetLongField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "pointer", "J"));
return x_unit->canUseTech(*tech, target, (bool)checkCanTargetUnit);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUseTech_1native__JLbwapi_TechType_2Lbwapi_PositionOrUnit_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_tech, jobject p_target, jboolean checkCanTargetUnit){
Unit x_unit = (Unit)pointer;
TechType* tech = (TechType*)env->GetLongField(p_tech, FindCachedField(env, env->GetObjectClass(p_tech), "pointer", "J"));
PositionOrUnit target(convertPositionOrUnit(env, p_target ));
return x_unit->canUseTech(*tech, target, (bool)checkCanTargetUnit);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUseTech_1native__JLbwapi_TechType_2Lbwapi_Position_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_tech, jobject p_target){
Unit x_unit = (Unit)pointer;
TechType* tech = (TechType*)env->GetLongField(p_tech, FindCachedField(env, env->GetObjectClass(p_tech), "pointer", "J"));
Position target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
return x_unit->canUseTech(*tech, target);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUseTech_1native__JLbwapi_TechType_2Lbwapi_Unit_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_tech, jobject p_target){
Unit x_unit = (Unit)pointer;
TechType* tech = (TechType*)env->GetLongField(p_tech, FindCachedField(env, env->GetObjectClass(p_tech), "pointer", "J"));
Unit target = (Unit)env->GetLongField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "pointer", "J"));
return x_unit->canUseTech(*tech, target);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUseTech_1native__JLbwapi_TechType_2Lbwapi_PositionOrUnit_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_tech, jobject p_target){
Unit x_unit = (Unit)pointer;
TechType* tech = (TechType*)env->GetLongField(p_tech, FindCachedField(env, env->GetObjectClass(p_tech), "pointer", "J"));
PositionOrUnit target(convertPositionOrUnit(env, p_target ));
return x_unit->canUseTech(*tech, target);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUseTech_1native__JLbwapi_TechType_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_tech){
Unit x_unit = (Unit)pointer;
TechType* tech = (TechType*)env->GetLongField(p_tech, FindCachedField(env, env->GetObjectClass(p_tech), "pointer", "J"));
return x_unit->canUseTech(*tech);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUseTech_1native__JLbwapi_TechType_2Lbwapi_Position_2ZZZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_tech, jobject p_target, jboolean checkCanTargetUnit, jboolean checkTargetsType, jboolean checkCanIssueCommandType, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
TechType* tech = (TechType*)env->GetLongField(p_tech, FindCachedField(env, env->GetObjectClass(p_tech), "pointer", "J"));
Position target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
...
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUseTech_1native__JLbwapi_TechType_2Lbwapi_Unit_2ZZZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_tech, jobject p_target, jboolean checkCanTargetUnit, jboolean checkTargetsType, jboolean checkCanIssueCommandType, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
TechType* tech = (TechType*)env->GetLongField(p_tech, FindCachedField(env, env->GetObjectClass(p_tech), "pointer", "J"));
Unit target = (Unit)env->GetLongField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "pointer", "J"));
return x_unit->canUseTech(*tech, target, (bool)checkCanTargetUnit, (bool)checkTargetsType, (bool)checkCanIssueCommandType, (bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUseTech_1native__JLbwapi_TechType_2Lbwapi_PositionOrUnit_2ZZZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_tech, jobject p_target, jboolean checkCanTargetUnit, jboolean checkTargetsType, jboolean checkCanIssueCommandType, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
TechType* tech = (TechType*)env->GetLongField(p_tech, FindCachedField(env, env->GetObjectClass(p_tech), "pointer", "J"));
PositionOrUnit target(convertPositionOrUnit(env, p_target ));
return x_unit->canUseTech(*tech, target, (bool)checkCanTargetUnit, (bool)checkTargetsType, (bool)checkCanIssueCommandType, (bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUseTechWithoutTarget_1native__JLbwapi_TechType_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_tech, jboolean checkCanIssueCommandType){
Unit x_unit = (Unit)pointer;
TechType* tech = (TechType*)env->GetLongField(p_tech, FindCachedField(env, env->GetObjectClass(p_tech), "pointer", "J"));
return x_unit->canUseTechWithoutTarget(*tech, (bool)checkCanIssueCommandType);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUseTechWithoutTarget_1native__JLbwapi_TechType_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_tech){
Unit x_unit = (Unit)pointer;
TechType* tech = (TechType*)env->GetLongField(p_tech, FindCachedField(env, env->GetObjectClass(p_tech), "pointer", "J"));
return x_unit->canUseTechWithoutTarget(*tech);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUseTechWithoutTarget_1native__JLbwapi_TechType_2ZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_tech, jboolean checkCanIssueCommandType, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
TechType* tech = (TechType*)env->GetLongField(p_tech, FindCachedField(env, env->GetObjectClass(p_tech), "pointer", "J"));
return x_unit->canUseTechWithoutTarget(*tech, (bool)checkCanIssueCommandType, (bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUseTechUnit_1native__JLbwapi_TechType_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_tech, jboolean checkCanIssueCommandType){
Unit x_unit = (Unit)pointer;
TechType* tech = (TechType*)env->GetLongField(p_tech, FindCachedField(env, env->GetObjectClass(p_tech), "pointer", "J"));
return x_unit->canUseTechUnit(*tech, (bool)checkCanIssueCommandType);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUseTechUnit_1native__JLbwapi_TechType_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_tech){
Unit x_unit = (Unit)pointer;
TechType* tech = (TechType*)env->GetLongField(p_tech, FindCachedField(env, env->GetObjectClass(p_tech), "pointer", "J"));
return x_unit->canUseTechUnit(*tech);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUseTechUnit_1native__JLbwapi_TechType_2ZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_tech, jboolean checkCanIssueCommandType, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
TechType* tech = (TechType*)env->GetLongField(p_tech, FindCachedField(env, env->GetObjectClass(p_tech), "pointer", "J"));
return x_unit->canUseTechUnit(*tech, (bool)checkCanIssueCommandType, (bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUseTechUnit_1native__JLbwapi_TechType_2Lbwapi_Unit_2ZZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_tech, jobject p_targetUnit, jboolean checkCanTargetUnit, jboolean checkTargetsUnits, jboolean checkCanIssueCommandType){
Unit x_unit = (Unit)pointer;
TechType* tech = (TechType*)env->GetLongField(p_tech, FindCachedField(env, env->GetObjectClass(p_tech), "pointer", "J"));
Unit targetUnit = (Unit)env->GetLongField(p_targetUnit, FindCachedField(env, env->GetObjectClass(p_targetUnit), "pointer", "J"));
...
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUseTechUnit_1native__JLbwapi_TechType_2Lbwapi_Unit_2ZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_tech, jobject p_targetUnit, jboolean checkCanTargetUnit, jboolean checkTargetsUnits){
Unit x_unit = (Unit)pointer;
TechType* tech = (TechType*)env->GetLongField(p_tech, FindCachedField(env, env->GetObjectClass(p_tech), "pointer", "J"));
Unit targetUnit = (Unit)env->GetLongField(p_targetUnit, FindCachedField(env, env->GetObjectClass(p_targetUnit), "pointer", "J"));
return x_unit->canUseTechUnit(*tech, targetUnit, (bool)checkCanTargetUnit, (bool)checkTargetsUnits);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUseTechUnit_1native__JLbwapi_TechType_2Lbwapi_Unit_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_tech, jobject p_targetUnit, jboolean checkCanTargetUnit){
Unit x_unit = (Unit)pointer;
TechType* tech = (TechType*)env->GetLongField(p_tech, FindCachedField(env, env->GetObjectClass(p_tech), "pointer", "J"));
Unit targetUnit = (Unit)env->GetLongField(p_targetUnit, FindCachedField(env, env->GetObjectClass(p_targetUnit), "pointer", "J"));
return x_unit->canUseTechUnit(*tech, targetUnit, (bool)checkCanTargetUnit);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUseTechUnit_1native__JLbwapi_TechType_2Lbwapi_Unit_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_tech, jobject p_targetUnit){
Unit x_unit = (Unit)pointer;
TechType* tech = (TechType*)env->GetLongField(p_tech, FindCachedField(env, env->GetObjectClass(p_tech), "pointer", "J"));
Unit targetUnit = (Unit)env->GetLongField(p_targetUnit, FindCachedField(env, env->GetObjectClass(p_targetUnit), "pointer", "J"));
return x_unit->canUseTechUnit(*tech, targetUnit);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUseTechUnit_1native__JLbwapi_TechType_2Lbwapi_Unit_2ZZZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_tech, jobject p_targetUnit, jboolean checkCanTargetUnit, jboolean checkTargetsUnits, jboolean checkCanIssueCommandType, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
TechType* tech = (TechType*)env->GetLongField(p_tech, FindCachedField(env, env->GetObjectClass(p_tech), "pointer", "J"));
Unit targetUnit = (Unit)env->GetLongField(p_targetUnit, FindCachedField(env, env->GetObjectClass(p_targetUnit), "pointer", "J"));
...
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUseTechPosition_1native__JLbwapi_TechType_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_tech, jboolean checkCanIssueCommandType){
Unit x_unit = (Unit)pointer;
TechType* tech = (TechType*)env->GetLongField(p_tech, FindCachedField(env, env->GetObjectClass(p_tech), "pointer", "J"));
return x_unit->canUseTechPosition(*tech, (bool)checkCanIssueCommandType);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUseTechPosition_1native__JLbwapi_TechType_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_tech){
Unit x_unit = (Unit)pointer;
TechType* tech = (TechType*)env->GetLongField(p_tech, FindCachedField(env, env->GetObjectClass(p_tech), "pointer", "J"));
return x_unit->canUseTechPosition(*tech);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUseTechPosition_1native__JLbwapi_TechType_2ZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_tech, jboolean checkCanIssueCommandType, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
TechType* tech = (TechType*)env->GetLongField(p_tech, FindCachedField(env, env->GetObjectClass(p_tech), "pointer", "J"));
return x_unit->canUseTechPosition(*tech, (bool)checkCanIssueCommandType, (bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUseTechPosition_1native__JLbwapi_TechType_2Lbwapi_Position_2ZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_tech, jobject p_target, jboolean checkTargetsPositions, jboolean checkCanIssueCommandType){
Unit x_unit = (Unit)pointer;
TechType* tech = (TechType*)env->GetLongField(p_tech, FindCachedField(env, env->GetObjectClass(p_tech), "pointer", "J"));
Position target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
return x_unit->canUseTechPosition(*tech, target, (bool)checkTargetsPositions, (bool)checkCanIssueCommandType);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUseTechPosition_1native__JLbwapi_TechType_2Lbwapi_Position_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_tech, jobject p_target, jboolean checkTargetsPositions){
Unit x_unit = (Unit)pointer;
TechType* tech = (TechType*)env->GetLongField(p_tech, FindCachedField(env, env->GetObjectClass(p_tech), "pointer", "J"));
Position target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
return x_unit->canUseTechPosition(*tech, target, (bool)checkTargetsPositions);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUseTechPosition_1native__JLbwapi_TechType_2Lbwapi_Position_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_tech, jobject p_target){
Unit x_unit = (Unit)pointer;
TechType* tech = (TechType*)env->GetLongField(p_tech, FindCachedField(env, env->GetObjectClass(p_tech), "pointer", "J"));
Position target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
return x_unit->canUseTechPosition(*tech, target);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canUseTechPosition_1native__JLbwapi_TechType_2Lbwapi_Position_2ZZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_tech, jobject p_target, jboolean checkTargetsPositions, jboolean checkCanIssueCommandType, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
TechType* tech = (TechType*)env->GetLongField(p_tech, FindCachedField(env, env->GetObjectClass(p_tech), "pointer", "J"));
Position target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
...
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canPlaceCOP_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Unit x_unit = (Unit)pointer;
return x_unit->canPlaceCOP();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canPlaceCOP_1native__JZ(JNIEnv * env, jobject obj, jlong pointer, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
return x_unit->canPlaceCOP((bool)checkCommandibility);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canPlaceCOP_1native__JLbwapi_TilePosition_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean checkCanIssueCommandType){
Unit x_unit = (Unit)pointer;
TilePosition target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
return x_unit->canPlaceCOP(target, (bool)checkCanIssueCommandType);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canPlaceCOP_1native__JLbwapi_TilePosition_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_target){
Unit x_unit = (Unit)pointer;
TilePosition target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
return x_unit->canPlaceCOP(target);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unit_canPlaceCOP_1native__JLbwapi_TilePosition_2ZZ(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean checkCanIssueCommandType, jboolean checkCommandibility){
Unit x_unit = (Unit)pointer;
TilePosition target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
return x_unit->canPlaceCOP(target, (bool)checkCanIssueCommandType, (bool)checkCommandibility);
}
JNIEXPORT jobject JNICALL Java_bwapi_UnitCommand_attack__Lbwapi_Unit_2Lbwapi_PositionOrUnit_2(JNIEnv * env, jclass jclz, jobject p_unit, jobject p_target){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
PositionOrUnit target(convertPositionOrUnit(env, p_target ));
...
JNIEXPORT jobject JNICALL Java_bwapi_UnitCommand_attack__Lbwapi_Unit_2Lbwapi_PositionOrUnit_2Z(JNIEnv * env, jclass jclz, jobject p_unit, jobject p_target, jboolean shiftQueueCommand){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
PositionOrUnit target(convertPositionOrUnit(env, p_target ));
...
JNIEXPORT jobject JNICALL Java_bwapi_UnitCommand_build(JNIEnv * env, jclass jclz, jobject p_unit, jobject p_target, jobject p_type){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
TilePosition target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
UnitType* type = (UnitType*)env->GetLongField(p_type, FindCachedField(env, env->GetObjectClass(p_type), "pointer", "J"));
...
JNIEXPORT jobject JNICALL Java_bwapi_UnitCommand_buildAddon(JNIEnv * env, jclass jclz, jobject p_unit, jobject p_type){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
UnitType* type = (UnitType*)env->GetLongField(p_type, FindCachedField(env, env->GetObjectClass(p_type), "pointer", "J"));
...
JNIEXPORT jobject JNICALL Java_bwapi_UnitCommand_train(JNIEnv * env, jclass jclz, jobject p_unit, jobject p_type){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
UnitType* type = (UnitType*)env->GetLongField(p_type, FindCachedField(env, env->GetObjectClass(p_type), "pointer", "J"));
...
JNIEXPORT jobject JNICALL Java_bwapi_UnitCommand_morph(JNIEnv * env, jclass jclz, jobject p_unit, jobject p_type){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
UnitType* type = (UnitType*)env->GetLongField(p_type, FindCachedField(env, env->GetObjectClass(p_type), "pointer", "J"));
...
JNIEXPORT jobject JNICALL Java_bwapi_UnitCommand_research(JNIEnv * env, jclass jclz, jobject p_unit, jobject p_tech){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
TechType* tech = (TechType*)env->GetLongField(p_tech, FindCachedField(env, env->GetObjectClass(p_tech), "pointer", "J"));
...
JNIEXPORT jobject JNICALL Java_bwapi_UnitCommand_upgrade(JNIEnv * env, jclass jclz, jobject p_unit, jobject p_upgrade){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
UpgradeType* upgrade = (UpgradeType*)env->GetLongField(p_upgrade, FindCachedField(env, env->GetObjectClass(p_upgrade), "pointer", "J"));
...
JNIEXPORT jobject JNICALL Java_bwapi_UnitCommand_setRallyPoint(JNIEnv * env, jclass jclz, jobject p_unit, jobject p_target){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
PositionOrUnit target(convertPositionOrUnit(env, p_target ));
...
JNIEXPORT jobject JNICALL Java_bwapi_UnitCommand_move__Lbwapi_Unit_2Lbwapi_Position_2(JNIEnv * env, jclass jclz, jobject p_unit, jobject p_target){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
Position target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
...
JNIEXPORT jobject JNICALL Java_bwapi_UnitCommand_move__Lbwapi_Unit_2Lbwapi_Position_2Z(JNIEnv * env, jclass jclz, jobject p_unit, jobject p_target, jboolean shiftQueueCommand){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
Position target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
...
JNIEXPORT jobject JNICALL Java_bwapi_UnitCommand_patrol__Lbwapi_Unit_2Lbwapi_Position_2(JNIEnv * env, jclass jclz, jobject p_unit, jobject p_target){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
Position target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
...
JNIEXPORT jobject JNICALL Java_bwapi_UnitCommand_patrol__Lbwapi_Unit_2Lbwapi_Position_2Z(JNIEnv * env, jclass jclz, jobject p_unit, jobject p_target, jboolean shiftQueueCommand){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
Position target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
...
JNIEXPORT jobject JNICALL Java_bwapi_UnitCommand_holdPosition__Lbwapi_Unit_2(JNIEnv * env, jclass jclz, jobject p_unit){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
...
JNIEXPORT jobject JNICALL Java_bwapi_UnitCommand_holdPosition__Lbwapi_Unit_2Z(JNIEnv * env, jclass jclz, jobject p_unit, jboolean shiftQueueCommand){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
...
JNIEXPORT jobject JNICALL Java_bwapi_UnitCommand_stop__Lbwapi_Unit_2(JNIEnv * env, jclass jclz, jobject p_unit){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
...
JNIEXPORT jobject JNICALL Java_bwapi_UnitCommand_stop__Lbwapi_Unit_2Z(JNIEnv * env, jclass jclz, jobject p_unit, jboolean shiftQueueCommand){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
...
JNIEXPORT jobject JNICALL Java_bwapi_UnitCommand_follow__Lbwapi_Unit_2Lbwapi_Unit_2(JNIEnv * env, jclass jclz, jobject p_unit, jobject p_target){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
Unit target = (Unit)env->GetLongField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "pointer", "J"));
...
JNIEXPORT jobject JNICALL Java_bwapi_UnitCommand_follow__Lbwapi_Unit_2Lbwapi_Unit_2Z(JNIEnv * env, jclass jclz, jobject p_unit, jobject p_target, jboolean shiftQueueCommand){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
Unit target = (Unit)env->GetLongField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "pointer", "J"));
...
JNIEXPORT jobject JNICALL Java_bwapi_UnitCommand_gather__Lbwapi_Unit_2Lbwapi_Unit_2(JNIEnv * env, jclass jclz, jobject p_unit, jobject p_target){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
Unit target = (Unit)env->GetLongField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "pointer", "J"));
...
JNIEXPORT jobject JNICALL Java_bwapi_UnitCommand_gather__Lbwapi_Unit_2Lbwapi_Unit_2Z(JNIEnv * env, jclass jclz, jobject p_unit, jobject p_target, jboolean shiftQueueCommand){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
Unit target = (Unit)env->GetLongField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "pointer", "J"));
...
JNIEXPORT jobject JNICALL Java_bwapi_UnitCommand_returnCargo__Lbwapi_Unit_2(JNIEnv * env, jclass jclz, jobject p_unit){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
...
JNIEXPORT jobject JNICALL Java_bwapi_UnitCommand_returnCargo__Lbwapi_Unit_2Z(JNIEnv * env, jclass jclz, jobject p_unit, jboolean shiftQueueCommand){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
...
JNIEXPORT jobject JNICALL Java_bwapi_UnitCommand_repair__Lbwapi_Unit_2Lbwapi_Unit_2(JNIEnv * env, jclass jclz, jobject p_unit, jobject p_target){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
Unit target = (Unit)env->GetLongField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "pointer", "J"));
...
JNIEXPORT jobject JNICALL Java_bwapi_UnitCommand_repair__Lbwapi_Unit_2Lbwapi_Unit_2Z(JNIEnv * env, jclass jclz, jobject p_unit, jobject p_target, jboolean shiftQueueCommand){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
Unit target = (Unit)env->GetLongField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "pointer", "J"));
...
JNIEXPORT jobject JNICALL Java_bwapi_UnitCommand_burrow(JNIEnv * env, jclass jclz, jobject p_unit){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
...
JNIEXPORT jobject JNICALL Java_bwapi_UnitCommand_unburrow(JNIEnv * env, jclass jclz, jobject p_unit){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
...
JNIEXPORT jobject JNICALL Java_bwapi_UnitCommand_cloak(JNIEnv * env, jclass jclz, jobject p_unit){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
...
JNIEXPORT jobject JNICALL Java_bwapi_UnitCommand_decloak(JNIEnv * env, jclass jclz, jobject p_unit){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
...
JNIEXPORT jobject JNICALL Java_bwapi_UnitCommand_siege(JNIEnv * env, jclass jclz, jobject p_unit){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
...
JNIEXPORT jobject JNICALL Java_bwapi_UnitCommand_unsiege(JNIEnv * env, jclass jclz, jobject p_unit){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
...
JNIEXPORT jobject JNICALL Java_bwapi_UnitCommand_lift(JNIEnv * env, jclass jclz, jobject p_unit){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
...
JNIEXPORT jobject JNICALL Java_bwapi_UnitCommand_land(JNIEnv * env, jclass jclz, jobject p_unit, jobject p_target){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
TilePosition target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
...
JNIEXPORT jobject JNICALL Java_bwapi_UnitCommand_load__Lbwapi_Unit_2Lbwapi_Unit_2(JNIEnv * env, jclass jclz, jobject p_unit, jobject p_target){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
Unit target = (Unit)env->GetLongField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "pointer", "J"));
...
JNIEXPORT jobject JNICALL Java_bwapi_UnitCommand_load__Lbwapi_Unit_2Lbwapi_Unit_2Z(JNIEnv * env, jclass jclz, jobject p_unit, jobject p_target, jboolean shiftQueueCommand){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
Unit target = (Unit)env->GetLongField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "pointer", "J"));
...
JNIEXPORT jobject JNICALL Java_bwapi_UnitCommand_unload(JNIEnv * env, jclass jclz, jobject p_unit, jobject p_target){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
Unit target = (Unit)env->GetLongField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "pointer", "J"));
...
JNIEXPORT jobject JNICALL Java_bwapi_UnitCommand_unloadAll__Lbwapi_Unit_2(JNIEnv * env, jclass jclz, jobject p_unit){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
...
JNIEXPORT jobject JNICALL Java_bwapi_UnitCommand_unloadAll__Lbwapi_Unit_2Z(JNIEnv * env, jclass jclz, jobject p_unit, jboolean shiftQueueCommand){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
...
JNIEXPORT jobject JNICALL Java_bwapi_UnitCommand_unloadAll__Lbwapi_Unit_2Lbwapi_Position_2(JNIEnv * env, jclass jclz, jobject p_unit, jobject p_target){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
Position target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
...
JNIEXPORT jobject JNICALL Java_bwapi_UnitCommand_unloadAll__Lbwapi_Unit_2Lbwapi_Position_2Z(JNIEnv * env, jclass jclz, jobject p_unit, jobject p_target, jboolean shiftQueueCommand){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
Position target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
...
JNIEXPORT jobject JNICALL Java_bwapi_UnitCommand_rightClick__Lbwapi_Unit_2Lbwapi_PositionOrUnit_2(JNIEnv * env, jclass jclz, jobject p_unit, jobject p_target){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
PositionOrUnit target(convertPositionOrUnit(env, p_target ));
...
JNIEXPORT jobject JNICALL Java_bwapi_UnitCommand_rightClick__Lbwapi_Unit_2Lbwapi_PositionOrUnit_2Z(JNIEnv * env, jclass jclz, jobject p_unit, jobject p_target, jboolean shiftQueueCommand){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
PositionOrUnit target(convertPositionOrUnit(env, p_target ));
...
JNIEXPORT jobject JNICALL Java_bwapi_UnitCommand_haltConstruction(JNIEnv * env, jclass jclz, jobject p_unit){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
...
JNIEXPORT jobject JNICALL Java_bwapi_UnitCommand_cancelConstruction(JNIEnv * env, jclass jclz, jobject p_unit){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
...
JNIEXPORT jobject JNICALL Java_bwapi_UnitCommand_cancelAddon(JNIEnv * env, jclass jclz, jobject p_unit){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
...
JNIEXPORT jobject JNICALL Java_bwapi_UnitCommand_cancelTrain__Lbwapi_Unit_2(JNIEnv * env, jclass jclz, jobject p_unit){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
...
JNIEXPORT jobject JNICALL Java_bwapi_UnitCommand_cancelTrain__Lbwapi_Unit_2I(JNIEnv * env, jclass jclz, jobject p_unit, jint slot){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
...
JNIEXPORT jobject JNICALL Java_bwapi_UnitCommand_cancelMorph(JNIEnv * env, jclass jclz, jobject p_unit){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
...
JNIEXPORT jobject JNICALL Java_bwapi_UnitCommand_cancelResearch(JNIEnv * env, jclass jclz, jobject p_unit){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
...
JNIEXPORT jobject JNICALL Java_bwapi_UnitCommand_cancelUpgrade(JNIEnv * env, jclass jclz, jobject p_unit){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
...
JNIEXPORT jobject JNICALL Java_bwapi_UnitCommand_useTech__Lbwapi_Unit_2Lbwapi_TechType_2(JNIEnv * env, jclass jclz, jobject p_unit, jobject p_tech){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
TechType* tech = (TechType*)env->GetLongField(p_tech, FindCachedField(env, env->GetObjectClass(p_tech), "pointer", "J"));
...
JNIEXPORT jobject JNICALL Java_bwapi_UnitCommand_useTech__Lbwapi_Unit_2Lbwapi_TechType_2Lbwapi_PositionOrUnit_2(JNIEnv * env, jclass jclz, jobject p_unit, jobject p_tech, jobject p_target){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
TechType* tech = (TechType*)env->GetLongField(p_tech, FindCachedField(env, env->GetObjectClass(p_tech), "pointer", "J"));
PositionOrUnit target(convertPositionOrUnit(env, p_target ));
...
JNIEXPORT jobject JNICALL Java_bwapi_UnitCommand_placeCOP(JNIEnv * env, jclass jclz, jobject p_unit, jobject p_target){
Unit unit = (Unit)env->GetLongField(p_unit, FindCachedField(env, env->GetObjectClass(p_unit), "pointer", "J"));
TilePosition target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
...
JNIEXPORT jstring JNICALL Java_bwapi_UnitCommandType_toString_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitCommandType* x_unitCommandType = (UnitCommandType*)pointer;
return env->NewStringUTF(x_unitCommandType->toString().c_str());
}
JNIEXPORT jobject JNICALL Java_bwapi_Unitset_getPosition_1native(JNIEnv * env, jobject obj, jlong pointer){
...
JNIEXPORT jobject JNICALL Java_bwapi_Unitset_getLoadedUnits_1native(JNIEnv * env, jobject obj, jlong pointer){
Unitset* x_unitset = (Unitset*)pointer;
...
JNIEXPORT jobject JNICALL Java_bwapi_Unitset_getInterceptors_1native(JNIEnv * env, jobject obj, jlong pointer){
Unitset* x_unitset = (Unitset*)pointer;
...
JNIEXPORT jobject JNICALL Java_bwapi_Unitset_getLarva_1native(JNIEnv * env, jobject obj, jlong pointer){
Unitset* x_unitset = (Unitset*)pointer;
...
JNIEXPORT jobject JNICALL Java_bwapi_Unitset_getUnitsInRadius_1native(JNIEnv * env, jobject obj, jlong pointer, jint radius){
Unitset* x_unitset = (Unitset*)pointer;
Unitset cresult = x_unitset->getUnitsInRadius(radius);
jclass listCls = FindCachedClass(env, "java/util/ArrayList");
jmethodID listConsID = FindCachedMethod(env, listCls, "<init>", "()V");
jobject result = env->NewObject(listCls, listConsID);
jmethodID addMethodID = FindCachedMethod(env, listCls, "add", "(Ljava/lang/Object;)Z");
...
JNIEXPORT jboolean JNICALL Java_bwapi_Unitset_issueCommand_1native(JNIEnv * env, jobject obj, jlong pointer, jobject p_command){
Unitset* x_unitset = (Unitset*)pointer;
UnitCommand command(convertUnitCommand(env, p_command ));
return x_unitset->issueCommand(command);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unitset_attack_1native__JLbwapi_Position_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_target){
Unitset* x_unitset = (Unitset*)pointer;
Position target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
return x_unitset->attack(target);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unitset_attack_1native__JLbwapi_Unit_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_target){
Unitset* x_unitset = (Unitset*)pointer;
Unit target = (Unit)env->GetLongField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "pointer", "J"));
return x_unitset->attack(target);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unitset_attack_1native__JLbwapi_PositionOrUnit_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_target){
Unitset* x_unitset = (Unitset*)pointer;
PositionOrUnit target(convertPositionOrUnit(env, p_target ));
return x_unitset->attack(target);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unitset_attack_1native__JLbwapi_Position_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean shiftQueueCommand){
Unitset* x_unitset = (Unitset*)pointer;
Position target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
return x_unitset->attack(target, (bool)shiftQueueCommand);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unitset_attack_1native__JLbwapi_Unit_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean shiftQueueCommand){
Unitset* x_unitset = (Unitset*)pointer;
Unit target = (Unit)env->GetLongField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "pointer", "J"));
return x_unitset->attack(target, (bool)shiftQueueCommand);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unitset_attack_1native__JLbwapi_PositionOrUnit_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean shiftQueueCommand){
Unitset* x_unitset = (Unitset*)pointer;
PositionOrUnit target(convertPositionOrUnit(env, p_target ));
return x_unitset->attack(target, (bool)shiftQueueCommand);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unitset_build_1native__JLbwapi_UnitType_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_type){
Unitset* x_unitset = (Unitset*)pointer;
UnitType* type = (UnitType*)env->GetLongField(p_type, FindCachedField(env, env->GetObjectClass(p_type), "pointer", "J"));
return x_unitset->build(*type);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unitset_build_1native__JLbwapi_UnitType_2Lbwapi_TilePosition_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_type, jobject p_target){
Unitset* x_unitset = (Unitset*)pointer;
UnitType* type = (UnitType*)env->GetLongField(p_type, FindCachedField(env, env->GetObjectClass(p_type), "pointer", "J"));
TilePosition target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
return x_unitset->build(*type, target);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unitset_buildAddon_1native(JNIEnv * env, jobject obj, jlong pointer, jobject p_type){
Unitset* x_unitset = (Unitset*)pointer;
UnitType* type = (UnitType*)env->GetLongField(p_type, FindCachedField(env, env->GetObjectClass(p_type), "pointer", "J"));
return x_unitset->buildAddon(*type);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unitset_train_1native(JNIEnv * env, jobject obj, jlong pointer, jobject p_type){
Unitset* x_unitset = (Unitset*)pointer;
UnitType* type = (UnitType*)env->GetLongField(p_type, FindCachedField(env, env->GetObjectClass(p_type), "pointer", "J"));
return x_unitset->train(*type);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unitset_morph_1native(JNIEnv * env, jobject obj, jlong pointer, jobject p_type){
Unitset* x_unitset = (Unitset*)pointer;
UnitType* type = (UnitType*)env->GetLongField(p_type, FindCachedField(env, env->GetObjectClass(p_type), "pointer", "J"));
return x_unitset->morph(*type);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unitset_setRallyPoint_1native__JLbwapi_Position_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_target){
Unitset* x_unitset = (Unitset*)pointer;
Position target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
return x_unitset->setRallyPoint(target);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unitset_setRallyPoint_1native__JLbwapi_Unit_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_target){
Unitset* x_unitset = (Unitset*)pointer;
Unit target = (Unit)env->GetLongField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "pointer", "J"));
return x_unitset->setRallyPoint(target);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unitset_setRallyPoint_1native__JLbwapi_PositionOrUnit_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_target){
Unitset* x_unitset = (Unitset*)pointer;
PositionOrUnit target(convertPositionOrUnit(env, p_target ));
return x_unitset->setRallyPoint(target);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unitset_move_1native__JLbwapi_Position_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_target){
Unitset* x_unitset = (Unitset*)pointer;
Position target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
return x_unitset->move(target);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unitset_move_1native__JLbwapi_Position_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean shiftQueueCommand){
Unitset* x_unitset = (Unitset*)pointer;
Position target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
return x_unitset->move(target, (bool)shiftQueueCommand);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unitset_patrol_1native__JLbwapi_Position_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_target){
Unitset* x_unitset = (Unitset*)pointer;
Position target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
return x_unitset->patrol(target);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unitset_patrol_1native__JLbwapi_Position_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean shiftQueueCommand){
Unitset* x_unitset = (Unitset*)pointer;
Position target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
return x_unitset->patrol(target, (bool)shiftQueueCommand);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unitset_holdPosition_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Unitset* x_unitset = (Unitset*)pointer;
return x_unitset->holdPosition();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unitset_holdPosition_1native__JZ(JNIEnv * env, jobject obj, jlong pointer, jboolean shiftQueueCommand){
Unitset* x_unitset = (Unitset*)pointer;
return x_unitset->holdPosition((bool)shiftQueueCommand);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unitset_stop_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Unitset* x_unitset = (Unitset*)pointer;
return x_unitset->stop();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unitset_stop_1native__JZ(JNIEnv * env, jobject obj, jlong pointer, jboolean shiftQueueCommand){
Unitset* x_unitset = (Unitset*)pointer;
return x_unitset->stop((bool)shiftQueueCommand);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unitset_follow_1native__JLbwapi_Unit_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_target){
Unitset* x_unitset = (Unitset*)pointer;
Unit target = (Unit)env->GetLongField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "pointer", "J"));
return x_unitset->follow(target);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unitset_follow_1native__JLbwapi_Unit_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean shiftQueueCommand){
Unitset* x_unitset = (Unitset*)pointer;
Unit target = (Unit)env->GetLongField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "pointer", "J"));
return x_unitset->follow(target, (bool)shiftQueueCommand);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unitset_gather_1native__JLbwapi_Unit_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_target){
Unitset* x_unitset = (Unitset*)pointer;
Unit target = (Unit)env->GetLongField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "pointer", "J"));
return x_unitset->gather(target);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unitset_gather_1native__JLbwapi_Unit_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean shiftQueueCommand){
Unitset* x_unitset = (Unitset*)pointer;
Unit target = (Unit)env->GetLongField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "pointer", "J"));
return x_unitset->gather(target, (bool)shiftQueueCommand);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unitset_returnCargo_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Unitset* x_unitset = (Unitset*)pointer;
return x_unitset->returnCargo();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unitset_returnCargo_1native__JZ(JNIEnv * env, jobject obj, jlong pointer, jboolean shiftQueueCommand){
Unitset* x_unitset = (Unitset*)pointer;
return x_unitset->returnCargo((bool)shiftQueueCommand);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unitset_repair_1native__JLbwapi_Unit_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_target){
Unitset* x_unitset = (Unitset*)pointer;
Unit target = (Unit)env->GetLongField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "pointer", "J"));
return x_unitset->repair(target);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unitset_repair_1native__JLbwapi_Unit_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean shiftQueueCommand){
Unitset* x_unitset = (Unitset*)pointer;
Unit target = (Unit)env->GetLongField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "pointer", "J"));
return x_unitset->repair(target, (bool)shiftQueueCommand);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unitset_burrow_1native(JNIEnv * env, jobject obj, jlong pointer){
Unitset* x_unitset = (Unitset*)pointer;
return x_unitset->burrow();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unitset_unburrow_1native(JNIEnv * env, jobject obj, jlong pointer){
Unitset* x_unitset = (Unitset*)pointer;
return x_unitset->unburrow();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unitset_cloak_1native(JNIEnv * env, jobject obj, jlong pointer){
Unitset* x_unitset = (Unitset*)pointer;
return x_unitset->cloak();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unitset_decloak_1native(JNIEnv * env, jobject obj, jlong pointer){
Unitset* x_unitset = (Unitset*)pointer;
return x_unitset->decloak();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unitset_siege_1native(JNIEnv * env, jobject obj, jlong pointer){
Unitset* x_unitset = (Unitset*)pointer;
return x_unitset->siege();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unitset_unsiege_1native(JNIEnv * env, jobject obj, jlong pointer){
Unitset* x_unitset = (Unitset*)pointer;
return x_unitset->unsiege();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unitset_lift_1native(JNIEnv * env, jobject obj, jlong pointer){
Unitset* x_unitset = (Unitset*)pointer;
return x_unitset->lift();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unitset_load_1native__JLbwapi_Unit_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_target){
Unitset* x_unitset = (Unitset*)pointer;
Unit target = (Unit)env->GetLongField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "pointer", "J"));
return x_unitset->load(target);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unitset_load_1native__JLbwapi_Unit_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean shiftQueueCommand){
Unitset* x_unitset = (Unitset*)pointer;
Unit target = (Unit)env->GetLongField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "pointer", "J"));
return x_unitset->load(target, (bool)shiftQueueCommand);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unitset_unloadAll_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Unitset* x_unitset = (Unitset*)pointer;
return x_unitset->unloadAll();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unitset_unloadAll_1native__JZ(JNIEnv * env, jobject obj, jlong pointer, jboolean shiftQueueCommand){
Unitset* x_unitset = (Unitset*)pointer;
return x_unitset->unloadAll((bool)shiftQueueCommand);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unitset_unloadAll_1native__JLbwapi_Position_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_target){
Unitset* x_unitset = (Unitset*)pointer;
Position target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
return x_unitset->unloadAll(target);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unitset_unloadAll_1native__JLbwapi_Position_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean shiftQueueCommand){
Unitset* x_unitset = (Unitset*)pointer;
Position target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
return x_unitset->unloadAll(target, (bool)shiftQueueCommand);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unitset_rightClick_1native__JLbwapi_Position_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_target){
Unitset* x_unitset = (Unitset*)pointer;
Position target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
return x_unitset->rightClick(target);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unitset_rightClick_1native__JLbwapi_Unit_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_target){
Unitset* x_unitset = (Unitset*)pointer;
Unit target = (Unit)env->GetLongField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "pointer", "J"));
return x_unitset->rightClick(target);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unitset_rightClick_1native__JLbwapi_PositionOrUnit_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_target){
Unitset* x_unitset = (Unitset*)pointer;
PositionOrUnit target(convertPositionOrUnit(env, p_target ));
return x_unitset->rightClick(target);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unitset_rightClick_1native__JLbwapi_Position_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean shiftQueueCommand){
Unitset* x_unitset = (Unitset*)pointer;
Position target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
return x_unitset->rightClick(target, (bool)shiftQueueCommand);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unitset_rightClick_1native__JLbwapi_Unit_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean shiftQueueCommand){
Unitset* x_unitset = (Unitset*)pointer;
Unit target = (Unit)env->GetLongField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "pointer", "J"));
return x_unitset->rightClick(target, (bool)shiftQueueCommand);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unitset_rightClick_1native__JLbwapi_PositionOrUnit_2Z(JNIEnv * env, jobject obj, jlong pointer, jobject p_target, jboolean shiftQueueCommand){
Unitset* x_unitset = (Unitset*)pointer;
PositionOrUnit target(convertPositionOrUnit(env, p_target ));
return x_unitset->rightClick(target, (bool)shiftQueueCommand);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unitset_haltConstruction_1native(JNIEnv * env, jobject obj, jlong pointer){
Unitset* x_unitset = (Unitset*)pointer;
return x_unitset->haltConstruction();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unitset_cancelConstruction_1native(JNIEnv * env, jobject obj, jlong pointer){
Unitset* x_unitset = (Unitset*)pointer;
return x_unitset->cancelConstruction();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unitset_cancelAddon_1native(JNIEnv * env, jobject obj, jlong pointer){
Unitset* x_unitset = (Unitset*)pointer;
return x_unitset->cancelAddon();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unitset_cancelTrain_1native__J(JNIEnv * env, jobject obj, jlong pointer){
Unitset* x_unitset = (Unitset*)pointer;
return x_unitset->cancelTrain();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unitset_cancelTrain_1native__JI(JNIEnv * env, jobject obj, jlong pointer, jint slot){
Unitset* x_unitset = (Unitset*)pointer;
return x_unitset->cancelTrain(slot);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unitset_cancelMorph_1native(JNIEnv * env, jobject obj, jlong pointer){
Unitset* x_unitset = (Unitset*)pointer;
return x_unitset->cancelMorph();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unitset_cancelResearch_1native(JNIEnv * env, jobject obj, jlong pointer){
Unitset* x_unitset = (Unitset*)pointer;
return x_unitset->cancelResearch();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unitset_cancelUpgrade_1native(JNIEnv * env, jobject obj, jlong pointer){
Unitset* x_unitset = (Unitset*)pointer;
return x_unitset->cancelUpgrade();
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unitset_useTech_1native__JLbwapi_TechType_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_tech){
Unitset* x_unitset = (Unitset*)pointer;
TechType* tech = (TechType*)env->GetLongField(p_tech, FindCachedField(env, env->GetObjectClass(p_tech), "pointer", "J"));
return x_unitset->useTech(*tech);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unitset_useTech_1native__JLbwapi_TechType_2Lbwapi_Position_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_tech, jobject p_target){
Unitset* x_unitset = (Unitset*)pointer;
TechType* tech = (TechType*)env->GetLongField(p_tech, FindCachedField(env, env->GetObjectClass(p_tech), "pointer", "J"));
Position target((int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "x", "I")), (int)env->GetIntField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "y", "I")));
return x_unitset->useTech(*tech, target);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unitset_useTech_1native__JLbwapi_TechType_2Lbwapi_Unit_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_tech, jobject p_target){
Unitset* x_unitset = (Unitset*)pointer;
TechType* tech = (TechType*)env->GetLongField(p_tech, FindCachedField(env, env->GetObjectClass(p_tech), "pointer", "J"));
Unit target = (Unit)env->GetLongField(p_target, FindCachedField(env, env->GetObjectClass(p_target), "pointer", "J"));
return x_unitset->useTech(*tech, target);
}
JNIEXPORT jboolean JNICALL Java_bwapi_Unitset_useTech_1native__JLbwapi_TechType_2Lbwapi_PositionOrUnit_2(JNIEnv * env, jobject obj, jlong pointer, jobject p_tech, jobject p_target){
Unitset* x_unitset = (Unitset*)pointer;
TechType* tech = (TechType*)env->GetLongField(p_tech, FindCachedField(env, env->GetObjectClass(p_tech), "pointer", "J"));
PositionOrUnit target(convertPositionOrUnit(env, p_target ));
return x_unitset->useTech(*tech, target);
}
JNIEXPORT jstring JNICALL Java_bwapi_UnitSizeType_toString_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitSizeType* x_unitSizeType = (UnitSizeType*)pointer;
return env->NewStringUTF(x_unitSizeType->toString().c_str());
}
JNIEXPORT jstring JNICALL Java_bwapi_UnitType_toString_1native(JNIEnv * env, jobject obj, jlong pointer){
...
JNIEXPORT jobject JNICALL Java_bwapi_UnitType_tileSize_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
...
JNIEXPORT jint JNICALL Java_bwapi_UnitType_width_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->width();
}
JNIEXPORT jint JNICALL Java_bwapi_UnitType_height_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
...
JNIEXPORT jboolean JNICALL Java_bwapi_UnitType_producesCreep_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
return x_unitType->producesCreep();
}
...
JNIEXPORT jboolean JNICALL Java_bwapi_UnitType_isCritter_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
...
JNIEXPORT jobject JNICALL Java_bwapi_UnitType_researchesWhat_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
SetContainer<TechType> cresult = x_unitType->researchesWhat();
jclass listCls = FindCachedClass(env, "java/util/ArrayList");
jmethodID listConsID = FindCachedMethod(env, listCls, "<init>", "()V");
jobject result = env->NewObject(listCls, listConsID);
jmethodID addMethodID = FindCachedMethod(env, listCls, "add", "(Ljava/lang/Object;)Z");
...
JNIEXPORT jobject JNICALL Java_bwapi_UnitType_upgradesWhat_1native(JNIEnv * env, jobject obj, jlong pointer){
UnitType* x_unitType = (UnitType*)pointer;
SetContainer<UpgradeType> cresult = x_unitType->upgradesWhat();
jclass listCls = FindCachedClass(env, "java/util/ArrayList");
jmethodID listConsID = FindCachedMethod(env, listCls, "<init>", "()V");
jobject result = env->NewObject(listCls, listConsID);
jmethodID addMethodID = FindCachedMethod(env, listCls, "add", "(Ljava/lang/Object;)Z");
...
JNIEXPORT jstring JNICALL Java_bwapi_UpgradeType_toString_1native(JNIEnv * env, jobject obj, jlong pointer){
...
jclass retcls = FindCachedClass(env, "bwapi/WalkPosition");
jmethodID retConsID = FindCachedMethod(env, retcls, "<init>", "(II)V");
jobject result = env->NewObject(retcls, retConsID, cresult.x, cresult.y);
return result;
}
JNIEXPORT jint JNICALL Java_bwapi_WalkPosition_getApproxDistance(JNIEnv * env, jobject obj, jobject p_position){
WalkPosition x_walkPosition((int)env->GetIntField(obj, FindCachedField(env, env->GetObjectClass(obj), "x", "I")), (int)env->GetIntField(obj, FindCachedField(env, env->GetObjectClass(obj), "y", "I")));
WalkPosition position((int)env->GetIntField(p_position, FindCachedField(env, env->GetObjectClass(p_position), "x", "I")), (int)env->GetIntField(p_position, FindCachedField(env, env->GetObjectClass(p_position), "y", "I")));
return x_walkPosition.getApproxDistance(position);
}
JNIEXPORT jdouble JNICALL Java_bwapi_WalkPosition_getLength(JNIEnv * env, jobject obj){
WalkPosition x_walkPosition((int)env->GetIntField(obj, FindCachedField(env, env->GetObjectClass(obj), "x", "I")), (int)env->GetIntField(obj, FindCachedField(env, env->GetObjectClass(obj), "y", "I")));
return x_walkPosition.getLength();
}
JNIEXPORT jstring JNICALL Java_bwapi_WeaponType_toString_1native(JNIEnv * env, jobject obj, jlong pointer){
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "CreateProtossBuilding", "Lbwapi/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::CreateProtossBuilding));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Teleport", "Lbwapi/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::Teleport));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "SelfDestructing", "Lbwapi/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::SelfDestructing));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "MedicHeal", "Lbwapi/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::MedicHeal));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "MedicHealToIdle", "Lbwapi/Order;"), env->CallStaticObjectMethod(cls, getId, (jlong)&Orders::MedicHealToIdle));
...
env->SetStaticObjectField(cls, env->GetStaticFieldID(cls, "Upgrade_60", "Lbwapi/UpgradeType;"), env->CallStaticObjectMethod(cls, getId, (jlong)&UpgradeTypes::Upgrade_60));
